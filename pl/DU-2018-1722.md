---
title: "Ustawa z dnia 20 lipca 2018 r. o zmianie ustawy - Prawo wodne oraz niektórych innych ustaw"
identifier: "DU-2018-1722"
country: "pl"
rank: "ustawa"
publication_date: "2018-07-20"
last_updated: "2018-07-20"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2018/1722"
department: "SEJM"
eli: "DU/2018/1722"
display_address: "Dz.U. 2018 poz. 1722"
internal_address: "WDU20180001722"
publisher: "DU"
volume: "0"
position: "1722"
...
obligated_bodies: "MIN. WŁAŚCIWY DS GOSPODARKI WODNEJ, MIN. WŁAŚCIWY DS ŚRODOWISKA"
effective_date_notes: "art. 1 pkt 5 i 22 wchodzi w życie z dniem 5 grudnia 2018 r.; art. 1 pkt 16 wchodzi w życie z dniem 1 stycznia 2021 r."
eu_directives_count: "2"
parliamentary_prints_count: "1"
references_count: "2"
text_variants_count: "4"
has_pdf: "true"
keywords: "podatki i opłaty terenowe, ochrona środowiska, wodne prawo, inwestycje"
---
...
a) w pkt 1 w lit. j dodaje się przecinek i dodaje się lit. k w brzmieniu:
...
c) w pkt 65 lit. b otrzymuje brzmienie:
...
3) po art. 75 dodaje się art. 75a w brzmieniu:
...
4) w art. 99 w ust. 1 pkt 4 otrzymuje brzmienie:
...
5) w art. 101 ust. 1 otrzymuje brzmienie:
...
6) w art. 166 po ust. 13 dodaje się ust. 13a w brzmieniu:
...
10) w art. 216 dodaje się ust. 6 w brzmieniu:
...
> 24) dokonuje uzgodnienia list programów priorytetowych Narodowego Funduszu Ochrony Środowiska i Gospodarki Wodnej w części dotyczącej gospodarki wodnej; 25) prowadzi sprawy, w których Prezes Wód Polskich pełni funkcję organu wyższego stopnia w rozumieniu przepisów ustawy z dnia 14 czerwca 1960 r. - Kodeks postępowania administracyjnego.

b) w ust. 3 w pkt 1 lit. b otrzymuje brzmienie:

> b) zgód wodnoprawnych, o których mowa w art. 388 ust. 1 pkt 1, 3 i 4;

c) w ust. 4 w pkt 16 kropkę zastępuje się średnikiem i dodaje się pkt 17 w brzmieniu:
...
14) w art. 269 dodaje się ust. 4 w brzmieniu:

> 4. Opłaty, o której mowa w ust. 1 pkt 2, nie ponoszą urzędy morskie.

15) w art. 270 ust. 2 otrzymuje brzmienie:
...
16) w art. 272 po ust. 16 dodaje się ust. 16a i 16b w brzmieniu:
...
17) po art. 273 dodaje się art. 273a w brzmieniu:
...
18) w art. 278 po ust. 1 dodaje się ust. 1a w brzmieniu:
...
19) po art. 279 dodaje się art. 279a w brzmieniu:
...
23) w art. 304 dotychczasową treść oznacza się jako ust. 1 i dodaje się ust. 2 w brzmieniu:
...
24) w art. 331 w ust. 1 pkt 11 otrzymuje brzmienie:

> 11) w zakresie związków spółek wodnych - związki spółek wodnych oraz właściwi wojewodowie;

25) w art. 335 ust. 5 otrzymuje brzmienie:

> 5. Kontrolę gospodarowania wodami w zakresie określonym w art. 334: 1) pkt 2 i 3 dotyczącą pobranych wód oraz ochrony wód przed zanieczyszczeniami, 2) pkt 6 dotyczącą stosowania programu działań mających na celu zmniejszenie zanieczyszczenia wód azotanami pochodzącymi ze źródeł rolniczych oraz zapobieganie dalszemu zanieczyszczeniu przez podmioty prowadzące produkcję rolną i działalność, o których mowa w art. 102 ust. 1 - wykonuje Inspekcja Ochrony Środowiska.

26) w art. 388 w ust. 2 uchyla się pkt 5 i 9;

27) w art. 389 pkt 9 otrzymuje brzmienie:
...
28) w art. 394 dodaje się ust. 4 w brzmieniu:
...
29) w art. 395 w pkt 13 kropkę zastępuje się średnikiem i dodaje się pkt 14 w brzmieniu:

> 14) lokalizowanie, na okres do 180 dni, tymczasowych obiektów budowlanych na obszarach szczególnego zagrożenia powodzią.

30) w art. 397 uchyla się ust. 5;

31) w art. 400 ust. 1 otrzymuje brzmienie:
...
32) w art. 401 ust. 4 otrzymuje brzmienie:
...
W ustawie z dnia 3 października 2008 r. o udostępnianiu informacji o środowisku i jego ochronie, udziale społeczeństwa w ochronie środowiska oraz o ocenach oddziaływania na środowisko po art. 6 dodaje się art. 6a w brzmieniu:
...
W ustawie z dnia 8 lipca 2010 r. o szczególnych zasadach przygotowania do realizacji inwestycji w zakresie budowli przeciwpowodziowych w art. 2 w pkt 1 w lit. j dodaje się przecinek i dodaje się lit. k w brzmieniu:
...
1089, 1479, 1496, 1563, 1590 i 1669.

##### Art. 9.

1. Zwrotu gminom utraconych dochodów z tytułu zwolnienia z podatku od nieruchomości, o którym mowa w art. 7 ust. 1 pkt 8a ustawy zmienianej w art. 2, dokonują wojewódzkie fundusze ochrony środowiska i gospodarki wodnej:
...
1. Do spraw wszczętych i niezakończonych przed dniem wejścia w życie niniejszej ustawy, dotyczących pozwoleń wodnoprawnych wydawanych na podstawie przepisów ustawy zmienianej w art. 1, stosuje się przepisy ustawy zmienianej w art. 1, w brzmieniu nadanym niniejszą ustawą.
...
1. Dotychczasowe przepisy wykonawcze wydane na podstawie art. 266 ustawy zmienianej w art. 1 zachowują moc i mogą być zmieniane na podstawie tego przepisu, jednak nie dłużej niż przez 18 miesięcy od dnia wejścia w życie niniejszej ustawy.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2018/1722/text.pdf)
