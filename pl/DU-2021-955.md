---
title: "Obwieszczenie Marszałka Sejmu Rzeczypospolitej Polskiej z dnia 18 maja 2021 r. w sprawie ogłoszenia jednolitego tekstu ustawy o statystyce publicznej"
identifier: "DU-2021-955"
country: "pl"
rank: "obwieszczenie"
publication_date: "2021-05-18"
last_updated: "2021-05-18"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2021/955"
department: "MARSZAŁEK SEJMU"
eli: "DU/2021/955"
display_address: "Dz.U. 2021 poz. 955"
internal_address: "WDU20210000955"
publisher: "DU"
volume: "0"
position: "955"
...
keywords: "statystyka"
---
# Obwieszczenie Marszałka Sejmu Rzeczypospolitej Polskiej z dnia 18 maja 2021 r. w sprawie ogłoszenia jednolitego tekstu ustawy o statystyce publicznej

## Treść obwieszczenia

1. Na podstawie art. 16 ust. 1 zdanie pierwsze ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst ustawy z dnia 29 czerwca 1995 r. o statystyce publicznej , z uwzględnieniem zmian wprowadzonych ustawą z dnia 14 sierpnia 2020 r. o zmianie ustawy o statystyce publicznej, ustawy o powszechnym spisie rolnym w 2020 r. oraz ustawy o narodowym spisie powszechnym ludności i mieszkań w 2021 r. oraz zmian wynikających z przepisów ogłoszonych przed dniem 13 maja 2021 r.

2. Podany w załączniku do niniejszego obwieszczenia jednolity tekst ustawy nie obejmuje art. 4 i art. 8 ustawy z dnia 14 sierpnia 2020 r. o zmianie ustawy o statystyce publicznej, ustawy o powszechnym spisie rolnym w 2020 r. oraz ustawy o narodowym spisie powszechnym ludności i mieszkań w 2021 r. , które stanowią:

> Art. 4. 1. Programy badań statystycznych statystyki publicznej ustalone przed dniem wejścia w życie niniejszej ustawy zachowują moc do dnia zakończenia realizacji określonych w nich badań statystycznych i mogą być zmieniane. 2. W przypadku zmiany programów badań statystycznych statystyki publicznej, o których mowa w ust. 1, dotyczącej zakresu danych osobowych, które przekazywane są w badaniach statystycznych określonych w tych programach, stosuje się zakres danych osobowych z katalogu określonego w art. 35b ust. 1 ustawy zmienianej w art. 1 w brzmieniu nadanym niniejszą ustawą.
...
1. Służby statystyki publicznej zbierają dane, w tym dane osobowe, z dostępnych źródeł określonych w ustawie i wydanych na jej podstawie aktach wykonawczych albo odrębnych ustawach.
...
1. Prezes Głównego Urzędu Statystycznego i Prezes Narodowego Banku Polskiego współdziałają ze sobą, prowadząc badania statystyczne na podstawie niniejszej ustawy, ustawy z dnia 29 sierpnia 1997 r. o Narodowym Banku Polskim (Dz. U. z 2020 r. poz. 2027) oraz ustawy z dnia 27 lipca 2002 r. - Prawo dewizowe .
...
1. Służby statystyki publicznej przetwarzają w celu statystycznym następujące dane osobowe:
...
14) zawód; 14a) dochód, w tym wynagrodzenie;
...
1. Dane osobowe po ich zebraniu przez służby statystyki publicznej, jeżeli pozwala na to cel ich przetwarzania, są pseudonimizowane.
...
1. Dane osobowe, jeżeli jest to niezbędne do realizacji zadań określonych w ustawie, w zakresie dotyczącym celów statystycznych, są łączone z danymi pochodzącymi z różnych badań statystycznych, rejestrów urzędowych, systemów informacyjnych administracji publicznej i niepublicznych systemów informacyjnych.
...
Przepisy art. 35a-35c, art. 35d ust. 1 i art. 35h stosuje się do innych organów i podmiotów prowadzących badania statystyczne, o których mowa w art. 20, w zakresie prowadzonych przez nie badań statystycznych.

##### Art. 35h.

1. Do przetwarzania danych osobowych w celu wykonywania zadań określonych w ustawie przez służby statystyki publicznej nie stosuje się przepisów art. 15, art. 16, art. 18 i art. 21 rozporządzenia 2016/679.
...
Prezes Głównego Urzędu Statystycznego zapewnia przechowywanie zgromadzonych danych zgodnie z zasadami określonymi w art. 10, art. 35d i rozdziale 5a.

### Rozdział 5a. Operat do badań statystycznych

##### Art. 39a.

1. W celu realizacji badań statystycznych Prezes Głównego Urzędu Statystycznego prowadzi operat do badań statystycznych, zwany dalej „OBS”, w którym zamieszcza informacje o podmiotach podlegających obserwacji statystycznej według określonych cech.
...
1. OBS podlega stałej i bieżącej aktualizacji w celu umożliwienia prowadzenia obserwacji statystycznej podmiotu tej obserwacji w czasie i przestrzeni.
...
1. Dane gromadzone w OBS są wykorzystywane wyłącznie przez służby statystyki publicznej do prowadzenia badań statystycznych, w tym spisów powszechnych.
...
1) oświatowej obejmującej prowadzenie przedszkola, szkoły, placówki lub innej jednostki organizacyjnej, o której mowa w art. 2 ustawy z dnia 14 grudnia 2016 r. - Prawo oświatowe ;
...
2) numer identyfikacji podatkowej (NIP) oraz informacje o jego unieważnieniu lub uchyleniu; 2a) numery identyfikacyjne wspólników spółki cywilnej, o ile takie posiadają, nazwisko i imiona albo firma wspólników spółki cywilnej wraz z numerem PESEL osoby fizycznej prowadzącej działalność, o ile taki posiada;
