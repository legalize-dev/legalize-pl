---
title: "Obwieszczenie Prezesa Rady Ministrów z dnia 17 czerwca 2015 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Prezesa Rady Ministrów w sprawie sporządzania i doręczania dokumentów elektronicznych oraz udostępniania formularzy, wzorów i kopii dokumentów elektronicznych"
identifier: "DU-2015-971"
country: "pl"
rank: "obwieszczenie"
publication_date: "2015-06-17"
last_updated: "2015-06-17"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2015/971"
department: "PREZ. RADY MINISTRÓW"
eli: "DU/2015/971"
display_address: "Dz.U. 2015 poz. 971"
internal_address: "WDU20150000971"
publisher: "DU"
volume: "0"
position: "971"
status_pl: "wygaśnięcie aktu"
promulgation_date: "2015-07-13"
effective_date_notes: "Tekst jednolity rozporządzenia nie obejmuje par. 42"
references_count: "3"
text_variants_count: "3"
has_pdf: "true"
keywords: "elektroniczne nośniki informacji, elektroniczne urządzenia, informatyzacja, dokumenty, systemy teleinformatyczne"
---
...
1. Na podstawie art. 16 ust. 3 ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst rozporządzenia Prezesa Rady Ministrów z dnia 14 września 2011 r. w sprawie sporządzania pism w formie dokumentów elektronicznych, doręczania dokumentów elektronicznych oraz udostępniania formularzy, wzorów i kopii dokumentów elektronicznych , z uwzględnieniem zmian wprowadzonych rozporządzeniem Prezesa Rady Ministrów z dnia 8 maja 2014 r. zmieniającym rozporządzenie w sprawie sporządzania pism w formie dokumentów elektronicznych, doręczania dokumentów elektronicznych oraz udostępniania formularzy, wzorów i kopii dokumentów elektronicznych .

2. Podany w załączniku do niniejszego obwieszczenia tekst jednolity rozporządzenia nie obejmuje:

1) § 42 rozporządzenia Prezesa Rady Ministrów z dnia 14 września 2011 r. w sprawie sporządzania pism w formie dokumentów elektronicznych, doręczania dokumentów elektronicznych oraz udostępniania formularzy, wzorów i kopii dokumentów elektronicznych , który stanowi:

> § 42. Umożliwienie odbiorcom wizualizacji pism, o których mowa w § 22 ust. 1, nastąpi nie później niż w terminie 12 miesięcy od daty wejścia w życie rozporządzenia.

2) § 2 rozporządzenia Prezesa Rady Ministrów z dnia 8 maja 2014 r. zmieniającego rozporządzenie w sprawie sporządzania pism w formie dokumentów elektronicznych, doręczania dokumentów elektronicznych oraz udostępniania formularzy, wzorów i kopii dokumentów elektronicznych , który stanowi:

> § 2. Rozporządzenie wchodzi w życie z dniem 11 maja 2014 r.
...
### Rozdział 2. Warunki organizacyjno-techniczne doręczania dokumentów elektronicznych, sposób doręczania pism,
...
2) wykorzystywać urządzenia udostępniające urzędowy koordynowany czas UTC(PL) zgodnie z rozporządzeniem Ministra Gospodarki, Pracy i Polityki Społecznej z dnia 19 marca 2004 r. w sprawie sposobów rozpowszechniania sygnałów czasu urzędowego i uniwersalnego czasu koordynowanego UTC(PL) ;

3) stosować techniki kryptograficzne zgodnie z udokumentowaną analizą ryzyka.

##### § 6.

System teleinformatyczny służący do obsługi doręczeń automatycznie generuje informację wskazującą, że nie wpłynęło w terminie potwierdzone urzędowe poświadczenie odbioru, o którym mowa w art. 46 § 4 pkt 3 ustawy z dnia 14 czerwca 1960 r. - Kodeks postępowania administracyjnego i w art. 152a § 1 ustawy z dnia 29 sierpnia 1997 r. - Ordynacja podatkowa , zwane dalej „poświadczeniem doręczenia”.
...
2. Utworzenie elektronicznej skrzynki podawczej na ePUAP oznacza upoważnienie ministra do obsługi doręczeń za pomocą ePUAP do podmiotów, o których mowa w ust. 1, i doręczeń realizowanych przez te podmioty.
...
1) dokument elektroniczny powinien być podpisany podpisem elektronicznym osoby identyfikowanej w sposób określony w art. 20a ust. 1 ustawy;
...
3) sposobu oznaczania w pismach w postaci elektronicznej niezbędnych elementów struktury określonych w przepisach wydanych na podstawie art. 5 ust. 2a ustawy z dnia 14 lipca 1983 r. o narodowym zasobie archiwalnym i archiwach , zwanych dalej „NES”, w taki sposób, aby te elementy struktury dawały się automatycznie wyodrębnić.
...
Adresat dokumentu elektronicznego potwierdza jego odebranie przez opatrzenie poświadczenia doręczenia podpisem elektronicznym umożliwiającym identyfikację podpisującego w sposób określony w art. 20a ust. 1 lub 2 ustawy.
...
d) opis - wskazujący zakres stosowania wzoru
...
2) tytuł odnoszący się do treści pisma, o którym mowa w rozporządzeniu Ministra Spraw Wewnętrznych i Administracji z dnia 30 października 2006 r. w sprawie niezbędnych elementów struktury dokumentów elektronicznych ;
...
2. Wniosek, o którym mowa w ust. 1, opatruje się bezpiecznym podpisem elektronicznym weryfikowanym za pomocą ważnego kwalifikowanego certyfikatu.
...
2) podpisany bezpiecznym podpisem elektronicznym weryfikowanym za pomocą ważnego kwalifikowanego certyfikatu
...
2. Jeżeli nie jest możliwe sprawdzenie przez odbiorcę ważności podpisu w chwili jego złożenia, w celu udostępnienia dokumentu elektronicznego sporządza się jego kopię podpisaną podpisem elektronicznym osoby, która może być zidentyfikowana w sposób określony w art. 20a ustawy.
...
Organy władzy publicznej wskazują, w zakresie swojej właściwości rzeczowej, miejsce udostępnienia formularzy elektronicznych w BIP.
...
## Załącznik nr 1 - Formaty danych, w jakich zapisuje się załączniki dodawane do pism
