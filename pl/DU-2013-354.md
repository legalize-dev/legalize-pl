...
9) oświadczenie o wyrażeniu zgody na przetwarzanie danych osobowych, w celu związanym z prowadzeniem listy ekspertów, zgodnie z ustawą z dnia 29 sierpnia 1997 r. o ochronie danych osobowych .
...
## Załącznik - Ramowy program szkolenia kandydatów na ekspertów
...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
|  | Podstawowe treści programowe | Minimalna liczba godzin | Minimalna liczba godzin | Minimalna liczba godzin |  |
|  | Podstawowe treści programowe | ogółem | wykłady (kształcenie na odległość) | ćwiczenia (w formie bezpośredniej) |  |
|  | 1 | 2 | 3 | 4 |  |
|  | 1. Rola eksperta: |  |  |  |  |
|  | 1) kontekst społeczny i cele pracy eksperta; |  |  |  |  |
|  | 2) zakres i granice autonomii eksperta; |  |  |  |  |
|  | 3) prawne usytuowanie eksperta w komisji egzaminacyjnej i kwalifikacyjnej; | 1,5 | 1,5 | - |  |
...
|  | 2) kontekst społeczny zmian w prawie dotyczącym systemu oświaty; | 6 | 6 | - |  |
...
|  | c) działanie członków komisji wynikające z przepisów prawa i pełnionych ról zespołowych; | 11 | 2 | 9 |  |
...
|  | 2) rozmowa jako rodzaj interakcji; | 11 | 2 | 9 |  |
...
|  | 4) ocena spełnienia niezbędnych wymagań do uzyskania stopnia awansu zawodowego, zgodnie z przepisami w sprawie uzyskiwania stopni awansu zawodowego przez nauczycieli; | 18,5 | 3 | 15,5 |  |
...
|  | 2) elementy warsztatu pracy eksperta; | 6 | 2 | 4 |  |
|  | 3) refleksja nad własnym warsztatem pracy; |  |  |  |  |
|  | 4) projektowanie własnego rozwoju. |  |  |  |  |
|  | 7. Etyczne aspekty pracy eksperta: |  |  |  |  |
|  | 1) funkcje etyki, w tym etyki zawodowej, we współczesnym społeczeństwie; | 6 | 2 | 4 |  |
