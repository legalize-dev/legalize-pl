---
title: "Obwieszczenie Ministra Rozwoju i Technologii z dnia 21 października 2024 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Ministra Rozwoju, Pracy i Technologii w sprawie wymagań technicznych dla kas rejestrujących"
identifier: "DU-2024-1654"
country: "pl"
rank: "obwieszczenie"
publication_date: "2024-10-21"
last_updated: "2024-10-21"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2024/1654"
department: "MIN. ROZWOJU I TECHNOLOGII"
eli: "DU/2024/1654"
display_address: "Dz.U. 2024 poz. 1654"
internal_address: "WDU20240001654"
publisher: "DU"
volume: "0"
position: "1654"
...
has_pdf: "true"
keywords: "elektroniczne nośniki informacji, kasy rejestrujące, elektroniczne urządzenia, dokumenty"
---
# Obwieszczenie Ministra Rozwoju i Technologii z dnia 21 października 2024 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Ministra Rozwoju, Pracy i Technologii w sprawie wymagań technicznych dla kas rejestrujących

## Treść obwieszczenia

1. Na podstawie art. 16 ust. 3 ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst rozporządzenia Ministra Rozwoju, Pracy i Technologii z dnia 12 września 2021 r. w sprawie wymagań technicznych dla kas rejestrujących , z uwzględnieniem zmian wprowadzonych rozporządzeniem Ministra Rozwoju i Technologii z dnia 2 marca 2023 r. zmieniającym rozporządzenie w sprawie wymagań technicznych dla kas rejestrujących .

2. Podany w załączniku do niniejszego obwieszczenia tekst jednolity rozporządzenia nie obejmuje odnośnika nr 2 oraz § 2 i § 3 rozporządzenia Ministra Rozwoju i Technologii z dnia 2 marca 2023 r. zmieniającego rozporządzenie w sprawie wymagań technicznych dla kas rejestrujących , które stanowią:
...
> § 2. 1. Potwierdzenia o spełnianiu funkcji i wymagań technicznych dla kas rejestrujących wydane na podstawie przepisów rozporządzenia zmienianego w § 1 w brzmieniu dotychczasowym zachowują moc przez okres, na który zostały wydane, chyba że potwierdzenie zostanie cofnięte. 2. Do postępowań w sprawach potwierdzeń o spełnianiu funkcji i wymagań technicznych dla kas rejestrujących, wszczętych i niezakończonych przed dniem wejścia w życie niniejszego rozporządzenia, stosuje się przepisy dotychczasowe. § 3. Rozporządzenie wchodzi w życie z dniem następującym po dniu ogłoszenia.

## Załącznik - Rozporządzenie Ministra Rozwoju, Pracy i Technologii z dnia 12 września 2021 r. w sprawie wymagań technicznych dla kas rejestrujących
...
### Rozdział 2. Wymagania techniczne dla kas dotyczące ich rodzajów
...
### Rozdział 3. Wymagania techniczne dla kas dotyczące ich konstrukcji
...
1. Dostęp do wnętrza kasy jest zabezpieczony co najmniej jedną plombą mechaniczną, przy czym ta plomba jest:
...
Klawiatura kasy zapewnia co najmniej wystawienie raportów fiskalnych dobowych i okresowych oraz zdarzeń.

##### § 16.

1. Zasilanie akumulatorowe kasy umożliwia wydruk co najmniej 200 dokumentów fiskalnych i niefiskalnych o łącznej długości co najmniej 6000 linii po 48 godzinach od odłączenia zasilania zewnętrznego, z wyłączeniem przesyłania danych.
...
1. Konstrukcja kasy nie może umożliwiać zaprogramowania w jej pamięciach wewnętrznych oraz wykonywania programów nieuwzględnionych w wykazie oprogramowania kasy, o którym mowa w § 54 ust. 1 pkt 19.
...
### Rozdział 4. Wymagania techniczne dla kas dotyczące zapisu i przechowywania danych w ich pamięciach
...
Kasa zapewnia zgodność danych zawartych w:
...
### Rozdział 5. Wymagania techniczne dla kas dotyczące dokumentów wystawianych przy ich użyciu
...
31) kod graficzny QR text zgodny z normą ISO/IEC 18004:2015 i z opisem zawartym w protokole komunikacyjnym przesyłania danych, zawierający kolejno oddzielone średnikiem dane:
...
### Rozdział 6. Wymagania techniczne dla kas dotyczące ich pracy

##### § 31.

1. Kasa, która pracuje w trybie fiskalnym, umożliwia pracę na co najmniej dwóch poziomach dostępu - dla użytkownika kasy oraz w trybie serwisowym.
...
1. Kasa zapewnia wykonanie fiskalizacji obejmującej:
...
Po dokonaniu fiskalizacji kasa uniemożliwia:
...
1. Kasa podczas pracy blokuje możliwość ewidencji sprzedaży w przypadku:
...
1. Kasa zapewnia ewidencję dokonywanych sprzedaży, kończących się każdorazowo wystawieniem paragonu fiskalnego lub faktury przez:
...
1. Kasa zapewnia, aby zawarte na paragonie fiskalnym i fakturze:
...
1. W przypadku wystąpienia zdarzenia jest ono zapisywane przez kasę w postaci elektronicznej niezwłocznie po jego wystąpieniu, a przed wykonaniem następnych czynności kasowych.
...
1. Kasa przesyła dane za pomocą protokołu komunikacyjnego przesyłania danych, który obejmuje zestawy poleceń związanych z:
...
1. Kasa, po uruchomieniu, rozpoczyna przesyłanie danych zgodnie z harmonogramem przesyłania danych lub, na żądanie użytkownika, wykonując polecenia przesyłania danych.
...
1. Kasa, z wyłączeniem drukarek fiskalnych, współpracuje z terminalem płatniczym przy użyciu protokołu komunikacyjnego współpracy kasy z terminalem płatniczym, który obejmuje zestawy poleceń związanych z:
...
Opisy w dokumentach fiskalnych wystawianych przy użyciu kasy i napisy na wyświetlaczach kasy dotyczące ewidencjonowanej sprzedaży są wykonywane w języku polskim.
...
### Rozdział 7. Wymagania techniczne dla kas o zastosowaniu specjalnym
...
Kasa, o której mowa w § 5 ust. 1 pkt 2 lit. d, zamyka wszystkie rozpoczęte w ciągu danej doby transakcje przed wystawieniem raportu fiskalnego dobowego.

##### § 52.

1. Kasa, o której mowa w § 5 ust. 1 pkt 2 lit. f, może nie zawierać drukarki kasy.
...
### Rozdział 8. Rodzaje danych zawartych we wniosku o wydanie potwierdzenia oraz rodzaje dokumentów i urządzeń niezbędnych do wydania potwierdzenia

##### § 53.

1. Wniosek o wydanie potwierdzenia zawiera:
...
1. Do wniosku, o którym mowa w § 53 ust. 1, dołącza się:
...
### Rozdział 9. Okres, na który jest wydawane potwierdzenie

##### § 56.

1. Potwierdzenie wydaje się na okres 5 lat, po upływie którego może ono być wydane na następny okres, po złożeniu wniosku wraz z wymaganymi dokumentami i urządzeniami oraz przeprowadzeniu badań.
...
### Rozdział 11. Sposób oznaczania pamięci fiskalnej numerami unikatowymi i warunki ich przydzielania oraz dokumenty, które powinny być dołączone do kasy przy wprowadzaniu jej do obrotu

##### § 60.

1. Pamięć fiskalna jest oznaczana numerem unikatowym wprowadzonym do niej wyłącznie podczas procesu produkcyjnego.
...
### Rozdział 12. Przepisy przejściowe i przepis końcowy
...
Książki kasy dołączone do kas wprowadzonych do obrotu przed dniem wejścia w życie niniejszego rozporządzenia mogą być nadal stosowane.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2024/1654/text.pdf)

## Załącznik nr 2 - Książka kasy

[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2024/1654/text.pdf)

## Załącznik nr 3 - Karta kasy

[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2024/1654/text.pdf)

## Załącznik nr 4 - Deklaracja o spełnieniu przez kasę funkcji i wymagań technicznych dla kas oraz zgodności z kasą wzorcową, która była podstawą do wydania potwierdzenia, o którym mowa w art. 111 ust. 6b ustawy
