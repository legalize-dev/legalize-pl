---
title: "Ustawa z dnia 19 listopada 2009 r. o grach hazardowych"
identifier: "DU-2009-1540"
country: "pl"
rank: "ustawa"
publication_date: "2009-11-19"
last_updated: "2009-11-19"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2009/1540"
department: "SEJM"
eli: "DU/2009/1540"
display_address: "Dz.U. 2009 nr 201 poz. 1540"
internal_address: "WDU20092011540"
publisher: "DU"
volume: "201"
position: "1540"
...
obligated_bodies: "MIN. WŁAŚCIWY DS ZDROWIA, MIN. WŁAŚCIWY DS KULTURY I OCHRONY DZIEDZICTWA NARODOWEGO, MIN. WŁAŚCIWY DS KULTURY FIZYCZNEJ I SPORTU, MIN. WŁAŚCIWY DS FINANSÓW PUBLICZNYCH, PRZEW. KOMITETU DO SPRAW POŻYTKU PUBLICZNEGO"
effective_date_notes: "art. 95 w zakresie art. 21 ust. 1 pkt 6, art. 106 pkt 1 i pkt 4 lit. a oraz art. 116 pkt 4 wchodzą w życie z dniem 2 stycznia 2016 r."
parliamentary_prints_count: "2"
references_count: "8"
text_variants_count: "5"
has_pdf: "true"
keywords: "kodeks karny skarbowy, gry losowe i zakłady wzajemne, podatki, sprawozdawczość, zezwolenia, kary pieniężne i porządkowe, świadectwa i dyplomy, koncesje, karne skarbowe prawo, opłaty"
---
...
5. Akcję (udziały) w spółkach, o których mowa w ust. 4, może nabywać lub obejmować:
...
2) członkowie zarządu, rady nadzorczej lub komisji rewizyjnej spółki posiadają obywatelstwo polskie lub obywatelstwo państwa członkowskiego Unii Europejskiej, państwa członkowskiego Europejskiego Stowarzyszenia Wolnego Handlu (EFTA) - strony umowy o Europejskim Obszarze Gospodarczym lub Organizacji Współpracy Gospodarczej 5 Rozwoju;
...
6. W zakresie gier objętych monopolem państwa minister właściwy do spraw finansów publicznych może uznać za równoważne ze świadectwami zawodowymi świadectwa wydane przez wyspecjalizowaną organizację prowadzącą szkolenia w zakresie gier hazardowych. Podmiot wykonujący monopol jest obowiązany przedłożyć ministrowi właściwemu do spraw finansów publicznych program tych szkoleń.

7. O wydanie świadectwa zawodowego albo uznanie świadectwa, o którym mowa w ust. 6, występuje podmiot urządzający gry hazardowe.
...
Minister właściwy do spraw finansów publicznych może cofnąć, w drodze decyzji, świadectwo zawodowe lub uznanie świadectwa, jeżeli osoba, która je uzyskała, przestała spełniać warunki określone w art. 25 ust. 1 pkt 1 lub 3.
...
2. W grach losowych, z wyjątkiem loterii fantowych i loterii promocyjnych, mogą uczestniczyć wyłącznie osoby, które ukończyły 18 lat.
...
2. Spółka prowadząca działalność w zakresie gier liczbowych, loterii pieniężnych lub zakładów wzajemnych może powierzyć innemu podmiotowi, na podstawie umowy agencyjnej, sprzedaż losów lub innych dowodów udziału w grze oraz przyjmowanie zakładów i stawek, a także wypłatę (wydanie) wygranych do wysokości określonej w regulaminie gry lub zakładu.
...
### Rozdział 5. Koncesje i zezwolenia
...
8) w przypadku zakładów wzajemnych - przewidywany rodzaj oraz liczbę zakładów;
...
2) nazwę i status prawny podmiotu występującego z wnioskiem, a w przypadku spółek handlowych również aktualny odpis z Krajowego Rejestru Sądowego;
...
a) zaświadczenie właściwego naczelnika urzędu skarbowego o pokryciu kapitału zakładowego z ujawnionych źródeł przychodów - w przypadku akcjonariusza (wspólnika) będącego osobą fizyczną, reprezentującego co najmniej jedną setną kapitału zakładowego spółki, jeżeli podmiotem występującym z wnioskiem jest spółka handlowa,
...
2. Wniosek o udzielenie zezwolenia na urządzenie loterii fantowej lub gry bingo fantowe, w której wartość puli wygranych nie przekracza wysokości kwoty bazowej, o której mowa w art. 70, zawiera, zamiast dokumentów, o których mowa w ust. 1 pkt 10-12, odpowiednio:
...
2) oświadczenie o niezaleganiu z zapłatą podatków stanowiących dochód budżetu państwa oraz składek na ubezpieczenia społeczne oraz ubezpieczenie zdrowotne;
...
2. Jedno zezwolenie jest udzielane na prowadzenie jednego salonu gry bingo pieniężne albo określonej liczby punktów przyjmowania zakładów wzajemnych.
...
2. W przypadku prowadzenia działalności w zakresie zakładów wzajemnych termin, o którym mowa w ust. 1 pkt 6, dotyczy rozpoczęcia działalności we wszystkich punktach przyjmowania zakładów wzajemnych.
...
1. Aktualny odpis z Krajowego Rejestru Sądowego nie może być wystawiony wcześniej niż na miesiąc przed dniem złożenia wniosku.
...
4. W przypadku podmiotów prowadzących działalność w zakresie zakładów wzajemnych obowiązek podatkowy powstaje z dniem rozpoczęcia wykonywania działalności w pierwszym z punktów objętych zezwoleniem.
...
1. Tworzy się Fundusz Rozwoju Kultury Fizycznej, którego dysponentem jest minister właściwy do spraw kultury fizycznej i sportu.
...
1. Podatnicy prowadzący działalność w zakresie gier na automatach o niskich wygranych uiszczają podatek od gier w formie zryczałtowanej w wysokości 2 000 zł miesięcznie od gier urządzanych na każdym automacie.
