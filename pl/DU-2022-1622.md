---
title: "Obwieszczenie Marszałka Sejmu Rzeczypospolitej Polskiej z dnia 23 czerwca 2022 r. w sprawie ogłoszenia jednolitego tekstu ustawy o zużytym sprzęcie elektrycznym i elektronicznym"
identifier: "DU-2022-1622"
country: "pl"
rank: "obwieszczenie"
publication_date: "2022-06-23"
last_updated: "2022-06-23"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2022/1622"
department: "MARSZAŁEK SEJMU"
eli: "DU/2022/1622"
display_address: "Dz.U. 2022 poz. 1622"
internal_address: "WDU20220001622"
publisher: "DU"
volume: "0"
position: "1622"
...
3) ustawą z dnia 7 kwietnia 2022 r. o wyrobach medycznych

oraz zmian wynikających z przepisów ogłoszonych przed dniem 21 czerwca 2022 r.

2. Podany w załączniku do niniejszego obwieszczenia tekst jednolity ustawy nie obejmuje:

1) art. 18 i art. 22 ustawy z dnia 4 lipca 2019 r. o zmianie ustawy o odpadach oraz niektórych innych ustaw , które stanowią:
...
2) odnośnika nr 1 oraz art. 19 ustawy z dnia 17 listopada 2021 r. o zmianie ustawy o odpadach oraz niektórych innych ustaw , które stanowią:
...
3) odnośników nr 1 i nr 3 oraz art. 148 ustawy z dnia 7 kwietnia 2022 r. o wyrobach medycznych , które stanowią:
...
1. Marszałek województwa wterminie do dnia 30 października roku następującego po roku kalendarzowym, w którym wniesiono zabezpieczenie finansowe, dokonuje rozliczenia tego zabezpieczenia.
...
2. Dystrybutor, dostarczając nabywcy sprzęt przeznaczony dla gospodarstw domowych, obowiązany jest do nieodpłatnego odbioru zużytego sprzętu pochodzącego z gospodarstw domowych wmiejscu dostawy tego sprzętu, o ile zużyty sprzęt jest tego samego rodzaju i pełnił te same funkcje co sprzęt dostarczony.
...
2. Prowadzący punkt serwisowy jest obowiązany do umieszczenia w punkcie serwisowym wwidocznym miejscu informacji o punktach zbierania zużytego sprzętu.
...
9. Masę odpadów powstałych ze zużytego sprzętu poddanych recyklingowi iinnym niż recykling procesom odzysku ustala się odpowiednio na podstawie zaświadczenia potwierdzającego recykling oraz zaświadczenia potwierdzającego inne niż recykling procesy odzysku.
...
5. W przypadku braku dodatkowej ewidencji, o której mowa w art. 22 ust. 1, lub prowadzenia jej wsposób nierzetelny informacje o masie wprowadzonego do obrotu sprzętu marszałek województwa określa w drodze oszacowania.
...
2. Wcelu wykazania, że przemieszczany używany sprzęt nie jest zużytym sprzętem, posiadacz używanego sprzętu organizujący jego przemieszczanie:
...
1. Główny Inspektor Ochrony Środowiska sporządza i przekazuje ministrowi właściwemu do spraw klimatu, w terminie do dnia 30 lipca każdego roku, roczny raport o funkcjonowaniu systemu gospodarki zużytym sprzętem w poprzednim roku kalendarzowym.

2. Minister właściwy do spraw klimatu określi, w drodze rozporządzenia, zakres i wzór rocznego raportu o funkcjonowaniu systemu gospodarki zużytym sprzętem, kierując się potrzebą oceny funkcjonowania systemu gospodarki zużytym sprzętem.
...
16. Rejestr autoryzowanych przedstawicieli zawiera numery rejestrowe iinformacje zawarte we wnioskach o wpis do rejestru autoryzowanych przedstawicieli.
...
6. Główny Inspektor Ochrony Środowiska dostosuje rejestr do wymogów, o których mowa w ust. 1, oraz w art. 116, wterminie 6 miesięcy od dnia wejścia w życie niniejszej ustawy.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2022/1622/text.pdf)
