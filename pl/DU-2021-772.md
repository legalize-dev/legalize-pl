---
title: "Porozumienie Administracyjne w sprawie stosowania Umowy między Rzecząpospolitą Polską a Republiką Turcji o zabezpieczeniu społecznym, podpisane w Warszawie dnia 17 października 2017 r"
identifier: "DU-2021-772"
country: "pl"
rank: "umowa_miedzynarodowa"
publication_date: "2017-10-17"
last_updated: "2017-10-17"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2021/772"
eli: "DU/2021/772"
display_address: "Dz.U. 2021 poz. 772"
internal_address: "WDU20210000772"
publisher: "DU"
volume: "0"
position: "772"
...
Instytucje łącznikowe wymienione w ustępie 1 uzgodnią wspólne procedury i formularze niezbędne do stosowania Umowy i niniejszego Porozumienia Administracyjnego.

Władza właściwa każdej z Umawiających się Stron może wyznaczyć inne, niż te, o których mowa w ustępie 1, instytucje łącznikowe. O takiej zmianie zobowiązana jest powiadomić niezwłocznie władzę właściwą drugiej Umawiającej się Strony.
...
### Rozdział 2. POSTANOWIENIA DOTYCZĄCE STOSOWANEGO USTAWODAWSTWA
...
w Republice Turcji, przez Zakład Zabezpieczeń Społecznych (SGK), w zakresie stosowania ustawodawstwa dotyczącego ubezpieczeń społecznych;
...
Instytucja właściwa Umawiającej się Strony, która wydaje zaświadczenie, o którym mowa w ustępie 1, dostarcza kopię tego zaświadczenia pracownikowi lub osobie pracującej na własny rachunek, pracodawcy i instytucji łącznikowej lub instytucji właściwej drugiej Umawiającej się Strony.

Wniosek o zgodę, o której mowa w artykule 7 ustęp 1 punkt 1 Umowy, powinien być złożony do instytucji łącznikowej przed końcem 24 -miesięcznego okresu delegowania. W przypadku otrzymania wniosku o przedłużenie okresu delegowania po dniu utraty ważności zaświadczenia instytucja łącznikowa Umawiającej się Strony, która otrzymała wniosek, sprawdza przyczyny opóźnienia i w razie stwierdzenia, że opóźnienie jest uzasadnione, przesyła wniosek instytucji łącznikowej drugiej Umawiającej się Strony w celu uzyskania zgody.

Do stosowania artykułu 7 ustęp 2 Umowy wyznacza się:

w Republice Turcji, Zakład Zabezpieczeń Społecznych (SGK) w Ankarze;

w Rzeczypospolitej Polskiej, Zakład Ubezpieczeń Społecznych (ZUS), Centrala w Warszawie.

### Rozdział 3. POSTANOWIENIA DOTYCZĄCE ŚWIADCZEŃ
...
### Rozdział 4. POSTANOWIENIA RÓŻNE I KOŃCOWE

##### Artykuł 7 Pomoc administracyjna
...
##### Artykuł 8 Wymiana danych statystycznych
...
**MINISTER RODZINY, PRACY I POLITYKI SPOŁECZNEJ RZECZYPOSPOLITEJ POLSKIEJ**

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

**MINISTER PRACY I ZABEZPIECZENIA SPOŁECZNEGO REPUBLIKI TURCJI**

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Dodatek - Porozumienie w języku tureckim

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Dodatek - Porozumienie w języku angielskim
