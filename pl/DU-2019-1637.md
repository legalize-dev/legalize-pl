---
title: "Rozporządzenie Ministra Kultury i Dziedzictwa Narodowego z dnia 14 sierpnia 2019 r. w sprawie podstaw programowych kształcenia w zawodach szkolnictwa artystycznego"
identifier: "DU-2019-1637"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2019-08-14"
last_updated: "2019-08-14"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2019/1637"
department: "MIN. KULTURY I DZIEDZICTWA NARODOWEGO"
eli: "DU/2019/1637"
display_address: "Dz.U. 2019 poz. 1637"
internal_address: "WDU20190001637"
publisher: "DU"
volume: "0"
position: "1637"
...
has_pdf: "true"
keywords: "szkolnictwo, muzycy, oświata i wychowanie, szkolnictwo artystyczne"
---
# Rozporządzenie Ministra Kultury i Dziedzictwa Narodowego z dnia 14 sierpnia 2019 r. w sprawie podstaw programowych kształcenia w zawodach szkolnictwa artystycznego
...
1. Począwszy od roku szkolnego 2019/2020 efekty kształcenia wspólne dla zawodów określone w załączniku nr 1 do rozporządzenia oraz podstawy programowe określone w załącznikach nr 2-6 do rozporządzenia stosuje się we wszystkich klasach (semestrach) publicznych szkół artystycznych.
...
## Załącznik nr 1 - Efekty kształcenia wspólne dla zawodów artystycznych na koniec nauki w szkole prowadzącej kształcenie w zawodach szkolnictwa artystycznego
...
7) specjalizacje w specjalności techniki renowacyjne:

a) renowacja elementów architektury,

b) renowacja mebli i wyrobów snycerskich;

8) specjalizacje w specjalności techniki scenograficzne:
...
EFEKTY KSZTAŁCENIA W ZAWODZIE PLASTYK PO ZAKOŃCZENIU NAUKI W LICEUM SZTUK PLASTYCZNYCH I POLICEALNEJ SZKOLE PLASTYCZNEJ
...
8) zna i rozpoznaje podstawowe techniki plastyczne oraz określa ich cechy charakterystyczne, przypisując te techniki artystom, którzy się w nich specjalizowali; charakteryzuje i rozpoznaje min. enkaustyke, mozaikę, witraż, fresk, miniaturę, malarstwo tablicowe i sztalugowe, temperowe, olejne, pastelowe, akwarelowe, akrylowe, drzeworyt, miedzioryt, akwafortę, litografię, sitodruk, chryzelefantynę, rzeźbę w drewnie, kamieniu, złocie, relief, odlew w brązie, emalię, intarsję i inkrustację;

9) wymienia dawne i współczesne dyscypliny artystyczne oraz potrafi wskazać dzieła współczesne, które wymykają się klasyfikacjom; rozpoznaje i charakteryzuje min. collage, instalację, assmablage, emballage, ready made, dekalkomanię, frottage, happening i performance;
...
12) określa funkcję i jej wpływ na kształt dzieła, identyfikuje min. takie funkcje jak: sakralna, sepulkralna, estetyczna i dekoracyjna, dydaktyczna, ekspresywna, użytkowa, reprezentacyjna, kommemoratywna, propagandowa, kompensacyjna, mieszkalna i rezydencjonalna, obronna, magiczna.
...
1. Wiadomości z zakresu podstaw projektowania Uczeń:
...
2) opanowuje podstawowe wiadomości z zakresu tej dziedziny;
...
3) odpowiednio planuje pracę zgodnie z przedłożonym do realizacji scenariuszem i scenopisem, dzieli ją na etapy: preprodukcji, produkcji, postprodukcji;
...
9) udźwiekawia animację filmową z realizatorem dźwięku, a w przypadku prostego projektu - samodzielnie;
...
1) rozróżnia podstawowe techniki formowania ceramiki, takie jak: modelowanie ręczne, odlewanie, toczenie;

2) rozróżnia i charakteryzuje właściwości materiałów ceramicznych głównych i pomocniczych, takich jak:
...
7) projektuje, dokonuje pomiaru, przeskalowuje i sporządza rysunek techniczny formy przestrzennej ipółprzestrzennej;
...
8) rozróżnia sposoby obróbki materiałów użytych do wykonania zabawki, min. z drewna i tkanin, oraz możliwości techniczne stosowanych narzędzi, przyrządów, przyborów i maszyn;
...
d) komunikatów w publicznej przestrzeni, np. witryn internetowych i banerów,
...
3) świadomie posługuje się środkami wyrazu artystycznego (kompozycja, światło, kolor, forma, faktura, znak, litera itp.) i technicznego (związanego min. z miejscem, podłożem);
...
7) w pracach projektowych i realizacyjnych stosuje zasady prawa regulujące tworzenie malarstwa w zarówno w przestrzeniach publicznych, jak i innych;
...
1. Wiadomości z zakresu witrażownictwa Uczeń:
...
4) rozróżnia i definiuje podstawowe technologie obróbki oraz zdobienia szkła płaskiego: matowanie, szlifowanie, malowanie na zimno i na gorąco, składanie witrażu w technikach klasycznych i współczesnych;
...
4) podejmuje działania niekonwencjonalne, takie jak: mieszanie technik, łączenie różnych materiałów, eksperymentowanie;
...
5) bezpiecznie i sprawnie posługuje się narzędziami, przyrządami i urządzeniami stosowanymi podczas pracy;
...
1) rozróżnia, identyfikuje i charakteryzuje rodzaje makijażu, fryzur i kanonów estetyki: antyku, średniowiecza, renesansu, baroku, rokoka, klasycyzmu, romantyzmu, XIX i XX wieku; charakteryzuje makijaże typowe dla wybranych grup etnicznych (np.: makijaż gejszy, makijaż hinduski oraz wybrane teatralne charakteryzacje historyczne, np. commedia dell'arte);
...
6) konsekwentnie stosuje kolorystykę w charakteryzacji, makijażu, we fryzurze i w zaroście;
...
1) wykonuje i kreuje podstawowe elementy modelatorskie i dekoratorskie scenografii;
...
3) rozróżnia i charakteryzuje style i kierunki historyczne w dekoratorstwie oraz najistotniejsze zjawiska w historii technik scenograficznych;
...
1) organizuje warsztat pracy, dobierając właściwe narzędzia, materiały i technologie, oraz środki ochrony osobistej:

a) obsługuje i bezpiecznie korzysta z różnych rodzajów narzędzi, przyrządów do wykonania elementów modelatorskich i dekoratorskich,

b) stosuje odpowiednie metody i zasady modelowania i dekorowania, łączenia oraz plastycznego wykończenia elementów scenografii,

c) podczas pracy z materiałami wymagającymi ochrony ciała stosuje odzież ochronną, rękawice, maski, okulary;
...
4) podejmuje działania niekonwencjonalne, takie jak: korzystanie w modelatorstwie z multimediów oraz doświadczeń innych dyscyplin i dziedzin. Specjalizacja: STYLIZACJA KOSTIUMU I KREACJA WIZERUNKU
...
Wśród sal lekcyjnych powinny znajdować się pracownie do prowadzenia zajęć specjalizacyjnych wyposażone w odpowiedni sprzęt, a także pomieszczenia do innych zajęć wynikających z tygodniowego lub semestralnego rozkładu zajęć.
...
Minimalna liczba godzin zajęć artystycznych realizowanych w liceum sztuk plastycznych wynosi 65 godzin (w ujęciu tygodniowym w cyklu kształcenia); w policealnej szkole plastycznej wynosi 1110 godzin (w ujęciu semestralnym w cyklu kształcenia).
...
Uczeń jest przygotowany do prezentowania umiejętności w zakresie akrobatyki podczas pokazu sztuki cyrkowej.
...
4) posiada lekkość i sprężystość mchów oraz wysoką sprawność psychofizyczną;
...
1. Zdobycie wiedzy z zakresu technik i zasad stosowanych w ekwilibrystyce Uczeń:
...
2. Rozwijanie koordynacji mchowej

Uczeń rozwija i doskonali: rytmizację mchu, równowagę, czas reakcji, orientację ruchowo-przestrzenną, zdolność łączenia mchu, zdolność różnicowania mchu, zdolność dostosowywania mchu.
...
1) postrzega sztukę cyrkową jako jeden z filarów życia kulturalnego;

2) określa wpływ sztuki cyrkowej na inne dziedziny sztuki;

3) samodzielnie analizuje, wyciąga wnioski i wyraża swoje zdanie na temat sztuki cyrkowej;

4) aktywnie uczestniczy w życiu artystycznym, śledzi i stara się przewidywać nowe trendy.
...
Uczeń posługuje się podstawowym zasobem środków językowych (leksykalnych, gramatycznych, ortograficznych oraz fonetycznych), umożliwiającym realizację pozostałych wymagań ogólnych.

2. Rozumienie wypowiedzi

Uczeń rozumie proste wypowiedzi ustne artykułowane wyraźnie, w standardowej odmianie języka, a także proste wypowiedzi pisemne, w tym ustne i pisemne wypowiedzi dotyczące wykonywania typowych czynności zawodowych.

3. Tworzenie wypowiedzi

Uczeń samodzielnie tworzy krótkie, proste, spójne i logiczne wypowiedzi ustne i pisemne, w tym wypowiedzi umożliwiające komunikowanie się w środowisku pracy.

4. Reagowanie na wypowiedzi

Uczeń uczestniczy w rozmowie i w typowych sytuacjach, w tym związanych z komunikowaniem się w środowisku pracy; reaguje w sposób zrozumiały, adekwatnie do sytuacji komunikacyjnej, ustnie lub pisemnie w formie prostego tekstu.

5. Przetwarzanie wypowiedzi

Uczeń zmienia formę przekazu ustnego lub pisemnego, w tym prostych tekstów związanych z wykonywaniem typowych czynności zawodowych.
...
13) świat przyrody (np. pogoda, pory roku, klimat, rośliny i zwierzęta, krajobraz, zagrożenie i ochrona środowiska naturalnego);

14) państwo i społeczeństwo (np. wydarzenia i zjawiska społeczne, problemy współczesnego świata);

15) elementy wiedzy o bezpieczeństwie i higienie pracy oraz o podejmowaniu i prowadzeniu działalności gospodarczej.

2. Rozumienie wypowiedzi

Uczeń rozumie proste wypowiedzi ustne, w tym dotyczące wykonywania typowych czynności zawodowych (np. rozmowy, wiadomości, komunikaty, ogłoszenia, instrukcje), artykułowane wyraźnie, w standardowej odmianie języka:
...
Uczeń tworzy krótkie, proste, spójne i logiczne wypowiedzi ustne, w tym wypowiedzi umożliwiające komunikowanie się w środowisku pracy:
...
Uczeń potrafi uczestniczyć w rozmowie i w typowych sytuacjach - w tym związanych z komunikowaniem się w środowisku pracy potrafi reagować w sposób zrozumiały, odpowiednio do sytuacji komunikacyjnej w formie prostego tekstu, w szczególności:
...
Uczeń potrafi zmieniać formę przekazu ustnego lub pisemnego - w tym prostych tekstów związanych z wykonywaniem typowych czynności zawodowych:
...
4) przedstawia publicznie wcześniej przygotowany materiał, np. prezentację, film.
...
1) dysponuje umiejętnościami potrzebnymi do stworzenia i wykonania wybranej scenicznej charakteryzacji dla siebie i innych;

2) potrafi dopasować makijaż do odpowiedniego stylu i układu akcji scenicznej.
...
ZASADY ZDROWEGO ŻYWIENIA Z ELEMENTAMI ANATOMII CELE KSZTAŁCENIA - WYMAGANIA OGÓLNE

1. Zdobycie wiedzy o zasadach zdrowego żywienia i zdrowego trybu życia.

Uczeń:

1) zdobywa świadomość zdrowotną oraz nawyki dbania o własne zdrowie w życiu codziennym;

2) przyswaja i utrwala wiedzę z zakresu podstawowych zasad zdrowego żywienia;

3) poznaje i stosuje w praktyce metody żywienia uwzględniające zapotrzebowanie energetyczne organizmu;

4) nabywa umiejętność planowania i konstruowania odpowiedniej dla uprawianej dyscypliny piramidy pokarmowej;

5) zdobywa wiedzę o podstawowych i niezbędnych dla człowieka składnikach odżywczych.

2. Nabycie podstawowej wiedzy z zakresu anatomii i biomechaniki.

Uczeń:

1) poznaje anatomię czynnościową człowieka ze szczególnym uwzględnieniem układu ruchu;

2) zapoznaje się z wybranymi zagadnieniami anatomii czynnościowej oraz funkcjonowaniem układu pokarmowego i nerwowego;

3) zdobywa wiedzę w zakresie możliwości psychomotorycznych organizmu ludzkiego oraz wpływu wykonywanych ćwiczeń na rozwój sprawności fizycznej.
...
1) posiada świadomość zdrowotną;

2) utrwala nawyki dbania o własne zdrowie w codziennych sytuacjach w szkole i w domu, w tym właściwe nawyki żywieniowe;

3) utrwala wiedzę z zakresu podstawowych zasad zdrowego żywienia i stosuje ją dla podniesienia własnej sprawności fizycznej;

4) stosuje w praktyce metody żywienia uwzględniające zapotrzebowanie energetyczne organizmu zarówno przed treningiem, jak i po nim;

5) poosiada umiejętność planowania i konstruowania odpowiedniej dla uprawianej dyscypliny piramidy pokarmowej, potrafi stosować wiedzę o piramidzie pokarmowej dla zachowania odpowiednich proporcji w diecie własnej;

6) dysponuje wiedzą o podstawowych i niezbędnych dla człowieka składnikach odżywczych (białko, węglowodany, tłuszcze, witaminy, składniki mineralne, woda i błonnik) oraz umie określać ich źródła pochodzenia i zapotrzebowanie organizmu na poszczególne składniki.

2. Nabycie podstawowej wiedzy z zakresu anatomii i biomechaniki.

Uczeń:

1) umie wykorzystać wiedzę z zakresu anatomii do dostosowania ćwiczeń do możliwości własnego organizmu;

2) potrafi dokonać samooceny i samokontroli w zakresie sprawności fizycznej i prawidłowej postawy;

3) stosuje w praktyce życia codziennego i treningów pozyskaną wiedzę o układzie pokarmowym i nerwowym, dostosowuje ją do swojej specjalności w sposób zapewniający jak najlepsze efekty zdrowotne i wydolnościowe;

4) stosuje wiedzę z zakresu możliwości psychomotorycznych organizmu ludzkiego oraz wpływu wykonywanych ćwiczeń na rozwój sprawności fizycznej;

5) umie odwoływać się do wiedzy dotyczącej higieny człowieka oraz umiejętności uzyskanych na innych zajęciach.
...
3. Praktyczne stosowanie różnych form i sposobów żonglowania Uczeń:
...
Minimalna liczba godzin zajęć artystycznych realizowanych w szkole sztuki cyrkowej wynosi: 58 godzin (w ujęciu tygodniowym w cyklu kształcenia).
...
8) wykonuje przy drążku i na środku sali ćwiczenia z grupy: pliés, battements, zwrotów i obrotów (np. pirouettes, tours), formy ronds de jambe oraz treści ćwiczeń z zastosowaniem półpalców i łączników tanecznych (np. flic-flack, glissades, pas de bourrees, pas tombe, pas chasse);
...
2. Taniec ludowy i charakterystyczny Uczeń:
...
1) posługuje się terminologią związaną z dziedzinami sztuki wykorzystywanymi w pracy twórczej - min. muzyką, literaturą, teatrem, tańcem;
...
7) buduje konsekwentnie postać sceniczną, uwzględniając min. jej charakter, wiek, epokę, język;
...
a) jednouderzeniowe (step, brush, spunk, heel, scuf, toe, bali, stomp),
...
6) kontroluje swoją prace nad formą - przed lustrem i bez lustra;
...
Zaleca się, aby szkoła posiadała sale lekcyjne o odpowiedniej powierzchni i akustyce niezbędne do prowadzenia zajęć i gwarantujące komfort pracy nauczyciela i uczniów (ze szczególnym uwzględnieniem odpowiedniego oświetlenia i prawidłowej wentylacji). Szkoła powinna zapewniać instrumentarium oraz akcesoria umożliwiające realizację podstaw programowych we wszystkich prowadzonych specjalnościach.

Wśród sal lekcyjnych powinny znajdować się pomieszczenia przystosowane do wykonawstwa muzycznego posiadające sprzęt nagłaśniający, do realizacji zajęć ruchowych (posiadające podłogę baletową lub parkiet oraz lustra), a także pomieszczenia do innych zajęć wynikających z semestralnego rozkładu zajęć.
...
Minimalna liczba godzin zajęć artystycznych realizowanych w policealnej szkole muzycznej wynosi: 1628 godzin (w ujęciu semestralnym w cyklu kształcenia).

## Załącznik nr 5 - Podstawa programowa kształcenia w zawodzie muzyk

EFEKTY KSZTAŁCENIA PO ZAKOŃCZENIU NAUKI W OGÓLNOKSZTAŁCĄCEJ SZKOLE MUZYCZNEJ I STOPNIA ORAZ W SZKOLE MUZYCZNEJ I STOPNIA Uczeń:
...
OBOWIĄZKOWE ZAJĘCIA EDUKACYJNE DLA OGÓLNOKSZTAŁCĄCEJ SZKOŁY
...
2. Elementarna wiedza i umiejętności z zakresu techniki wokalnej Uczeń świadomie i umiejętnie posługuje się aparatem głosowym.
...
5) poszerza swoją wiedzę, min. słuchając nagrań i czytając literaturę fachową, a także korzystając z technologii informacyjnej i komunikacyjnej;
...
11) zna i stosuje właściwą aplikaturę w obrębie skali B1-b^1^;
...
14) realizuje przewidziane programem nauczania zadania techniczno-wykonawcze.
...
1) świadomie planuje swój rozwój zawodowy;
...
c) interwały, rodzaje trój dźwięków (dur, moll, zwiększony, zmniejszony) wraz z przewrotami oraz D^7^ i czterodźwięk zmniejszony z przewrotami;
...
6) w wykonywanym repertuarze potrafi określić charakterystyczne cechy epoki, stylu oraz kompozytora, np. technika imitacyjna w polifonii barokowej, faktura homofoniczna w utworach klasycznych, tempo rabato w romantycznej kantylenie.
...
3) systematycznie i efektywnie organizuje czas samodzielnej pracy;
...
5) na egzaminie końcowym prezentuje następujący program:
...
3) poznaje pojęcia i terminy muzyczne, historię gitary, jej budowę i zasady konserwacji;

4) uczestniczy w wydarzeniach kulturalnych i poznaje literaturę muzyczną przedmiotu.
...
7) poszerza swoją wiedzę, min. słuchając nagrań, a także korzystając z technologii informacyjnej i komunikacyjnej;

8) aktywnie uczestniczy w życiu muzycznym szkoły i środowiska jako wykonawca.

INSTRUMENT GŁÓWNY - HARFA HACZYKOWA / PEDAŁOWA
...
1) pod kierunkiem nauczyciela poznaje sposoby samodzielnej pracy w zakresie jej organizacji, kontroli i samooceny;

2) poprzez słuchanie nagrań uczy się kształtować własny gust estetyczny.
...
7) właściwie realizuje zawarte w utworze oznaczenia artykulacyjne oraz typowe dla harfy wybrane efekty brzmieniowe, takie jak: glissanda, flażolety, arpeggia, zarywanie strun paznokciami, pres de la table, wykonywanie efektów perkusyjnych;
...
1) dysponuje elementarną wiedzą w zakresie historii harfy oraz jej budowy (umie nazwać poszczególne, najważniejsze części instrumentu), zna zasady prostej konserwacji instrumentu min. umie samodzielnie założyć strunę;
...
1) zdobywa wiedzę z zakresu zasad muzyki i notacji muzycznej;
...
2) chętnie uczestniczy w życiu muzycznym i kulturalnym, biorąc udział w audycjach szkolnych i koncertach pozaszkolnych.
...
1) kształci umiejętności prawidłowego posługiwania się aparatem gry;

2) zdobywa podstawy techniki klawesynowej;

3) poznaje zasady interpretacji materiału muzycznego;

4) rozwija własną muzykalność.
...
1) poznaje różne odmiany klawesynów;

2) poznaje wybraną literaturę przedmiotu oraz reprezentatywne utwory z repertuaru klawesynowego skomponowane w różnych stylach i okresach historycznych.

3. Przygotowanie do samodzielnej pracy oraz aktywnego uczestnictwa w życiu kulturalnym i społecznym

Uczeń:

1) postępuje zgodnie z zasadami etyki;

2) poznaje i stosuje zasady komunikacji społecznej;

3) uczestniczy w życiu kulturalnym jako odbiorca sztuki, a także poprzez grę solową i kameralną.
...
8) poszerza swoją wiedzę i korzysta z zasobów kultury w różnych jej formach, min. słuchając nagrań i czytając literaturę fachową;
...
1) rozwija muzyczne zainteresowania;

2) uczęszcza na koncerty i słucha muzyki z nagrań;

3) uczestniczy w życiu muzycznym szkoły i środowiska;

4) poznaje wiedzę dotyczącą charakterystycznych stylów wykonawczych.

2. Poznanie teoretycznych podstaw gry na instrumencie

Uczeń:

1) poznaje zasady notacji oraz podstawowe terminy i pojęcia muzyczne niezbędne do odczytania i realizacji tekstu muzycznego;

2) stosuje w praktyce estradowej style wykonawcze;

3) zdobywa wiedzę z zakresu historii, budowy instrumentu oraz zasad jego konserwacji.

3. Opanowanie podstawowych umiejętności gry na instrumencie

Uczeń:

1) kształci umiejętność zachowania prawidłowej postawy podczas gry na instrumencie, oraz udoskonala sprawność aparatu gry prawej i lewej ręki;

2) poszerza spektrum umiejętności technicznych i interpretacyjnych oraz doskonali umiejętność prezentacji estradowej;

3) poznaje zasady precyzyjnego strojenia instrumentu;

4) rozwija podstawy techniki instrumentalnej oraz wrażliwość na jakość dźwięku i intonację;

5) podejmuje próby improwizacji prostych tematów melodycznych oraz doskonali umiejętność gry „ze słuchu”.

4. Kształcenie umiejętności samodzielnej pracy nad repertuarem

Uczeń:

1) poznaje pod kierunkiem nauczyciela sposoby samodzielnej pracy w zakresie jej organizacji, stosowania odpowiednich technik oraz kształci umiejętność kontrolowania własnej gry i samooceny;

2) rozwija, wdraża i stosuje nabyte umiejętności samodzielnej pracy w praktyce solistycznej i kameralistycznej.

5. Przygotowanie do występów publicznych

Uczeń

1) poznaje zasady występów publicznych, nabywa umiejętności koncentracji i właściwego skupienia celem prezentacji estradowej;

2) poznaje i stosuje sposoby pokonywania sytuacji trudnych związanych z występem estradowym;

3) współpracuje z akompaniatorem i rozwija umiejętności współpracy z instrumentalistami w ramach zespołu/orkiestry.
...
4) zna budowę gam durowych i molowych oraz pasaży (do czterech znaków przykluczowych);
...
6) wykorzystuje równe sposoby artykulacji: detaché, martelé, portato, legato, staccato i pizzicato;
...
9) podejmuje próby wibracji dźwięku, udoskonalają oraz swobodnie stosuje;
...
1) zna i stosuje podstawowe zasady odpowiedniego zachowania się i prezencji na estradzie;
...
8) jest przygotowany do kontynuowania nauki.
...
12) realizuje zadania techniczno-wykonawcze przewidziane programem szkoły I stopnia.
...
3) rozwija umiejętności techniczne w zakresie gry na manuale i pedale.
...
1. Zdobycie podstawowej wiedzy ogólnomuzycznej Uczeń:
...
3) dąży do „ożywiania” dźwięku organowego poprzez kształtowanie wrażliwości artykulacyjnej i umiejętne stosowanie tempo rabato.
...
1) poprzez udział w wydarzeniach kulturalnych oraz słuchanie nagrań świadomie kształtuje własny gust estetyczny i kształci umiejętność właściwego zachowania podczas różnych wydarzeń kulturalnych;
...
4) rozwiązuje problemy min. poprzez realizowanie wskazówek nauczyciela;
...
2) poszerza swoją wiedzę, min. słuchając nagrań i czytając literaturę fachową, a także korzystając z technologii informacyjnej i komunikacyjnej;
...
2) dobywa podstawową wiedzę o muzyce i o instrumencie.
...
1) poszerza zainteresowania muzyczne poprzez uczęszczanie na koncerty, słuchanie muzyki z różnych dostępnych źródeł;
...
6) wykazuje się techniką gry, w ramach której stosuje właściwy podział smyczka i operuje niezbędnymi sposobami artykulacji (detache, legato, portato, martele, staccato, sautillé) oraz ozdobnikami;
...
10) prawidłowo realizuje dwudźwieki i akordy;
...
b) struktury harmoniczne: interwały proste i złożone (nona, decyma) gamowłaściwe i w oderwaniu od tonacji, trój dźwięki majorowe i minorowe w postaci zasadniczej i w przewrotach, trój dźwięki zmniejszone i zwiększone, triadę harmoniczną i TVI w poznanych odmianach gam, dominantę septymową w postaci zasadniczej i w przewrotach z rozwiązaniem, czterodźwięk zmniejszony, rodzaje kadencji (doskonała, plagalna, zawieszona, zwodnicza); zagadnienia są realizowane w tonacjach do pięciu znaków przykluczowych,
...
b) czołowych kompozytorów: J. S. Bacha, W. A. Mozarta, L. van Beethovena, F. Chopina, K. Szymanowskiego, I. Stawińskiego, W. Lutosławskiego;
...
5) buduje pentatonike bezpółtonową, skale modalne, skale całotonową i chromatyczną nieregularną;
...
OBOWIĄZKOWE ZAJĘCIA EDUKACYJNE DLA SZKOŁY MUZYCZNEJ I STOPNIA AUDYCJE MUZYCZNE
...
8) opanował technikę gry w stopniu umożliwiającym dalsze kształcenie, stosuje prawidłowy podział smyczka oraz operuje podstawowymi sposobami artykulacji (detache, portato, legato, martele);
...
6) rozpoznaje i wskazuje cechy charakterystyczne epoki, stylu oraz kompozytora wykonywanych utworów, np. technika imitacyjna w polifonii barokowej, faktura homofoniczna w utworach klasycznych, tempo rabato i oddech w romantycznej kantylenie.
...
g) aktywność chwytu czubków palców, h) koordynację rak,

niezależność pracy rak i palców;
...
4) kształci podstawową technikę gry (koordynacja pracy obu rąk, niezależność palców, tłumienie strun, uderzenie tirando i apoyando, gra dwudźwięków, trój dźwięków, czterodźwięków i podstawowych akordów gitarowych, gra naturalnych i sztucznych flażoletów, chwyt barre, gra w pozycjach i zmiany pozycji, realizacja arpeggio, legato, tremolo, rasgueado i podstawowych ozdobników);
...
1) kształci prawidłowe posługiwanie się aparatem gry;
...
2) poznaje reprezentatywne utwory z literatury klawesynowej skomponowane w różnych epokach i stylach;

3) kształci umiejętności analizy i interpretacji materiału muzycznego.
...
3) uczestniczy w życiu kulturalnym szkoły i środowiska.
...
2) zdobywa wiedzę z zakresu historii, budowy instrumentu oraz zasad jego konserwacji.
...
6) operuje podstawowymi sposobami artykulacji: detaché, martelé, portato, legato, staccato i pizzicato;
...
1) zaznajamia się z obsługą i działaniem organów;
...
2) prawidłowo odczytuje zapis nutowy w kluczu wiolinowym i basowym;
...
4. Przygotowanie do udziału w życiu artystycznym oraz do występów publicznych Uczeń aktywnie uczestniczy w kulturze, różnych formach życia muzycznego szkoły i poza szkołą.
...
8) realizuje różnorodne formy swobodnej improwizacji na różnych instrumentach lub zestawach instrumentów.
...
5) operuje podstawowymi sposobami artykulacji: detache, martele, portato, legato, staccato i pizzicato prawą i lewą ręką;
...
1) rozwija uzdolnienia i zainteresowania muzyczne (dostosowane do wieku i predyspozycji) poprzez uczęszczanie na koncerty i słuchanie muzyki z nagrań;
...
3) realizuje w sposób odpowiedzialny powierzone mu zadania, min. w prostych formach muzykowania zespołowego;
...
6) wykazuje się podstawową techniką gry, stosuje właściwy podział smyczka i operuje podstawowymi sposobami artykulacji (detache, legato, portato, martele, staccato);
...
OBOWIĄZKOWE ZAJĘCIA EDUKACYJNE WSPÓLNE DLA WSZYSTKICH
...
a) formy dwu-, trzy- i wieloczęściowe:
...
1. Rozwijanie wiedzy teoretycznej, niezbędnej do wykonywania muzyki jazzowej Uczeń posługuje się zasobem pojęć i terminów muzycznych, umożliwiających rozumienie i tworzenie muzyki jazzowej.

2. Kształcenie umiejętności analizy utworów jazzowych

Uczeń rozpoznaje budowę formalną i harmonikę utworów jazzowych.

3. Zdobywanie wiedzy na temat współczesnych nurtów harmonii jazzowej Uczeń stosuje posiadaną wiedzę do opisu i analizy dzieł muzycznych.

4. Kształcenie umiejętności posługiwania się specyficznym dla jazzu zapisem nutowym Uczeń biegle czyta zapis nutowy, charakterystyczny dla jazzu.
...
7. Kształcenie umiejętności posługiwania się technikami improwizacji jazzowej Uczeń poznaje sposoby wykorzystania zasad improwizacji w zakresie śpiewu i instrumentalistyki.
...
2) stosuje reharmonizacje diatoniczną;

3) stosuje reharmonizacje za pomocą zmiany trybu akordów;

4) stosuje reharmonizacje za pomocą substytutu trzytonowego;

5) stosuje reharmonizacje za pomocą akordów blokowych i drop 2;
...
2. Umiejętność chronologicznego porządkowania epok w aspekcie szkół kompozytorskich, ośrodków artystycznych, stylów i postaci konstytuujących dzieje muzyki Uczeń:
...
3. Zdobywanie wiedzy w zakresie opisu, analizy i interpretacji dzieła muzycznego Uczeń stosuje posiadaną wiedzę do opisu, analizy i interpretacji dzieł muzycznych.

4. Poznawanie historii muzyki i literatury jazzowej

Uczeń samodoskonali się w zakresie historii muzyki jazzowej, gromadzi nagrania, wyszukuje, selekcjonuje i dokonuje oceny informacji o muzyce i jej dziejach, min. wykorzystując technologię informacyjną i komunikacyjną.
...
9) porządkuje chronologicznie: style, postaci kompozytorów reprezentatywnych dla stylu, techniki improwizacji i kompozycji, instrumentacje i obsady wykonawcze.
...
Uczeń poznaje metody pracy z wykorzystaniem min. wydawnictw nutowych, książkowych i fonograficznych, technik informacyjnych i programów komputerowych oraz uczestniczy w życiu muzycznym.
...
2) korzysta z literatury specjalistycznej, dostępnych technik informacyjnych, poznaje metody pracy z wykorzystaniem min. wydawnictw nutowych, książkowych i fonograficznych, technik informacyjnych i programów komputerowych oraz uczestniczy w życiu muzycznym;
...
EFEKTY KSZTAŁCENIA PO ZAKOŃCZENIU NAUKI W OGÓLNOKSZTAŁCĄCEJ SZKOLE MUZYCZNEJ II STOPNIA I W SZKOLE MUZYCZNEJ II STOPNIA Uczeń:
...
6) samodzielnie wyszukuje, dokonuje wyboru i oceny informacji z zakresu przedmiotów ogólnomuzycznych, min. wykorzystując technologię informacyjną i komunikacyjną;
...
2) osiada umiejętności właściwego zachowania się na estradzie, wiedzę dotyczącą znaczenia tremy scenicznej i stresu podczas publicznej prezentacji oraz niezbędną wiedzę dotyczącą pozamuzycznych elementów, wpływających na ogólne wrażenie artystyczne i odbiór występu.
...
a) swobodnego posługiwania się aparatem gry;

b) pełnego wykorzystywania sposobów kształtowania dźwięku na akordeonie;

c) gry a vista utworów o różnym stopniu trudności;
...
1) poprzez udział w koncertach doskonali umiejętność swobodnej prezentacji przed publicznością przy równoczesnym kreatywnym wyrażaniu swojej wrażliwości artystycznej.;
...
1) poprzez udział w wydarzeniach kulturalnych, lekturę literatury fachowej oraz słuchanie nagrań świadomie kształtuje własny gust estetyczny i kształci umiejętność właściwego zachowania podczas różnych wydarzeń kulturalnych;
...
3. Uzyskanie kompetencji niezbędnych do prezentacji estradowej Uczeń:
...
3) poszerza swoją wiedzę, min. słuchając nagrań i czytając literaturę fachową, a także korzystając z technologii informacyjnej i komunikacyjnej;
...
3. Kształcenie umiejętności samodzielnej pracy Uczeń:
...
d) różnorodnych sposobów wydobycia dźwięku,

e) wyrównania brzmienia;

2) wykorzystuje elementy techniki gry w sposób wirtuozowski;

3) swobodnie i elastycznie posługuje się aparatem gry ze szczególnym uwzględnieniem synchronizacji pracy rak we wszystkich typach faktury, niezależności rak oraz sprawności technicznej lewej ręki;
...
h) przerzutów i skoków,

i) ornamentalnej (np.: ozdobniki, w tym tryle; arpeggio; glissando; tremolo);

5) prawidłowo realizuje fakturę homofoniczna i polifoniczną w następujących zagadnieniach:
...
6) posługuje się różnorodną pedalizacją, stosując min. półpedały, pedał wibracyjny;
...
g) zróżnicowaną barwę dźwięku - kolorystykę (min. efekty impresjonistyczne),
...
e) registrację (stosowanie adekwatnych połączeń głosów organowych związane z historycznym instrumentarium i konwencjami); 5) realizuje struktury polifoniczne i homofoniczne.
...
f) kształtowania dźwięku w grze na 4 kotłach, umiejętności strojenia i zmiany wysokości dźwięków w trakcie utworów (przestajania), stosowania dynamiki, artykulacji i doboru pałek,
...
2. Kształcenie umiejętności samodzielnej prac
...
4) poszerza i aktualizuje wiedzę muzyczną, korzystając min. z technologii informacyjnej i komunikacyjnej.
...
4. Kształcenie umiejętności stosowania rytmu w improwizacji Uczeń stosuje różnorodne rytmy w improwizacji.
...
4. Kształcenie umiejętności stosowania rytmu w improwizacji Uczeń:
...
1) zna podziały i rodzaje metrum typowe dla muzyki jazzowej, latynoskiej, afro-kubańskiej, hinduskiej i bałkańskiej;
...
3. Poznanie wiedzy z historii i literatury muzycznej, z uwzględnieniem muzyki jazzowej Uczeń poznaje historię muzyki i literaturę muzyczną, ze szczególnym uwzględnieniem jazzu, jego głównych nurtów, stylów oraz przedstawicieli.
...
3. Poznanie wiedzy z historii i literatury muzycznej, z uwzględnieniem muzyki jazzowej Uczeń:
...
2. Kształcenie umiejętności improwizacji oraz interpretacji utworów muzycznych Uczeń improwizuje w oparciu o formy i schematy harmoniczne, charakterystyczne dla muzyki jazzowej, oraz interpretuje utwory muzyczne w sposób zgodny z kanonami stylistyki jazzowej.
...
2) wykonuje prostą analizę widmową w oparciu o ogólnodostępne oprogramowanie oraz interpretuje wynik;

3) przygotowuje i przedstawia krótką prezentację multimedialną w zakresie dziedziny;
...
3) jest zainteresowany współczesnym życiem artystycznym i aktywnie bierze w nim udział.
...
1) wykorzystuje zdobytą wiedzę w praktyce lutniczej;

2) w działaniach praktycznych stosuje i łączy wiedzę i umiejętności z zakresu przedmiotu głównego oraz z zakresu przedmiotów ogólnomuzycznych.
...
1) poznaje podstawowe pojęcia, terminy lutnicze oraz zasady budowy i konstruowania instrumentu lutniczego;

2) poznaje techniki obróbki drewna.

2. Wykorzystanie wiedzy w działaniach warsztatowych

Uczeń:

1) potrafi zbudować instrument lutniczy przy zastosowaniu odpowiednich technik;

2) organizuje warsztat pracy i potrafi zaplanować proces technologiczny.

3. Rozwijanie percepcji sztuki i działań kreatywnych

Uczeń:

1) wykorzystuje zdobytą wiedzę i umiejętności z zakresu przedmiotów lutniczych i ogólnomuzycznych;

2) jest zainteresowany współczesnym życiem artystycznym i aktywnie bierze w nim udział.
...
1) poznaje podstawowe pojęcia dotyczące kompozycji na płaszczyźnie i w przestrzeni oraz posługuje się nimi w procesie projektowania i wykonania instrumentu lutniczego;

2) poznaje wybrane techniki zdobnicze.
...
2) jest kreatywny w zakresie opracowywania projektów, posługując się różnymi środkami wyrazu.
...
1. Zdobywanie podstawowej wiedzy z zakresu gry na instrumentach lutniczych Uczeń opanowuje w stopniu podstawowym grę na wybranym instrumencie lutniczym.
...
2) w grze stosuje następującą artykulację: detaché, martelé, legato, staccato;
...
2) jest kreatywny w zakresie opracowywania projektów i tworzenia instrumentów lutniczych, posługując się różnymi środkami wyrazu;

3) w działaniach praktycznych wykorzystuje wiedzę z zakresu przedmiotów ogólnomuzycznych;

4) jest zainteresowany współczesnym życiem artystycznym i aktywnie bierze w nim udział.
...
1) zna budowę i zasady działania mechanizmu fortepianu;

2) zachowuje prawidłową postawę przy instrumencie;

3) posługuje się różnymi technikami gry:

a) swobodnie posługuje się aparatem gry, wykazuje się niezależnością rąk i palców,

b) stosuje różne rodzaje artykulacji (legato, staccato, portato),

c) stosuje technikę palcową, pasażową, podwójnych dźwięków, skoków, akordową, oktawową,

d) prowadzi dwugłos w jednej ręce,

e) prawidłowo wykonuje ozdobniki, tryle, arpeggio w opracowywanych utworach,

f) prawidłowo posługuje się prawym i lewym pedałem;
...
2. Wykorzystywanie wiedzy z zakresu przedmiotów ogólnomuzycznych w praktyce Uczeń poznaje style muzyczne oraz z ich cechy charakterystyczne i potrafi je zastosować we własnej improwizacji i kompozycji.
...
2) zna życiorys E. Jagues-Dalcroze'a;
...
2. Rozwijanie aktywnej i twórczej postawy w pracy indywidualnej i zespołowej Uczeń realizuje własne koncepcje artystyczne oraz działa w ramach wspólnych projektów grupowych.
...
6) samodzielnie wyszukuje, selekcjonuje i dokonuje oceny informacji z zakresu przedmiotów ogólnomuzycznych, wykorzystując min. technologię informacyjną i komunikacyjną;
...
1) zna podziały rytmiczne i rodzaje metrum typowe dla muzyki jazzowej, latynoskiej, afro- kubańskiej, hinduskiej i bałkańskiej;
...
1) ćwiczy koordynację wszystkich elementów techniki wokalnej: emisję głosu, oddech i artykulację;
...
1) ogólnokształcącej szkole muzycznej I stopnia w cyklu 8-letnim wynosi: 52^2^/3 godziny (w ujęciu tygodniowym w cyklu kształcenia);

2) szkole muzycznej I stopnia:

a) w cyklu 6-letnim wynosi: 35^1^/3 godziny,

b) w cyklu 4-letnim wynosi: 26^1^/3godziny (w ujęciu tygodniowym w cyklu kształcenia);
...
a) instrumentalistyka jazzowa wynosi: 60 godzin,

b) wokalistyka wynosi: do 61 godzin,

c) wokalistyka jazzowa wynosi: do 70^2^/3 godziny (w ujęciu tygodniowym w cyklu kształcenia).

## Załącznik nr 6 - Podstawa programowa kształcenia w zawodzie tancerz

EFEKTY KSZTAŁCENIA PO ZAKOŃCZENIU NAUKI W OGÓLNOKSZTAŁCĄCEJ SZKOLE BALETOWEJ ORAZ W SZKOLE SZTUKI TAŃCA
...
2) szanuje dziedzictwo kulturowe swojego narodu i innych narodów;
...
12) charakteryzuje sylwetki i dorobek artystyczny wybranych polskich choreografów (Conrad Drzewiecki, Witold Gruca, Janina Jarzynówna-Sobczak, Krzysztof Pastor, Feliks Parnell, Henryk Tomaszewski, Roman Turczynowicz, Emil Wesołowski, Ewa Wycichowska, Piotr Zajlich) i tancerzy (Barbara Bittnerówna, Alicja Boniuszko, Ewa Głowacka, Olga Sawicka, Stanisław Szymański, Wojciech Wiesiołłowski, Leon Wójcikowski);

13) charakteryzuje sylwetki i dorobek artystyczny wybranych zagranicznych choreografów (Alvin Ailey, Karole Armitage, Frederick Ashton, George Balanchine, Pina Bausch, Maurice Béjart, August Bournomdlle, Carolyn Carlson, John Cranko, Birgit Cullberg, Merce Cunningham, Mats Ek, Michaił Fokin, William Forsythe, Martha Graham, Jurij Grigorowicz, Bill T. Jones, Kurt Jooss, Anne Teresa de Keersmaeker, Jiří Kylián, José Limón, Hans van Manen, Maguy Marin, Leonid Miasin, John Neumeier, Alvin Nicolais, Bronisława Niżyńska, Wacław Niżyński, Jean-Georges Noverre, Marius Petipa, Jules Perrot, Roland Petit, Angelin Preljocaj, Jerome Robbins, Heinz Spoerli, Filippo Taglioni, Sasha Waltz, Mary Wigman, Ninette de Valois, Wim Vandekeybus) i tancerzy (Alicia Alonso, Michaił Barysznikow, Jorge Donn, Isadora Duncan, Margot Fonteyn, Carla Fracci, Sylvie Guillem, Marcia Haydée, Władimir Małachow, Rudolf Nurejew, Maja Plisiecka, Galina Ulanowa);

14) charakteryzuje twórczość wybranych teoretyków tańca i ruchu oraz pedagogów (Pierre Beauchamp, Carlo Blassis, Enrico Cecchetti, Emil Jaques-Dalcroze, François Delsarte, Michaił Fokin, Martha Graham, Doris Humphrey, Rudolf von Laban, Jean-Georges Noverre, Agryppina Waganowa);
...
8) omawia związki między zjawiskami artystycznymi w dziedzinie tańca i wydarzeniami społeczno-politycznymi;
...
a) Sylfida (Pierre Lacotte wg Filippo Taglioni lub August Bournomdlle),
...
c) Jezioro łabędzie (Marius Petipa i Lew Iwanow lub współczesne inscenizacje dzieł wg tradycyjnej XIX-wiecznej choreografii, Mats Ek),

d) Dziadek do orzechów (Wasilij Wajnonen lub Peter Wright),

e) Śpiąca królewna (Marius Petipa lub współczesne inscenizacje dzieł wg tradycyjnej XIX-wiecznej choreografii, Mats Ek),

f) Coppélia (Ninette de Valois wg Lwa Iwanowa i Enrico Cecchetti'ego lub Roland Petit),

g) Bajadera (Marius Petipa lub współczesne inscenizacje dzieł wg tradycyjnej XIX- wiecznej choreografii),
...
zg) Channels/Inserts (Merce Cunningham),
...
1) posiada wiedzę dotyczącą sposobów tańczenia w duecie oraz w grupie, umożliwiającą prawidłowe wykonanie elementów i póz charakterystycznych dla różnych technik tańca;

2) stosuje terminologię przedmiotową.
...
Uczeń stosuje wiedzę do scenicznej prezentacji tańca w duecie i w grupie, nadając mu artystyczny kształt przez właściwą i charakterystyczną dla różnych technik tańca interpretację muzyczno-ruchową.
...
1) wykonuje następujące elementy, łączone w kombinacje i etiudy taneczne:
...
Nie określa się podstawy programowej przedmiotu „repertuar”, ponieważ podczas zajęć repertuarowych nauczyciele pracują z uczniami najczęściej indywidualnie nad choreografiami w wybranej technice, przygotowując uczniów do występów scenicznych oraz rywalizacji konkursowych. Repertuar jest prowadzony w zakresie zajęć: taniec klasyczny, taniec współczesny, taniec ludowy i charakterystyczny oraz taniec dawny z uwzględnieniem indywidualnych potrzeb i możliwości uczniów oraz możliwości kadrowych i lokalowych szkoły. Repertuar szkolny nie musi być wykorzystany w pełnym wymiarze oraz nie jest oceniany.
...
8) objaśnia taniec przez określenie różnych cech ruchu;
...
1) posiada wiedzę teoretyczną na temat polskich tańców narodowych, tańców góralskich i wybranych tańców innych narodów, w zakresie umożliwiającym wykonanie elementów i figur tanecznych w formie właściwej dla danego stylu tanecznego, z uwzględnieniem charakteru tych tańców i muzyki;

2) stosuje terminologię z zakresu przedmiotu.

2. Umiejętności

Uczeń:

1) wykonuje kroki i figury taneczne polskich tańców narodowych, tańców góralskich i wybranych tańców innych narodów w formie właściwej dla danego stylu i charakteru tych tańców;

2) współpracuje z partnerem i w zespole;

3) sprawnie porusza się w kompozycji przestrzennej typowej dla poszczególnych tańców.
...
1) posiada zdolności do indywidualnego i zespołowego wykonywania powierzonych zadań;

2) potrafi zorganizować własny warsztat pracy zgodnie z zasadami bezpieczeństwa i higieny zawodu tancerza;

3) świadomie rozwija swój kunszt artystyczny i zawodowy;

4) szanuje dziedzictwo kulturowe swojego narodu i innych narodów.
...
3) stosuje w etiudach lub układach tanecznych interpretację muzyczno-ruchową właściwą dla poloneza, krakowiaka, kujawiaka, oberka, mazura, tańców góralskich i wybranych tańców rosyjskich, węgierskich i hiszpańskich.
...
4) dostrzega związki i zależności między teoretycznymi i praktycznymi elementami tańca współczesnego;

5) definiuje różne estetyki tańca: od klasycznych szkół (modern dance, jazz), poprzez różnorodność nurtów tańca współczesnego po hip-hop i inne nowe formy tańca;

6) percypuje obecność tańca współczesnego obok tańca klasycznego, folkloru międzynarodowego i innych form tańca;

7) dostrzega podstawowe różnice między techniką tańca współczesnego, klasycznego oraz innymi technikami i formami tańca;
...
4) dostrzega (w realizowanym materiale) i opisuje zależności zachodzące między czasem, przestrzenią i energią;
...
4) wykazuje kreatywność przez podejmowanie zadań improwizacyjnych;
...
1) posiada wiedzę z zakresu zasad muzyki i notacji muzycznej;

2) posługuje się zasobem pojęć i terminów muzycznych umożliwiającym samodzielną i zespołową aktywność wykonawczą.

2. Kształcenie słuchu

Uczeń:

1) umiejętnie operuje głosem;

2) dokonuje analizy słuchowej;

3) odtwarza i tworzy tematy melodyczno-rytmiczne;

4) kształci pamięć muzyczną.

3. Aktywność twórcza i wyobraźnia muzyczna

Uczeń:

1) kreuje i odtwarza wypowiedzi muzyczne, wykorzystując głos, ruch, grę na instrumentach muzycznych;

2) korzysta z literatury muzycznej oraz ze źródeł internetowych.
...
10) potrafi dokonać zapisu dyktanda melodyczno-rytmicznego, wykorzystując zdobytą wiedzę i umiejętności.
...
4) improwizuje głosem, na instrumentach, gesto-dźwiękami samodzielnie lub pod kierunkiem nauczyciela (np. melodie do podanego tekstu);
...
Wśród sal lekcyjnych powinny znajdować się pomieszczenia przystosowane do realizacji zajęć ruchowych (posiadające podłogę baletową lub parkiet, lustra, drążki oraz fortepian/pianino dla akompaniatora lub sprzęt audio umożliwiający odtwarzanie materiałów dźwiękowych) oraz pomieszczenia do innych zajęć wynikających z tygodniowego lub semestralnego rozkładu zajęć.
...
Minimalna liczba godzin zajęć artystycznych realizowanych w ogólnokształcącej szkole baletowej oraz w szkole sztuki tańca wynosi: 162 godziny (w ujęciu tygodniowym w cyklu kształcenia).
