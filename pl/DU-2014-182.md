---
title: "Rozporządzenie Ministra Rolnictwa i Rozwoju Wsi z dnia 22 stycznia 2014 r. w sprawie sposobu prowadzenia dokumentacji dotyczącej materiału siewnego oraz zakresu i terminów składania informacji dotyczących obrotu materiałem siewnym"
identifier: "DU-2014-182"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2014-01-22"
last_updated: "2014-01-22"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2014/182"
department: "MIN. ROLNICTWA I ROZWOJU WSI"
eli: "DU/2014/182"
display_address: "Dz.U. 2014 poz. 182"
internal_address: "WDU20140000182"
publisher: "DU"
volume: "0"
position: "182"
...
1. Prowadzący obrót materiałem siewnym roślin rolniczych i warzywnych prowadzi dokumentację:
...
1. Dokument sprzedaży materiału siewnego, o którym mowa w § 2 ust. 1 pkt 7 lit. b, powinien zawierać:
...
Dokumentację dotyczącą materiału siewnego sporządzoną przed dniem wejścia w życie niniejszego rozporządzenia przechowuje się przez okres wskazany w dotychczasowych przepisach.

##### § 7.

Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia.

## Załącznik - Gatunki roślin uprawnych objęte informacjami dotyczącymi obrotu materiałem siewnym
...
|  |  |  |  |
| --- | --- | --- | --- |
|  | **Nazwa polska** | **Nazwa polska** | **Nazwa botaniczna** |
|  | **ROŚLINY ROLNICZE** | **ROŚLINY ROLNICZE** | **ROŚLINY ROLNICZE** |
|  | **A. Rośliny zbożowe** | **A. Rośliny zbożowe** | **A. Rośliny zbożowe** |
|  | 1 | Jęczmień | *Hordeum vulgare*L. |
|  | 2 | Kukurydza | *Zea mays*L. |
|  | 3 | Mieszaniec sorga zwyczajnego isorgasudańskiego^*^ | *Sorghum bicolor(L.)*Moench x *Sorghum sudanense*(Piper) Stapf |
...
|  | **B. Rośliny oleiste i włókniste** | **B. Rośliny oleiste i włókniste** | **B. Rośliny oleiste i włókniste** |
...
|  | **C. Rośliny pastewne** | **C. Rośliny pastewne** | **C. Rośliny pastewne** |
|  | Bobowate - *Fabaceae (Leguminosae)* | Bobowate - *Fabaceae (Leguminosae)* | Bobowate - *Fabaceae (Leguminosae)* |
...
|  | Wiechlinowate - *Poaceae (Gramineae)* | Wiechlinowate - *Poaceae (Gramineae)* | Wiechlinowate - *Poaceae (Gramineae)* |
...
|  | 6 | Kostrzewa szczeciniasta | *Festuca trachyphylla*(Hack.) Krajina |
...
|  | 27 | Życica mieszańcowa (syn. rajgras oldenburski) | *Lolium x boucheanum*Kunth |
...
|  | 30 | Oberżyna | *Solarium melongena*L. |
...
|  | 34 | Pomidor | *Solarium lycopersicum*L. |
