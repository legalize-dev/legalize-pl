---
title: "Ustawa z dnia 1 grudnia 2016 r. o zmianie ustawy o dochodach jednostek samorządu terytorialnego oraz niektórych innych ustaw"
identifier: "DU-2016-1985"
country: "pl"
rank: "ustawa"
publication_date: "2016-12-01"
last_updated: "2016-12-01"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2016/1985"
department: "SEJM"
eli: "DU/2016/1985"
display_address: "Dz.U. 2016 poz. 1985"
internal_address: "WDU20160001985"
publisher: "DU"
volume: "0"
position: "1985"
...
has_pdf: "true"
keywords: "oświata i wychowanie, samorząd terytorialny, dochód"
---
...
2) w art. 70c w ust. 4 pkt 6 otrzymuje brzmienie:
...
1) w art. 14 w ust. 5 w pkt 1 wprowadzenie do wyliczenia otrzymuje brzmienie:
...
W ustawie z dnia 13 czerwca 2013 r. o zmianie ustawy o systemie oświaty oraz niektórych innych ustaw w art. 16 ust. 1 otrzymuje brzmienie:
...
W ustawie z dnia 23 czerwca 2016 r. o zmianie ustawy o systemie oświaty oraz niektórych innych ustaw w art. 1:

1) w pkt 70 ust. 2 otrzymuje brzmienie:
...
a) w lit. a ust. 2a otrzymuje brzmienie:
...
b) w lit. c ust. 2d otrzymuje brzmienie:
...
c) w lit. d ust. 2db otrzymuje brzmienie:
...
a) w lit. f ust. 1k otrzymuje brzmienie:
...
b) w lit. g ust. 1ka otrzymuje brzmienie:
...
c) w lit. h ust. 1l otrzymuje brzmienie:
...
d) w lit. i ust. 2c otrzymuje brzmienie:
...
e) w lit. k ust. 2e otrzymuje brzmienie:
...
f) w lit. I ust. 2eb otrzymuje brzmienie:
...
Przepisy ustaw zmienianych w art. 1-3 w brzmieniu nadanym niniejszą ustawą stosuje się po raz pierwszy do:
