---
title: "Ustawa z dnia 26 października 2000 r. o zmianie ustawy o jednostkach badawczo-rozwojowych"
identifier: "DU-2000-1100"
country: "pl"
rank: "ustawa"
publication_date: "2000-10-26"
last_updated: "2000-10-26"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2000/1100"
department: "SEJM"
eli: "DU/2000/1100"
display_address: "Dz.U. 2000 nr 103 poz. 1100"
internal_address: "WDU20001031100"
publisher: "DU"
volume: "103"
position: "1100"
status_pl: "uchylony"
...
obligated_bodies: "RADA MINISTRÓW, MARSZAŁEK SEJMU"
named_entities: "Polska Akademia Nauk"
effective_date_notes: "Objęte tekstem jednolitym Dz. U. z 2001 r Nr 33, poz. 388 z dniem 20 marca 2001 r. z wyjątkiem art. 2-6"
parliamentary_prints_count: "2"
references_count: "5"
text_variants_count: "4"
has_pdf: "true"
keywords: "instytuty naukowo-badawcze, badawczo-rozwojowe jednostki, nadzór, nauka, pracownicy nauki, prywatyzacja, komercjalizacja, placówka naukowa"
---
# Ustawa z dnia 26 października 2000 r. o zmianie ustawy o jednostkach badawczo-rozwojowych

##### Art. 1.

W ustawie z dnia 25 lipca 1985 r. o jednostkach badawczo-rozwojowych wprowadza się następujące zmiany:

1) w art. 1 w ust. 1, w art. 2 w ust. 2 w pkt 1 i 3, w art. 15 w ust. 3 i w art. 49 w ust. 2 w pkt 1 wyrazy „badawczo-rozwojowych” zastępuje się wyrazem „rozwojowych”;

2) w art. 2 w ust. 3a i w art. 23 w ust. 1 wyrazy „prace badawczo-rozwojowe” zastępuje się wyrazami „prace rozwojowe”;
...
b) w ust. 4 po wyrazie „opinii” dodaje się wyrazy „rady naukowej oraz”;

4) w art. 5:

a) w ust. 5 wyrazy „do 500” zastępuje się wyrazami „do 300” oraz wyrazy „powyżej 500” zastępuje się wyrazami „powyżej 300”,

b) w ust. 6 wyraz „państwowej” zastępuje się wyrazem „rządowej”;
...
c) w ust. 5 kropkę zastępuje się przecinkiem i dodaje się wyrazy „po zaopiniowaniu przez radę naukową.”,
...
a) w ust. 4 kropkę zastępuje się przecinkiem i dodaje się wyrazy „z zastrzeżeniem przepisu art. 13 ust. 3.”,

b) w ust. 6 kropkę zastępuje się przecinkiem i dodaje się wyrazy „z zastrzeżeniem ust. 7.”,
...
a) w ust. 2 skreśla się wyrazy „fundusz nagród oraz”,

b) dodaje się ust. 2a w brzmieniu:

> 2a. Jednostka badawczo-rozwojowa tworzy zakładowy fundusz nagród.

c) w ust. 3 po wyrazie „przekazanych” dodaje się wyrazy „jej na podstawie umów”;
...
a) w ust. 2 wyrazy „uzgodnieniu z radą naukową” zastępuje się wyrazami „zasięgnięciu opinii rady naukowej”,
...
19) w art. 23 w ust. 1 dodaje się zdanie drugie w brzmieniu:
...
b) w pkt 7 skreśla się wyrazy „oraz regulaminu pracy”,
...
22) w art. 28 dodaje się ust. 5 i 6 w brzmieniu:

> 5. W razie stwierdzenia, że decyzja dyrektora jednostki badawczo-rozwojowej lub zaniechanie podjęcia decyzji spowodowało stratę finansową, organ sprawujący nadzór nad tą jednostką może ustalić odszkodowanie na zasadach określonych w Kodeksie pracy. 6. Przepis ust. 5 nie wyklucza zastosowania przepisów dotyczących odpowiedzialności za naruszenie dyscypliny finansów publicznych.

23) w art. 29:

a) w ust. 1 po wyrazie „niezbędne” dodaje się wyrazy „do realizacji szczególnie ważnych celów gospodarczych lub społecznych,”

b) w ust. 2 kropkę zastępuje się przecinkiem i dodaje się wyrazy „zawieranej ze stroną finansującą wykonanie zadania, o którym mowa w ust. 1.”;
...
a) po wyrazach „można zatrudnić” dodaje się wyrazy „na podstawie umowy o pracę”,
...
a) w ust. 5 po wyrazach „radę naukową” stawia się kropkę, a pozostałe wyrazy skreśla się,
...
a) w ust. 1 wyrazy „funkcjonariuszy pożarnictwa” zastępuje się wyrazami „Państwowej Straży Pożarnej”, a wyrazy „Ministra Spraw Wewnętrznych” zastępuje się wyrazami „ministra właściwego do spraw wewnętrznych”,

b) w ust. 2 wyrazy „funkcjonariuszy pożarnictwa” zastępuje się wyrazami „Państwowej Straży Pożarnej”;

45) skreśla się art. 68 i 69;

46) art. 72 otrzymuje brzmienie:
