---
title: "Rozporządzenie Ministra Nauki z dnia 12 września 2024 r. w sprawie danych przetwarzanych w Zintegrowanym Systemie Informacji o Szkolnictwie Wyższym i Nauce POL-on"
identifier: "DU-2024-1403"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2024-09-12"
last_updated: "2024-09-12"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2024/1403"
department: "MIN. NAUKI"
eli: "DU/2024/1403"
display_address: "Dz.U. 2024 poz. 1403"
internal_address: "WDU20240001403"
publisher: "DU"
volume: "0"
position: "1403"
...
has_pdf: "true"
keywords: "nauka, szkolnictwo wyższe, studia w szkołach wyższych, systemy teleinformatyczne, studenci"
---
# Rozporządzenie Ministra Nauki z dnia 12 września 2024 r. w sprawie danych przetwarzanych w Zintegrowanym Systemie Informacji o Szkolnictwie Wyższym i Nauce POL-on
...
c) art. 345 ust. 1 pkt 3, 6, 7 i 13-16 ustawy, zamieszczanych w wykazie osób ubiegających się o stopień naukowy doktora albo o stopień doktora w zakresie sztuki, zwanym dalej „wykazem osób ubiegających się o stopień doktora”,
...
e) art. 349 ust. 1 pkt 2, 3, 4 i 5 ustawy, zamieszczanych w bazie osób upoważnionych do podpisywania dokumentów, o których mowa w art. 78 ust. 3, art. 163 ust. 4 oraz art. 180 ust. 1 i 1a ustawy, zwanej dalej „bazą osób upoważnionych”;
...
b) informację, czy stopień został:

- nadany przez instytucję, o której mowa w art. 328 ust. 1 albo 2 ustawy,

- uznany za równoważny na podstawie umowy międzynarodowej,

- uznany za równoważny w drodze postępowania nostryfikacyjnego;
...
12) dziedzinę nauki albo dziedzinę sztuki, zwane dalej „dziedziną”, albo dziedzinę i dyscyplinę naukową albo dyscyplinę artystyczną, zwane dalej „dyscypliną”, lub dyscypliny, w których został nadany tytuł profesora;

13) uprawnienia równoważne z uprawnieniami wynikającymi z posiadania stopnia doktora habilitowanego, nabyte na podstawie decyzji, o której mowa w art. 226 ust. 2 ustawy:

a) datę nabycia,

b) dziedzinę i dyscyplinę, w których zostały nabyte,

c) nazwę podmiotu, w którym zostały nabyte.
...
1) nazwę podmiotu zatrudniającego albo podmiotu, na rzecz którego jest wykonywana działalność naukowa;

2) datę złożenia oświadczenia, o którym mowa w art. 343 ust. 7 ustawy;

3) o oświadczeniu, o którym mowa w art. 265 ust. 5 ustawy:

a) wskazaną w nim dyscyplinę,

b) datę jego złożenia,

c) datę jego obowiązywania;

4) o oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy:

a) datę jego złożenia,

b) osiągnięcia naukowe lub artystyczne przypisane do dyscypliny, która została w nim wskazana.
...
a) podstawę nawiązania,

b) datę nawiązania,

c) okres, na jaki został nawiązany,

d) datę ustania;

2) czy uczelnia stanowi dla nauczyciela akademickiego podstawowe miejsce pracy;

3) nazwę podmiotu będącego miejscem dodatkowego zatrudnienia nauczyciela akademickiego;

4) przynależność pracownika - w przypadku zatrudnienia w:

a) uczelni - do grupy pracowników:
...
b) instytucie badawczym albo jednostce naukowej Polskiej Akademii Nauk - do grupy pracowników:
...
c) Centrum Łukasiewicz albo instytucie działającym w ramach Sieci Badawczej Łukasiewicz, zwanym dalej „instytutem Sieci Łukasiewicz” - do grupy pracowników pionu badawczego;

5) nazwę stanowiska pracy;

6) czy pracownik prowadzi działalność naukową albo czy bierze udział w jej prowadzeniu;

7) czy stanowisko pracy w Centrum Łukasiewicz albo w instytucie Sieci Łukasiewicz jest finansowane ze środków finansowych, o których mowa odpowiednio w art. 365 pkt 2a albo 13a ustawy.
...
3) okres zatrudnienia, w ramach którego doświadczenie zostało zdobyte;
...
9. W zakresie danych, o których mowa w art. 343 ust. 1 pkt 20 ustawy, w wykazie pracowników zamieszcza się następujące informacje:

1) o orzeczonej karze dyscyplinarnej, o której mowa w art. 276 ust. 1 pkt 4-8 ustawy:

a) datę wydania orzeczenia,

b) datę uprawomocnienia się orzeczenia,

c) sygnaturę orzeczenia,
...
2) o orzeczeniu, o którym mowa w art. 180 ustawy z dnia 6 czerwca 1997 r. - Kodeks karny wykonawczy :
...
g) datę, od której nastąpił zakaz zajmowania stanowiska albo wykonywania zawodu nauczyciela akademickiego,

h) datę zatarcia skazania.

10. W zakresie danych, o których mowa w art. 343 ust. 1 pkt 21 ustawy, w wykazie pracowników zamieszcza się następujące informacje:

1) o uzyskanym patencie na wynalazek:

a) tytuł wynalazku,

b) nazwę podmiotu albo podmiotów, które uzyskały patent,
...
h) datę i nazwę państwa uprzedniego pierwszeństwa oraz numer zgłoszenia lub oznaczenie wystawy,

i) streszczenie opisu wynalazku,

j) datę złożenia tłumaczenia na język polski patentu europejskiego, w którym Rzeczpospolita Polska została wyznaczona jako kraj ochrony,

k) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,

l) nazwę podmiotu upoważnionego w oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy,

m) imiona i nazwiska pozostałych współtwórców wynalazku oraz - jeżeli są znane - numery ORCID;

2) o uzyskanym prawie ochronnym na wzór użytkowy:

a) tytuł wzoru użytkowego,

b) nazwę podmiotu albo podmiotów, które uzyskały prawo ochronne,
...
i) streszczenie opisu wzoru użytkowego,

j) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,

k) nazwę podmiotu upoważnionego w oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy,

l) imiona i nazwiska pozostałych współtwórców wzoru użytkowego oraz - jeżeli są znane - numery ORCID;

3) o uzyskanym wyłącznym prawie hodowcy do odmiany rośliny:
...
h) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,
...
4) o artykule naukowym:

a) DOI ( *Digital Object Identifier* - cyfrowy identyfikator dokumentu elektronicznego), a w przypadku jego braku - adres strony internetowej zawierającej pełny tekst artykułu, jeżeli znajduje się w otwartym dostępie, albo adres strony internetowej zawierającej informacje o artykule,

b) tytuł,

c) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,

d) nazwę podmiotu upoważnionego w oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy,

e) imiona i nazwiska współautorów oraz - jeżeli są znane - numery ORCID,

f) czy jest to artykuł recenzyjny,

g) czy został opublikowany w recenzowanych materiałach z międzynarodowej konferencji naukowej - jeżeli tak, informacje dotyczące konferencji:
...
h) tytuł czasopisma naukowego oraz ISSN - Międzynarodowy Znormalizowany Numer Wydawnictw Ciągłych (*International Standard Serial Number*) lub eISSN - elektroniczny Międzynarodowy Znormalizowany Numer Wydawnictw Ciągłych ( *International Standard Serial Number*),

i) rok opublikowania,

j) tom lub zeszyt czasopisma naukowego, jeżeli posiada,

k) numery stron, jeżeli posiada,

l) dotyczące otwartego dostępu ( *Open Access*), w tym:
...
- czy udostępnienie nastąpiło przed opublikowaniem, w dniu opublikowania czy po opublikowaniu,

- liczby miesięcy, jakie upłynęły od dnia opublikowania do dnia udostępnienia artykułu naukowego w sposób otwarty,

m) wysokość opłat za opublikowanie poniesionych przez podmiot, o którym mowa w lit. d, (wyrażoną w złotych) i źródło ich finansowania (środki finansowe, o których mowa w art. 365 pkt 2 ustawy, środki finansowe przyznane na realizację projektu w zakresie badań naukowych lub prac rozwojowych, inne);

5) o monografii naukowej i redakcji naukowej monografii naukowej:
...
b) tytuł oraz ISBN - Międzynarodowy Znormalizowany Numer Książki ( *International Standard Book Number*) lub ISMN - Międzynarodowy Znormalizowany Numer Druku Muzycznego ( *International Standard Music Number*),

c) rolę osoby (autor albo redaktor, a w przypadku przekładu - autor przekładu),

d) imiona i nazwiska współautorów i redaktorów oraz - jeżeli są znane - numery ORCID,

e) wydawcę,

f) rok wydania,

g) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,

h) nazwę podmiotu upoważnionego w oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy,

i) czy monografia naukowa stanowi przekład:
...
j) czy monografia naukowa stanowi edycję naukową tekstu źródłowego,

k) czy monografia naukowa powstała w wyniku realizacji projektu finansowanego przez Narodowe Centrum Nauki, zwane dalej „NCN”, Fundację na rzecz Nauki Polskiej, w ramach Narodowego Programu Rozwoju Humanistyki, programu ramowego w zakresie wspierania badań i innowacji Unii Europejskiej albo w ramach programu związanego z wdrażaniem takiego programu,
...
m) dotyczące otwartego dostępu ( *Open Access*), w tym:
...
n) wysokość opłat za wydanie poniesionych przez podmiot, o którym mowa w lit. h, (wyrażoną w złotych) i źródło ich finansowania (środki finansowe, o których mowa w art. 365 pkt 2 ustawy, środki finansowe przyznane na realizację projektu w zakresie badań naukowych lub prac rozwojowych, inne);

6) o rozdziale w monografii naukowej, jeżeli w monografii są wskazani autorzy rozdziału:

a) informacje o monografii naukowej, której fragment stanowi dany rozdział, o których mowa w pkt 5,

b) tytuł,

c) imiona i nazwiska pozostałych współautorów oraz - jeżeli są znane - numery ORCID,

d) dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,

e) nazwę podmiotu upoważnionego w oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy;

7) o osiągnięciu artystycznym:

a) rodzaj określony w przepisach wydanych na podstawie art. 267 ust. 2 pkt 1 ustawy,
...
f) rok i nazwę państwa realizacji,

g) charakterystykę (maksymalnie 1200 znaków ze spacjami),

h) rok i nazwę państwa pierwszego upublicznienia,

i) zakres rozpowszechnienia (ogólnopolski, międzynarodowy),
...
- nazwę państwa, w którym przyznano nagrodę albo wyróżnienie,
...
m) czy osiągnięcie artystyczne ma być uwzględnione w ewaluacji jakości działalności naukowej, zwanej dalej „ewaluacją”.
...
4) datę ważności i numer Karty Polaka.
...
4) czy student realizuje kształcenie:

a) przygotowujące do wykonywania zawodu nauczyciela,

b) na studiach wspólnych;

5) rok i semestr studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - rok studiów:

a) które student zaliczył w danym roku akademickim,

b) na które student jest wpisany w danym roku akademickim;

6) liczbę punktów ECTS:

a) uzyskanych po zaliczeniu kolejnych lat i semestrów studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - lat studiów,

b) zaliczonych w wyniku potwierdzenia efektów uczenia się.
...
2) nazwę podmiotu prowadzącego albo podmiotów prowadzących szkołę doktorską;
...
3) datę ważności i numer Karty Polaka.
...
2) datę wydania i numer prawomocnej decyzji o:

a) nadaniu stopnia doktora,

b) odmowie nadania stopnia doktora,

c) umorzeniu postępowania w sprawie nadania stopnia doktora;

3) dziedzinę albo dziedzinę i dyscyplinę, której dotyczy decyzja, o której mowa w pkt 2;

4) datę wydania i numer prawomocnej decyzji w sprawie stwierdzenia nieważności decyzji o nadaniu stopnia doktora albo prawomocnej decyzji uchylającej decyzję o nadaniu stopnia doktora i rozstrzygającej sprawę co do istoty;

5) nazwę podmiotu, który wydał decyzję, o której mowa w pkt 2 i 4.
...
2) organ nadzorujący podmiot;

3) numer identyfikacyjny REGON podmiotu;

4) numer identyfikacji podatkowej (NIP) podmiotu;

5) numer podmiotu z Krajowego Rejestru Sądowego, zwanego dalej „KRS”, rejestru instytutów PAN albo ewidencji uczelni niepublicznych;
...
j) adres do doręczeń elektronicznych, o którym mowa w art. 2 pkt 1 ustawy z dnia 18 listopada 2020 r. o doręczeniach elektronicznych , zwany dalej „adresem do doręczeń elektronicznych”;

7) rodzaj podmiotu (uczelnia, instytut PAN, instytut badawczy, instytut międzynarodowy, Centrum Łukasiewicz, instytut Sieci Łukasiewicz, Polska Akademia Umiejętności, zwana dalej „PAU”, inny podmiot prowadzący głównie działalność naukową w sposób samodzielny i ciągły);
...
a) rodzaj (publiczna, niepubliczna, prowadzona przez kościół lub inny związek wyznaniowy),

b) przynależność do grupy uczelni akademickich albo zawodowych;
...
- numer z KRS albo rejestru instytutów PAN, pod którym podmiot podzielony był wpisany,

- numery z KRS albo rejestru instytutów PAN, pod którymi podmioty powstałe w wyniku podziału są wpisane,
...
- organy nadzorujące podmioty połączone, - numery identyfikacyjne REGON podmiotów połączonych,

- numery identyfikacji podatkowej (NIP) podmiotów połączonych,

- numery z KRS, rejestru instytutów PAN albo ewidencji uczelni niepublicznych, pod którymi podmioty połączone były wpisane,
...
- numer z KRS, rejestru instytutów PAN albo ewidencji uczelni niepublicznych, pod którym podmiot włączony był wpisany.
...
j) adres do doręczeń elektronicznych;
...
6) nazwy podmiotów, z którymi są prowadzone studia wspólne albo studia wspólne interdyscyplinarne, ze wskazaniem podmiotu albo podmiotów odpowiedzialnych za wprowadzanie danych do Systemu POL-on;

7) czy studia są prowadzone w siedzibie czy w filii;

8) datę rozpoczęcia prowadzenia studiów;

9) datę zakończenia prowadzenia studiów;
...
a) w ramach indywidualnych studiów międzydziedzinowych, o których mowa w art. 59 ustawy,

b) z podmiotem, o którym mowa w art. 61 ust. 1 ustawy,

c) jako studia:

- o których mowa w art. 53 ust. 8 ustawy,

- wspólne interdyscyplinarne, o których mowa w art. 53 ust. 8a ustawy,

- wspólne, o których mowa w art. 60 ust. 1 ustawy,

- dualne, o których mowa w art. 62 ustawy;
...
18) wysokość w bieżącym roku akademickim opłaty (wyrażonej w złotych):

a) za kształcenie na studiach niestacjonarnych,

b) za kształcenie na studiach stacjonarnych - w przypadku uczelni niepublicznych,

c) za kształcenie na studiach w języku obcym,

d) za kształcenie cudzoziemców na studiach stacjonarnych w języku polskim,

e) za powtarzanie zajęć na studiach stacjonarnych z powodu niezadowalających wyników w nauce,

f) za prowadzenie zajęć nieobjętych programem studiów,

g) rekrutacyjnej;

19) czy na studiach jest realizowane kształcenie:

a) przygotowujące do wykonywania zawodu nauczyciela,

b) w ramach filologii obcej, ze wskazaniem języka tej filologii;
...
3. W zakresie danych, o których mowa w art. 346 ust. 1 pkt 5 ustawy, w wykazie instytucji zamieszcza się następujące informacje:

1) dyscypliny, w ramach których podmiot prowadzi działalność naukową;

2) lata, za które ewaluacja jest przeprowadzana;

3) dyscypliny, w których ewaluacja została przeprowadzona zgodnie z art. 265 ust. 4 ustawy;

4) czy podmiot prowadzi badania naukowe lub prace rozwojowe na rzecz obronności i bezpieczeństwa państwa objęte ochroną informacji niejawnych, ze wskazaniem procentowego udziału czasu pracy poświęconego na tę działalność w czasie pracy związanym z działalnością naukową podmiotu ogółem w poszczególnych dyscyplinach;

5) o których mowa w § 2 ust. 10;

6) opisy wpływu działalności naukowej na funkcjonowanie społeczeństwa i gospodarki zawierające informacje na temat związku między wynikami badań naukowych lub prac rozwojowych albo działalności naukowej w zakresie twórczości artystycznej a gospodarką, funkcjonowaniem administracji publicznej, ochroną zdrowia, kulturą i sztuką, ochroną środowiska naturalnego, bezpieczeństwem i obronnością państwa lub innymi czynnikami wpływającymi na rozwój cywilizacyjny społeczeństwa, zwane dalej „opisami wpływu”, w języku polskim i angielskim, w liczbie wynikającej z przepisów wydanych na podstawie art. 267 ust. 2 pkt 1 ustawy, z uwzględnieniem:

a) tytułu każdego opisu wpływu (maksymalnie 150 znaków ze spacjami dla każdej wersji językowej),

b) streszczenia każdego opisu wpływu (maksymalnie 1000 znaków ze spacjami dla każdej wersji językowej),

c) wskazania roku, w którym ewaluacja, w której dany opis wpływu jest zgłaszany do oceny, jest przeprowadzana,

d) dyscypliny, której dotyczy każdy opis wpływu,

e) imion i nazwisk osób, które prowadziły działalność naukową objętą każdym opisem wpływu, oraz - jeżeli są znane - numerów ORCID,

f) informacji, czy dany opis wpływu został zgłoszony jako:
...
g) informacji o efektach działalności naukowej mających znaczenie dla kreowania wpływu, w tym:
...
- opisu bibliograficznego i streszczenia nie więcej niż 5 osiągnięć naukowych, o których mowa w § 2 ust. 10 pkt 1 i 4-6, będących wynikiem badań naukowych lub prac rozwojowych, prowadzonych w okresie objętym ewaluacją albo przed tym okresem, ale zakończonych nie wcześniej niż w dwudziestym roku poprzedzającym pierwszy rok objęty ewaluacją, ze wskazaniem głównych autorów tych osiągnięć, którzy są albo byli zatrudnieni w podmiocie albo odbywali w nim kształcenie (maksymalnie 1500 znaków ze spacjami na każde osiągnięcie dla każdej wersji językowej); opisu nie więcej niż 5 osiągnięć artystycznych, o których mowa w § 2 ust. 10 pkt 7 (maksymalnie 1500 znaków ze spacjami na każde osiągnięcie dla każdej wersji językowej); opis bibliograficzny i streszczenie osiągnięcia naukowego albo opis osiągnięcia artystycznego mogą uwzględniać adres strony internetowej, pod którym w dniu umieszczenia opisu wpływu w Systemie POL-on dane osiągnięcie jest dostępne,

h) charakterystyki wpływu działalności naukowej, w tym działalności, której wyniki są przedmiotem komercjalizacji, ze wskazaniem związku między działalnością naukową a tym wpływem oraz grupy społecznej będącej beneficjentem tego wpływu i obszaru, na który działalność naukowa ma największy wpływ (maksymalnie 5000 znaków ze spacjami dla każdej wersji językowej),

i) szczegółowej charakterystyki nie więcej niż 5 dowodów wpływu działalności naukowej (maksymalnie 1000 znaków ze spacjami na każdy dowód dla każdej wersji językowej), a w przypadku opisu, o którym mowa w lit. f tiret drugie podwójne tiret trzecie, nie więcej niż 5 dowodów wpływu będących wynikiem działalności naukowej innego podmiotu utworzonego przez podmiot w celu komercjalizacji; charakterystyka może uwzględniać adres strony internetowej, pod którym w dniu umieszczenia opisu wpływu w Systemie POL-on dany dowód wpływu jest dostępny,

j) informacji, czy wpływ powstał w wyniku interdyscyplinarnych badań naukowych lub prac rozwojowych, oraz charakterystyki znaczenia interdyscyplinarności badań naukowych lub prac rozwojowych dla powstania tego wpływu (maksymalnie 1500 znaków ze spacjami dla każdej wersji językowej);

7) o realizowanych projektach w zakresie badań naukowych, prac rozwojowych lub upowszechniania nauki:

a) tytuł projektu,

b) streszczenie opisu projektu,

c) słowa kluczowe,

d) dyscypliny, w ramach których projekt jest realizowany w danym podmiocie, ze wskazaniem procentowego udziału tych dyscyplin w projekcie,

e) czy projekt dotyczy upowszechniania nauki,

f) datę rozpoczęcia realizacji projektu,

g) datę zakończenia realizacji projektu,

h) czy projekt jest realizowany samodzielnie czy w ramach grupy podmiotów,

i) nazwy podmiotów współrealizujących projekt, mających siedzibę na terytorium Rzeczypospolitej Polskiej,

j) wskazanie podmiotu będącego liderem grupy podmiotów realizującej projekt,

k) czy lider grupy podmiotów realizującej projekt jest podmiotem należącym do systemu szkolnictwa wyższego i nauki,

l) imiona i nazwisko oraz - jeżeli jest znany - numer ORCID:
...
m) czy projekt jest finansowany albo współfinasowany w trybie konkursowym,

n) nazwę konkursu, programu lub przedsięwzięcia, w ramach którego projekt jest finansowany,

o) nazwę działania lub priorytetu, w ramach których projekt jest finansowany,

p) czy projekt jest finansowany z udziałem środków, o których mowa w art. 365 pkt 9 ustawy,

q) czy projekt jest finansowany:

- przez NCN, Narodowe Centrum Badań i Rozwoju, NAWA, Centrum Łukasiewicz, zagraniczną instytucję finansującą (należy podać nazwę), Fundację na rzecz Nauki Polskiej, ze środków Europejskiej Rady do spraw Badań Naukowych,
...
r) adres instytucji finansującej, a w przypadku instytucji zagranicznej - jeżeli jest znany,

s) wysokość środków finansowych ogółem przyznanych na realizację projektu, w tym przez instytucje zagraniczne (wyrażoną w złotych),

t) wysokość środków finansowych przyznanych poszczególnym podmiotom współrealizującym projekt, mającym siedzibę na terytorium Rzeczypospolitej Polskiej, w podziale na środki pochodzące od instytucji finansujących krajowych i zagranicznych (wyrażoną w złotych),

u) wysokość wkładu własnego (wyrażoną w złotych),

v) datę zawarcia umowy lub wydania decyzji przez instytucję finansującą,

w) datę rozliczenia środków finansowych przyznanych na realizację projektu.

4. W zakresie danych, o których mowa w art. 346 ust. 1 pkt 11 i 12 ustawy, w wykazie instytucji zamieszcza się następujące informacje:

1) o szkole doktorskiej:
...
- nazwy podmiotów współprowadzących,

- nazwę podmiotu odpowiedzialnego za wprowadzanie danych do Systemu POL-on i uprawnionego do otrzymywania środków finansowych na wspólne kształcenie,
...
j) dotyczące ewaluacji jakości kształcenia w szkole doktorskiej:

- daty i numery uchwał Komisji Ewaluacji Nauki, o których mowa w art. 262 ust. 2 i 6 ustawy,

- ocenę będącą wynikiem ewaluacji,

- czy zostały zgłoszone zastrzeżenia, o których mowa w art. 262 ust. 4 ustawy,

- okres objęty oceną;

2) o których mowa w § 2 ust. 10, dotyczące osiągnięć naukowych i artystycznych doktorantów;

3) o organie nadającym stopnie w uczelni:
...
d) okres posiadania uprawnień do nadawania stopni.
...
5) status inwestycji (w realizacji albo zrealizowana);

6) wysokość nakładów inwestycyjnych (wyrażoną w złotych);

7) źródła finansowania inwestycji;

8) okres trwałości inwestycji, w przypadku gdy jest określony w umowie albo w decyzji o przyznaniu środków finansowych na realizację inwestycji;

9) dane techniczne i rok produkcji:
...
10) dane osoby wskazanej przez kierownika podmiotu do kontaktu w sprawach związanych z użytkowaniem infrastruktury sfinansowanej w ramach inwestycji, w tym aparatury naukowo-badawczej lub infrastruktury informatycznej, o wartości przekraczającej 500 000 zł:
...
1) źródła pochodzenia środków, w tym wysokość środków z:
...
3) o przychodach z usług badawczych świadczonych na zlecenie podmiotów nienależących do systemu szkolnictwa wyższego i nauki:
...
d) czy przychód został uzyskany przez inny podmiot utworzony przez ten podmiot w celu komercjalizacji,

e) dyscypliny, w ramach których przychód został uzyskany, ze wskazaniem procentowego udziału danej dyscypliny w tym przychodzie,
...
3) czy przychód został uzyskany przez inny podmiot utworzony przez ten podmiot w celu komercjalizacji;

4) dyscypliny, w ramach których przychód został uzyskany, ze wskazaniem procentowego udziału danej dyscypliny w tym przychodzie;

5) rok uzyskania przychodu.

##### § 6.

W zakresie danych, o których mowa w art. 349 ust. 1 pkt 2, 3, 4 i 5 ustawy, w bazie osób upoważnionych zamieszcza się następujące informacje:
...
3) odwzorowanie cyfrowe:

a) pieczątki imiennej,
...
6) Centrum Łukasiewicz;

7) instytutu Sieci Łukasiewicz;

8) PAU;

9) innego podmiotu prowadzącego głównie działalność naukową w sposób samodzielny i ciągły posiadającego siedzibę na terytorium Rzeczypospolitej Polskiej;

10) Rady Doskonałości Naukowej.

2. Wniosek o założenie konta w Systemie POL-on składa osoba kierująca podmiotem, o którym mowa w ust. 1:

1) pkt 1-5 i 7, w terminie 7 dni od dnia utworzenia podmiotu, a w przypadku uczelni niepublicznej - od dnia wpisania do ewidencji uczelni niepublicznych;

2) pkt 9, nie wcześniej niż po upływie roku od dnia utworzenia podmiotu.

3. Wniosek o założenie konta w Systemie POL-on dla podmiotu, o którym mowa w ust. 1 pkt 1-5 i 7, zawiera:
...
e) jednostkę podziału terytorialnego, o której mowa w § 5 ust. 1 pkt 6 lit. e,

f) adres elektronicznej skrzynki podawczej,

g) adres do doręczeń elektronicznych;

3) datę utworzenia;

4) numer identyfikacyjny REGON, NIP albo numer z KRS, jeżeli został nadany;

5) imiona i nazwisko oraz adres poczty elektronicznej osoby, która będzie uprawniona do obsługi konta.

4. Wniosek o założenie konta w Systemie POL-on dla podmiotu, o którym mowa w ust. 1 pkt 9, zawiera:
...
7) liczbę osób zatrudnionych w ramach stosunku pracy, w przeliczeniu na pełny wymiar czasu pracy, prowadzących działalność naukową;
...
11) informacje o projektach w zakresie badań naukowych, prac rozwojowych lub upowszechniania nauki realizowanych w okresie 24 miesięcy poprzedzających miesiąc złożenia wniosku:
...
d) czy projekt jest realizowany samodzielnie czy we współpracy z innymi podmiotami,

e) w przypadku projektu realizowanego we współpracy z innymi podmiotami - nazwy podmiotów biorących udział w realizacji projektu albo tworzących konsorcjum;
...
5. Do wniosku o założenie konta w Systemie POL-on podmiot, o którym mowa w ust. 1 pkt 9, dołącza informację o złożeniu, na podstawie art. 30 ust. 1 pkt 3 ustawy z dnia 29 czerwca 1995 r. o statystyce publicznej, sprawozdania o działalności badawczej i rozwojowej (B+R) GUS PNT-01 za rok poprzedzający rok złożenia wniosku.

6. Wniosek o założenie konta w Systemie POL-on składa się w formie dokumentu elektronicznego opatrzonego podpisem zaufanym, kwalifikowanym podpisem elektronicznym albo podpisem osobistym, za pomocą elektronicznej skrzynki podawczej ministra albo z wykorzystaniem publicznej usługi rejestrowanego doręczenia elektronicznego.

##### § 8.

W przypadku utworzenia podmiotu, o którym mowa w § 7 ust. 1 pkt 1-5, 7 i 9, dane do baz danych, o których mowa w art. 342 ust. 3 pkt 1-4 i 7 ustawy, wprowadza się w terminie 30 dni od dnia założenia konta w Systemie POL-on.

##### § 9.

1. Rektor, rektor uczelni prowadzonej przez kościół lub inny związek wyznaniowy otrzymującej subwencje, dotacje i inne środki z budżetu państwa, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, prezes Centrum Łukasiewicz, dyrektor instytutu Sieci Łukasiewicz, prezes PAU i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej:

1) wprowadzają dane do wykazu pracowników w terminie 30 dni od dnia zatrudnienia nauczyciela akademickiego, innej osoby prowadzącej zajęcia, osoby prowadzącej działalność naukową lub biorącej udział w jej prowadzeniu, zwanych dalej łącznie „pracownikami”;

2) aktualizują dane w wykazie pracowników w terminie 30 dni od dnia zaistnienia zmiany albo uzyskania informacji o zmianie;

3) oznaczają dane w wykazie pracowników jako archiwalne w terminie 30 dni od dnia ustania zatrudnienia pracownika.

2. Do wykazu pracowników dane, o których mowa w art. 343 ust. 1:

1) pkt 10 ustawy, wprowadzają rektor, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej,

2) pkt 11, 12 i 16 ustawy, wprowadzają rektor, rektor uczelni prowadzonej przez kościół lub inny związek wyznaniowy otrzymującej subwencje, dotacje i inne środki z budżetu państwa, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, prezes PAU i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej
...
5. Rektor albo minister usuwa z wykazu pracowników dane, o których mowa w art. 343 ust. 1 pkt 20 ustawy, niezwłocznie po powzięciu informacji o:

1) zatarciu kary dyscyplinarnej;

2) uchyleniu orzeczenia o ukaraniu karą dyscyplinarną;

3) zatarciu skazania;

4) uchyleniu wyroku sądu.
...
7. Danych służących upowszechnianiu wyników działalności naukowej, o których mowa w art. 343 ust. 1 pkt 1, 3, 8, 10, 13, 18, 19 i 21 ustawy, nie usuwa się.

8. Przewodniczący Rady Doskonałości Naukowej wprowadza do wykazu pracowników dane o utracie tytułu profesora w terminie 21 dni od dnia doręczenia prawomocnego orzeczenia sądu, o którym mowa w art. 231 ust. 1 ustawy.
...
1) wprowadzają dane do wykazu studentów w terminie 30 dni od dnia rozpoczęcia nowego cyklu kształcenia w danym roku akademickim;

2) aktualizują dane w wykazie studentów, o których mowa w art. 344 ust. 1 pkt 8 ustawy, w terminie 30 dni od dnia zakończenia semestru studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - od dnia zakończenia roku studiów, a pozostałe dane dotyczące studenta - w terminie 30 dni od dnia uzyskania informacji o zmianie;

3) oznaczają dane w wykazie studentów jako archiwalne w terminie 30 dni od dnia ukończenia studiów albo uprawomocnienia się decyzji o skreśleniu z listy studentów.
...
1) wprowadzają do wykazu osób ubiegających się o stopień doktora dane:
...
2) aktualizują dane w wykazie osób ubiegających się o stopień doktora w terminie 21 dni od dnia zaistnienia zmiany albo uzyskania informacji o zmianie;

3) oznaczają dane w wykazie osób ubiegających się o stopień doktora jako archiwalne w terminie 21 dni od dnia, w którym decyzja:
...
3. Danych służących upowszechnianiu wyników działalności naukowej, o których mowa w art. 345 ust. 1 pkt 1, 3, 12, 13 i 16 ustawy, nie usuwa się.

##### § 12.

1. Rektor, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, prezes PAU i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej:

1) wprowadzają dane, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, do wykazu instytucji w terminie 21 dni od dnia utworzenia studiów na określonym kierunku, poziomie i profilu;

2) wprowadzają dane, o których mowa w art. 346 ust. 1 pkt 11 ustawy, do wykazu instytucji w zakresie, o którym mowa w § 5 ust. 4 pkt 1:

a) lit. a-i, w terminie 21 dni od dnia utworzenia szkoły doktorskiej,

b) lit. j, w terminie 21 dni od dnia, w którym uchwała w sprawie oceny jakości kształcenia w szkole doktorskiej stała się ostateczna;

3) aktualizują dane w wykazie instytucji, o których mowa w art. 346 ust. 1:
...
c) pkt 13-17 ustawy, w terminie do dnia 31 marca następnego roku, według stanu na dzień 31 grudnia, z wyjątkiem danych, o których mowa w art. 346 ust. 1 pkt 16 ustawy w zakresie informacji o przychodach z usług badawczych świadczonych na zlecenie podmiotów nienależących do systemu szkolnictwa wyższego i nauki oraz art. 346 ust. 1 pkt 17 ustawy, dotyczących roku poprzedzającego rok przeprowadzenia ewaluacji, które aktualizuje w terminie do dnia 15 stycznia roku, w którym ewaluacja jest przeprowadzana;

4) oznaczają dane, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, jako archiwalne w terminie 21 dni od dnia zaprzestania prowadzenia studiów.

2. Prezes Centrum Łukasiewicz i dyrektor instytutu Sieci Łukasiewicz aktualizują w wykazie instytucji dane, o których mowa w art. 346 ust. 1:
...
3. Dane, o których mowa w art. 346 ust. 1 pkt 10 ustawy, minister wprowadza do wykazu instytucji w terminie do dnia 15 lutego roku akademickiego, w którym rozpoczęto prowadzenie studiów.

4. Jeżeli prowadzenie studiów rozpoczęto po dniu 15 lutego, dane, o których mowa w art. 346 ust. 1 pkt 10 ustawy, minister wprowadza do dnia 15 lutego następnego roku.

5. Dane w wykazie instytucji nie są archiwizowane i nie są usuwane, z wyjątkiem danych, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, które są przechowywane przez okres 20 lat, liczony od roku następującego po roku, w którym nastąpiło oznaczenie tych danych jako archiwalne.
...
1) wprowadzają do bazy dokumentów w postępowaniach awansowych dane osób ubiegających się o:
...
2) aktualizują dane w bazie dokumentów w postępowaniach awansowych niezwłocznie po zaistnieniu zmiany albo po uzyskaniu informacji o zmianie.
...
1) wprowadzają dane do bazy osób upoważnionych niezwłocznie po objęciu funkcji przez osobę upoważnioną do podpisywania dokumentów albo po wprowadzeniu wzoru pieczęci urzędowej lub wzoru dokumentu;

2) aktualizują dane w bazie osób upoważnionych niezwłocznie po zaistnieniu zmiany;

3) oznaczają dane w bazie osób upoważnionych jako archiwalne niezwłocznie po zakończeniu sprawowania funkcji przez osobę upoważnioną do podpisywania dokumentów albo po wprowadzeniu nowego wzoru pieczęci urzędowej lub nowego wzoru dokumentu.

2. Danych zamieszczonych w bazie osób upoważnionych nie usuwa się.

##### § 16.

1. Rektor, rektor uczelni prowadzonej przez kościół lub inny związek wyznaniowy otrzymującej subwencje, dotacje i inne środki z budżetu państwa, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, prezes Centrum Łukasiewicz, dyrektor instytutu Sieci Łukasiewicz, prezes PAU i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej wprowadzają do bazy dokumentów planistyczno-sprawozdawczych odpowiednio:
...
c) składane w trybie art. 427 ust. 1 ustawy, w terminie 21 dni od dnia otrzymania wezwania ministra do złożenia danego sprawozdania;

4) raporty z wykorzystania środków finansowych, o których mowa w art. 365 pkt 2a, 2b oraz pkt 4 lit. c i d ustawy, w terminie do dnia 30 kwietnia roku następującego po roku, na który środki finansowe zostały przyznane;

5) raporty z wykorzystania środków finansowych, o których mowa w art. 365 pkt 4 lit. a i b ustawy, w przypadku inwestycji, o których mowa w:
...
b) art. 373 ust. 1 pkt 3 i ust. 3 pkt 4 ustawy, w terminie:
...
6) raporty z wykorzystania środków finansowych, o których mowa w art. 365 pkt 5 ustawy, w terminie:
...
7) raporty z wykorzystania środków finansowych, o których mowa w art. 365 pkt 7 ustawy, w terminie:

a) do dnia 31 marca roku następującego po roku, na który środki finansowe zostały przyznane, a w przypadku:

- programu lub przedsięwzięcia związanych z kształceniem - w terminie do dnia 5 października roku następującego po roku akademickim, na który środki finansowe zostały przyznane, jako raport roczny,
...
1) art. 343 ust. 1 pkt 1, 3, 8, 10, 13, 18, 19, pkt 20 - w zakresie informacji o prawomocnym orzeczeniu kary dyscyplinarnej - i pkt 21 ustawy;

2) art. 346 ust. 1 pkt 1-10, pkt 11 - z wyłączeniem danych osobowych doktorantów - i pkt 12-14 oraz ust. 3 ustawy;

3) art. 348 ust. 1 ustawy, z wyłączeniem numerów PESEL i numerów dokumentów potwierdzających tożsamość osób ubiegających się o stopień albo o tytuł profesora.

3. Konta w Systemie POL-on założone dla podmiotów, o których mowa w § 7 ust. 1, umożliwiają tym podmiotom dostęp do danych.

4. Uprawnionym podmiotom, o których mowa w art. 343 ust. 5 pkt 1 i 4, art. 344 ust. 3 pkt 1 i 3-5, art. 345 ust. 3 pkt 1 i 3-5, art. 346 ust. 7 pkt 1 i 1a, art. 347 ust. 5, art. 349 ust. 3 oraz art. 350 ust. 3 pkt 1 i 1a ustawy, dostęp do danych zawartych w Systemie POL-on przysługuje na podstawie konta założonego dla nich w tym systemie.

5. W przypadku uzyskania uprawnień na podstawie przepisów, o których mowa w ust. 4, podmiot składa do ministra wniosek o założenie konta w Systemie POL-on. Przepisy § 7 ust. 3 i 6 stosuje się odpowiednio.

##### § 18.

1. Rektor, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, Prezes Centrum Łukasiewicz, dyrektor instytutu Sieci Łukasiewicz i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły, posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej wprowadzą dane, o których mowa w § 5 ust. 1 pkt 6 lit. j i ust. 2 pkt 1 lit. j, w terminie 60 dni od dnia objęcia podmiotu, którego dane są obowiązani wprowadzać, obowiązkiem stosowania przepisów ustawy z dnia 18 listopada 2020 r. o doręczeniach elektronicznych w zakresie doręczania korespondencji z wykorzystaniem publicznej usługi rejestrowanego doręczenia elektronicznego.

2. Rektor:

1) zaktualizuje dane, o których mowa w § 5 ust. 4 pkt 3 lit. d,

2) wprowadzi dane, o których mowa w § 5 ust. 2 pkt 11 lit. c tiret pierwsze, drugie i trzecie oraz pkt 19 lit. b
