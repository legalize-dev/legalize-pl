...
identifier: "DU-2017-2247"
country: "pl"
rank: "obwieszczenie"
publication_date: "2017-11-09"
last_updated: "2017-11-09"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2017/2247"
department: "PREZ. RADY MINISTRÓW"
eli: "DU/2017/2247"
display_address: "Dz.U. 2017 poz. 2247"
internal_address: "WDU20170002247"
publisher: "DU"
volume: "0"
position: "2247"
...
1. Na podstawie art. 16 ust. 3 ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst rozporządzenia Rady Ministrów z dnia 12 kwietnia 2012 r. w sprawie Krajowych Ram Interoperacyjności, minimalnych wymagań dla rejestrów publicznych i wymiany informacji w postaci elektronicznej oraz minimalnych wymagań dla systemów teleinformatycznych , z uwzględnieniem zmian wprowadzonych rozporządzeniem Rady Ministrów z dnia 14 października 2016 r. zmieniającym rozporządzenie w sprawie Krajowych Ram Interoperacyjności, minimalnych wymagań dla rejestrów publicznych i wymiany informacji w postaci elektronicznej oraz minimalnych wymagań dla systemów teleinformatycznych .

2. Podany w załączniku do niniejszego obwieszczenia tekst jednolity rozporządzenia nie obejmuje § 2 rozporządzenia Rady Ministrów z dnia 14 października 2016 r. zmieniającego rozporządzenie w sprawie Krajowych Ram Interoperacyjności, minimalnych wymagań dla rejestrów publicznych i wymiany informacji w postaci elektronicznej oraz minimalnych wymagań dla systemów teleinformatycznych , który stanowi:
...
a) część pierwsza - identyfikator zbioru danych przestrzennych nadany zgodnie z przepisami wydanymi na podstawie art. 13 ust. 5 ustawy z dnia 4 marca 2010 r. o infrastrukturze informacji przestrzennej (Dz. U. z 2017 r. poz. 1382, z późn. zm.),
...
|  | **1** | 2 | 2 | 3 | 3 | **4** | 5 | 6 | 7 | 8 |
|  | **1** | Osoba fizyczna posiadająca nadany numer PESEL | Osoba fizyczna posiadająca nadany numer PESEL | Numer PESEL | Numer PESEL | **11** | Pole znakowe, znaki z zakresu {0..9} | Powszechny Elektroniczny System Ewidencji Ludności | Ustawa z dnia 24 września 2010 r. o ewidencji ludności (Dz. U. z 2017 r. poz. 657) | \d{ll} |
...
|  | **3** | Obiekt przestrzenny | Punkt adresowy | Identyfikator punktu adresowego | Przestrzeń nazw (namespace)^*)^ | do **26** | Pole znakowe, znaki z zakresu {A.. Z, a.. z, 0..9„.,} | Ewidencja Miejscowości, Ulic i Adresów | Ustawa z dnia 17 maja 1989 r. - Prawo geodezyjne i kartograficzne (Dz. U. z 2017 r. poz. 2101) | PL\.[A-Za-z]{1,6}\.\d{1,6} \.[A-Za-z0-9]{1,8} [A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12} |
|  | **3** | Obiekt przestrzenny | Punkt adresowy | Identyfikator punktu adresowego | Identyfikator lokalny (localId) | do **38** | Pole znakowe, znaki z zakresu {A.. Z, a.. z, 0.. 9, _,.,-} | Ewidencja Miejscowości, Ulic i Adresów | Ustawa z dnia 17 maja 1989 r. - Prawo geodezyjne i kartograficzne (Dz. U. z 2017 r. poz. 2101) | PL\.[A-Za-z]{1,6}\.\d{1,6} \.[A-Za-z0-9]{1,8} [A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12} |
|  |  |  |  |  | Identyfikator wersji (versionld) | do 25 | Pole znakowe, znaki z zakresu {T, 0.. 9, +, -,:} |  |  | \d{4}-\d\d- \d\dT\d\d:\d\d: \d\d[+\- ]\d\d:\d\d |
|  |  |  | Działka ewidencyjna | Identyfikator działki ewidencyjnej | Przestrzeń nazw (namespace)^*)^ | do 26 | Pole znakowe, znaki z zakresu {A.. Z, a.. z, 0..9„.,} | Ewidencja Gruntów i Budynków |  | PL\.[A-Za-z]{1,6}\.\d{1,6} \.[A-Za-z0- 9]{1,8} [A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12} \d{4}-\d\d- \d\dT\d\d:\d\d: \d\d[+\- ]\d\d:\d\d |
|  |  |  | Działka ewidencyjna | Identyfikator działki ewidencyjnej | Identyfikator lokalny (localld) | do 38 | Pole znakowe, znaki z zakresu {A.. Z, a.. z, 0.. 9, _,.,-} | Ewidencja Gruntów i Budynków |  | PL\.[A-Za-z]{1,6}\.\d{1,6} \.[A-Za-z0- 9]{1,8} [A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12} \d{4}-\d\d- \d\dT\d\d:\d\d: \d\d[+\- ]\d\d:\d\d |
|  |  |  |  |  |  |  |  |  |  |  |
