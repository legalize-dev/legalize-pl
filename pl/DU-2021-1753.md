---
title: "Rozporządzenie Ministra Rozwoju, Pracy i Technologii z dnia 12 września 2021 r. w sprawie kryteriów i warunków technicznych, którym muszą odpowiadać kasy rejestrujące z elektronicznym zapisem kopii"
identifier: "DU-2021-1753"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2021-09-12"
last_updated: "2021-09-12"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2021/1753"
department: "MIN. ROZWOJU, PRACY I TECHNOLOGII"
eli: "DU/2021/1753"
display_address: "Dz.U. 2021 poz. 1753"
internal_address: "WDU20210001753"
publisher: "DU"
volume: "0"
position: "1753"
...
has_pdf: "true"
keywords: "elektroniczne nośniki informacji, kasy rejestrujące, sprawozdawczość, elektroniczne urządzenia, dokumenty, podatek od towarów i usług"
---
...
Na podstawie art. 145a ust. 16 ustawy z dnia 11 marca 2004 r. o podatku od towarów i usług zarządza się, co następuje:
...
Kasy, ze względu na konstrukcję lub przeznaczenie, dzieli się na następujące rodzaje:
...
1. Kasa odpowiada następującym kryteriom:
...
Kasa odpowiada następującym warunkom technicznym:
...
W drukarkach fiskalnych, o których mowa w § 4 pkt 2, komunikacja bezprzewodowa między programem aplikacyjnym a kasą jest dostępna jedynie poprzez elementy konstrukcyjne i programowe zamknięte w obudowie kasy i jest dozwolona jedynie za pośrednictwem szyfrowanego kanału komunikacyjnego z wykorzystaniem mechanizmów wzajemnej autoryzacji.

##### § 8.

Opisy w dokumentach wystawianych przy użyciu kasy i napisy na wyświetlaczach kasy są wykonywane w języku polskim.

##### § 9.

1. Kasa dodatkowo odpowiada następującym kryteriom i warunkom technicznym:
...
1. Program pracy kasy posiada funkcję:
...
1. Kasa umożliwia wydruk paragonu fiskalnego zawierającego:
...
1. Kasa umożliwia wydruk raportu fiskalnego dobowego zawierającego co najmniej:
...
1. Kasa współpracująca z taksometrem przeznaczona do prowadzenia ewidencji sprzedaży przy świadczeniu usług przewozu osób oraz ich bagażu podręcznego taksówkami, poza kryteriami określonymi w § 5, odpowiada także następującym kryteriom:
...
1. Kasa współpracująca z taksometrem przeznaczona do prowadzenia ewidencji sprzedaży przy świadczeniu usług przewozu osób oraz ich bagażu podręcznego taksówkami odpowiada również następującym warunkom technicznym:
...
1. Kasa, o której mowa w § 18, umożliwia wydruk paragonu fiskalnego zawierającego co najmniej:
...
Program pracy kasy odpowiada następującym warunkom technicznym:
...
Program pracy kasy może nie zawierać niektórych elementów odpowiedzialnych za elektroniczny zapis kopii, związanych z realizacją warunków technicznych określonych w § 20 pkt 11-19, jeżeli:
...
### Rozdział 3. Sposób oznaczania pamięci fiskalnej kas numerami unikatowymi i warunki ich przydzielania oraz dokumenty, które powinny być dołączone do kasy przy wprowadzaniu jej do obrotu
...
### Rozdział 4. Wniosek o wydanie potwierdzenia o spełnieniu przez kasy funkcji, kryteriów i warunków technicznych, którym odpowiadają kasy, oraz okres, na który jest wydawane potwierdzenie

##### § 24.

1. W celu otrzymania potwierdzenia producent składa wniosek zawierający:
...
1. W celu wykonania badań kasy producent udostępnia wszystkie urządzenia przeznaczone do współpracy z kasą.
...
Wniosek oraz dołączone do niego dokumenty są sporządzane w języku polskim albo są dołączane ich tłumaczenia na język polski, sporządzone przez tłumacza przysięgłego.

##### § 28.

Potwierdzenie wydaje się na okres, o którym mowa w art. 145a ust. 7 pkt 1 ustawy.

##### § 29.

Po uzyskaniu potwierdzenia wszelkie zmiany funkcjonalne, konstrukcyjne oraz programowe w kasie, przed ich wprowadzeniem, wymagają każdorazowo ponownego złożenia wniosku wraz z wymaganymi dokumentami i urządzeniami, uzyskania pozytywnego wyniku z wszystkich przeprowadzonych badań kasy oraz uzyskania potwierdzenia.

### Rozdział 5. Zakres badań kasy oraz rodzaje danych zawartych w sprawozdaniu z badań kasy
...
1. Potwierdzenia wydane przed dniem wejścia w życie niniejszego rozporządzenia zachowują moc do dnia określonego w tym potwierdzeniu, nie dłużej niż przez okres, o którym mowa w art. 145a ust. 7 pkt 1 ustawy, chyba że potwierdzenie zostanie cofnięte.
...
2) potwierdzeniu, o którym mowa w art. 111 ust. 6b ustawy, wydanym po dniu wejścia w życie ustawy z dnia 18 marca 2011 r. o zmianie ustawy o podatku od towarów i usług oraz ustawy - Prawo o miarach , na podstawie przepisów, o których mowa w pkt 1
...
1. Numer unikatowy dla użytkowanych kas, które uzyskały potwierdzenie o spełnieniu kryteriów i warunków technicznych przed 2000 r., składa się z dwuliterowego prefiksu oraz ciągu 8 cyfr.
...
Do postępowań w sprawach potwierdzeń, wszczętych i niezakończonych przed dniem wejścia w życie niniejszego rozporządzenia, stosuje się przepisy dotychczasowe.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2021/1753/text.pdf)
