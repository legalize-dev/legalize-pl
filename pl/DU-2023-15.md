---
title: "Rozporządzenie Ministra Rolnictwa i Rozwoju Wsi z dnia 23 grudnia 2022 r. w sprawie szczegółowego zakresu informacji zawartych w komputerowej bazie danych"
identifier: "DU-2023-15"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2022-12-23"
last_updated: "2022-12-23"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2023/15"
department: "MIN. ROLNICTWA I ROZWOJU WSI"
eli: "DU/2023/15"
display_address: "Dz.U. 2023 poz. 15"
internal_address: "WDU20230000015"
publisher: "DU"
volume: "0"
position: "15"
...
has_pdf: "true"
keywords: "elektroniczne nośniki informacji, rejestry, zwierzęta hodowlane"
---
...
Na podstawie art. 13 ustawy z dnia 4 listopada 2022 r. o systemie identyfikacji i rejestracji zwierząt zarządza się, co następuje:

##### § 1.

Komputerowa baza danych zawiera w odniesieniu do:
...
k) rodzaj środka identyfikacji zastosowanego do oznakowania zwierzęcia i miejsce jego umieszczenia - w przypadku zastosowania elektronicznego identyfikatora u tego zwierzęcia,
...
u) weterynaryjny numer identyfikacyjny, jeżeli został nadany w związku z rejestracją siedziby stada na podstawie art. 93 rozporządzenia 2016/429 lub zatwierdzeniem siedziby stada na podstawie art. 97 ust. 1 rozporządzenia 2016/429, oraz datę wydania decyzji o nadaniu tego numeru,
...
j) rodzaj środka identyfikacji zastosowanego do oznakowania zwierzęcia oraz miejsce jego umieszczenia - w przypadku zastosowania elektronicznego identyfikatora lub tatuażu u tego zwierzęcia,
...
s) weterynaryjny numer identyfikacyjny, jeżeli został nadany w związku z rejestracją siedziby stada na podstawie art. 93 rozporządzenia 2016/429 lub zatwierdzeniem siedziby stada na podstawie art. 97 ust. 1 rozporządzenia 2016/429, oraz datę wydania decyzji o nadaniu tego numeru,
...
k) rodzaj środka identyfikacji zastosowanego do oznakowania zwierzęcia oraz miejsce jego umieszczenia - w przypadku zastosowania elektronicznego identyfikatora lub tatuażu u tego zwierzęcia,
...
h) rodzaj środka identyfikacji zastosowanego do oznakowania zwierzęcia oraz miejsce jego umieszczenia - w przypadku zastosowania elektronicznego identyfikatora lub tatuażu u tego zwierzęcia,
...
r) datę padnięcia, zabicia lub poddania ubojowi lochy oznakowanej indywidualnym numerem identyfikacyjnym lochy w siedzibie stada oraz numer siedziby stada, w której to zwierzę padło, zostało zabite lub poddane ubojowi,
...
- liczbę zwierząt przemieszczonych z siedziby stada lub do siedziby stada,
...
- inne modele produkcji świń niewymienione w tiret pierwszym-piątym;
...
j) miejsce umieszczenia zastosowanego środka identyfikacji,
...
q) informacje o padnięciu, zabiciu lub poddaniu zwierzęcia ubojowi z nakazu powiatowego lekarza weterynarii albo uboju zwierzęcia z konieczności albo informacje dotyczące uboju zwierzęcia w rzeźni obejmujące:
...
r) weterynaryjny numer identyfikacyjny, jeżeli został nadany w związku z rejestracją siedziby stada na podstawie art. 93 rozporządzenia 2016/429 lub zatwierdzeniem siedziby stada na podstawie art. 97 ust. 1 rozporządzenia 2016/429, oraz datę wydania decyzji o nadaniu tego numeru,
