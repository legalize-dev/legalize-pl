...
identifier: "DU-2023-974"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2023-05-18"
last_updated: "2023-05-18"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2023/974"
department: "MIN. SPRAWIEDLIWOŚCI"
eli: "DU/2023/974"
display_address: "Dz.U. 2023 poz. 974"
internal_address: "WDU20230000974"
publisher: "DU"
volume: "0"
position: "974"
...
has_pdf: "true"
keywords: "formularze, rejestry, fundacje"
---
# Rozporządzenie Ministra Sprawiedliwości z dnia 18 maja 2023 r. w sprawie określenia wzorów urzędowych formularzy wniosków o wpis do rejestru fundacji rodzinnych oraz sposobu i miejsca ich udostępniania

## Treść rozporządzenia

Na podstawie art. 119 ust. 2 ustawy z dnia 26 stycznia 2023 r. o fundacji rodzinnej zarządza się, co następuje:
...
Formularze, o których mowa w § 1, są udostępniane w siedzibach sądów okręgowych.
...
## Załącznik nr 1 - RFR-W: Wniosek o rejestrację fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 2 - RFR-Z: Wniosek o zmianę danych fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 3 - RFR-Z30: Wniosek o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 4 - RFR-Z61: Wniosek o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 5 - RFR-Z63: Wniosek o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 6 - RFR-Z67: Wniosek o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 7 - RFR-Z68: Wniosek o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 8 - RFR-X: Wniosek o wykreślenie fundacji rodzinnej z rejestru fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 9 - RFR-WA: Załącznik do wniosku o rejestrację fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 10 - RFR-WB: Załącznik do wniosku o rejestrację fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 11 - RFR-WL: Załącznik do wniosku o rejestrację lub o zmianę danych fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 12 - RFR-WK: Załącznik do wniosku o rejestrację lub o zmianę danych fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 13 - RFR-WM: Załącznik do wniosku o rejestrację lub o zmianę danych fundacji rodzinnej w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 14 - RFR-ZA: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 15 - RFR-ZB: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 16 - RFR-ZK: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 17 - RFR-ZL: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 18 - RFR-ZN: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 19 - RFR-ZR: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnej (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 20 - RFR-ZM: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts//text.pdf)

## Załącznik nr 21 - RFR-ZY: Załącznik do wniosku o zmianę danych w rejestrze fundacji rodzinnych (wzór)
