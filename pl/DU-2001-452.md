---
title: "Ustawa z dnia 16 marca 2001 r. o rolnictwie ekologicznym"
identifier: "DU-2001-452"
country: "pl"
rank: "ustawa"
publication_date: "2001-03-16"
last_updated: "2001-03-16"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2001/452"
department: "SEJM"
eli: "DU/2001/452"
display_address: "Dz.U. 2001 nr 38 poz. 452"
internal_address: "WDU20010380452"
publisher: "DU"
volume: "38"
position: "452"
status_pl: "uchylony"
promulgation_date: "2001-05-02"
entry_into_force: "2001-11-03"
valid_from: "2001-11-03"
effective_date_notes: "Art. 3 pkt 3 wchodzi w życie z dniem 3 maja 2005 r., art. 16 ust. 2 wchodzi w życie w dniu uznania przez właściwy organ Unii Europejskiej krajowego systemu kontroli za równorzędny z unijnym w zakresie certyfikacji zgodności w rolnictwie ekologicznym."
parliamentary_prints_count: "1"
references_count: "5"
text_variants_count: "5"
has_pdf: "true"
keywords: "produkty rolne, ekologia, grzywny, kontrola, przepisy karne, zwierzęta hodowlane, żywność i żywienie, rolnictwo, produkcja, dotacje, sprzedaż"
---
...
1. Zwierzęta utrzymywane w ekologicznym gospodarstwie rolnym, z zastrzeżeniem ust. 2 i 3, mogą pochodzić tylko z ekologicznych gospodarstw rolnych.
...
1. Pasiekę umiejscawia się na terenie, który spełnia wymogi określone w art. 5 ust. 1 pkt 1, a w promieniu co najmniej 3 km od pasieki produkcja jest prowadzona metodami ekologicznymi lub znajdują się tereny, o których mowa w art. 10.
...
1. W ekologicznym gospodarstwie rolnym lub w jego części, w której prowadzi się produkcję metodami ekologicznymi:
...
1. W prowadzeniu produkcji zwierzęcej metodami ekologicznymi zabronione jest profilaktyczne stosowanie leków weterynaryjnych.
...
1. Producent prowadzi wykaz środków używanych do wytwarzania produktów rolnictwa ekologicznego oraz środków leczenia zwierząt, z podaniem źródła ich pochodzenia.
...
1. Płody rolne nieprzetworzone oraz produkty z nich powstałe, w tym także zwierzęta oraz produkty i przetwory pochodzenia zwierzęcego, wprowadza się do obrotu jako produkty rolnictwa ekologicznego, jeżeli zostały wyprodukowane lub przetworzone metodami ekologicznymi, co potwierdza certyfikat zgodności.
...
1. Producent zamierzający prowadzić ekologiczne gospodarstwo rolne występuje do upoważnionej jednostki certyfikującej z pisemnym zgłoszeniem, do którego dołącza:
...
1. Certyfikat zgodności może być wydany po przeprowadzeniu kontroli u zainteresowanego producenta przez wyznaczonych pracowników upoważnionej jednostki certyfikującej.
...
1. Upoważniona jednostka certyfikująca w uzasadnionych przypadkach może, bez uprzedniego zawiadomienia, przeprowadzać u producentów doraźne kontrole zgodności prowadzonej produkcji lub przetwórstwa z wydanym certyfikatem zgodności i pobierać próbki produktów rolnictwa ekologicznego.
...
1. W celu uzyskania certyfikatu zgodności zainteresowany producent występuje do upoważnionej jednostki certyfikującej z pisemnym wnioskiem zawierającym:
...
1. Nadzór nad działalnością upoważnionych jednostek certyfikujących sprawuje Inspekcja Skupu i Przetwórstwa Artykułów Rolnych.
...
### Rozdział 4. Znakowanie, przechowywanie i przewóz produktów rolnictwa ekologicznego

##### Art. 24.

1. Produkty, o których mowa w art. 16 ust. 1, są oznakowane etykietą i wprowadzane do obrotu jako produkty rolnictwa ekologicznego.
...
1. Oznakowanie produktu rolnictwa ekologicznego, z zastrzeżeniem ust. 3, polega na zamieszczeniu na etykiecie lub opakowaniu tego produktu napisu „produkt rolnictwa ekologicznego” oraz nazwy producenta, numeru certyfikatu zgodności, nazwy upoważnionej jednostki certyfikującej i jej numeru identyfikacyjnego.
...
1. Oznakowane produkty rolnictwa ekologicznego przeznaczone do obrotu lub dalszego przetwórstwa należy przechowywać oddzielnie od innych produktów rolnych.
...
W ustawie z dnia 30 czerwca 1970 r. o Inspekcji Skupu i Przetwórstwa Artykułów Rolnych w art. 3 w ust. 1 po pkt 4 dodaje się pkt 5 w brzmieniu:
...
W ustawie z dnia 31 stycznia 1980 r. o ochronie i kształtowaniu środowiska w art. 88 po pkt 7 dodaje się pkt 7a w brzmieniu:
...
W ustawie z dnia 20 lipca 1991 r. o Inspekcji Ochrony Środowiska w art. 28 po ust. 2 dodaje się ust. 3 w brzmieniu:
...
## Załącznik - Oznakowania na produktach rolnictwa ekologicznego objętych systemem kontroli Unii Europejskiej

1) ES: Agricultura Ecologica - Sistema de control CE

2) DK: Økologisk Jordburg - EF Kontrolording

3) D: Ökologische Landbau - EG-kontrollsystem lub Biologische Landwirtschaft - EG-kontrollsystem

4) GR: Βιολογικη γεωργια - Σνοτημα ελεγχον ΕΚ

5) EN: Organic Farming - EC Control System
...
9) P: Agricultura Ecologica - Sistema de Controlo CE

10) FI: Luonnonmukainen maataloustuotanto - EY:n valvontajärjestelmä Ekologiskt jordburk - EG-kontrollsystem

11) S: Ekologiskt jordburk - EG-kontrollsystem
