---
title: "Ustawa z dnia 12 września 2002 r. o normalizacji"
identifier: "DU-2002-1386"
country: "pl"
rank: "ustawa"
publication_date: "2002-09-12"
last_updated: "2002-09-12"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2002/1386"
department: "SEJM"
eli: "DU/2002/1386"
display_address: "Dz.U. 2002 nr 169 poz. 1386"
internal_address: "WDU20021691386"
publisher: "DU"
volume: "169"
position: "1386"
...
named_entities: "Polski Komitet Normalizacyjny, Polskie Normy"
parliamentary_prints_count: "1"
references_count: "7"
text_variants_count: "5"
has_pdf: "true"
keywords: "jakość wyrobów, badania i certyfikacje, jednostki budżetowe, komitety, normalizacja, normy"
---
...
5. Rada Ministrów określi, w drodze rozporządzenia, sposób nadawania i wykorzystywania znaku zgodności z Polska Normą, mając na względzie ułatwienie producentom i dystrybutorom oznaczania wyrobów znakiem zgodności z Polską Normą oraz uwzględniając:
...
2. Tworzy się środek specjalny PKN, zwany dalej „środkiem specjalnym”.

3. Środek specjalny może być tworzony z następujących źródeł:

1) wpływów od zamawiających prace związane z opracowywaniem Polskich Norm i innych dokumentów normalizacyjnych;

2) wpływów ze sprzedaży norm i innych materiałów związanych z normalizacją;

3) wpływów ze szkoleń normalizacyjnych;

4) odsetek bankowych od środka specjalnego, o którym mowa w ust. 2.

4. Ze środka specjalnego są finansowane:

1) prace związane z opracowywaniem Polskich Norm i innych dokumentów normalizacyjnych wykonywane na zamówienie jednostek pozabudżetowych;

2) przygotowania do sprzedaży i rozpowszechniania norm i innych materiałów związanych z normalizacją, w szczególności:

a) przygotowanie do druku oraz druk norm i innych materiałów związanych z normalizacją,

b) zapisywanie norm i innych materiałów związanych z normalizacją na nośnikach elektronicznych,

c) zakup zabezpieczeń przed nielegalnym kopiowaniem,

d) reklama i kolportaż,

e) zakup gotowych do sprzedaży norm i innych materiałów związanych z normalizacją od innych wydawnictw;

3) szkolenia normalizacyjne, w szczególności:

a) organizowanie i prowadzenie szkoleń normalizacyjnych,

b) wynagrodzenia wykładowców;

4) wydatki związane z obsługą środka specjalnego.

5. Ze środka specjalnego nie mogą być finansowane wynagrodzenia osobowe.
...
1. Prezes Rady Ministrów powołuje Prezesa na okres 5 lat spośród zgłoszonych przez Radę Normalizacyjną kandydatów wyłonionych uprzednio w drodze konkursu. Rada Normalizacyjna może również przedstawić Prezesowi Rady Ministrów tylko jednego kandydata.

2. Rada Normalizacyjna przeprowadza konkurs, o którym mowa w ust. 1.

3. Na stanowisko Prezesa może kandydować obywatel polski:

1) posiadający wykształcenie wyższe;

2) legitymujący się co najmniej czteroletnim stażem pracy związanym z normalizacją;

3) niekarany.

4. Prezes Rady Ministrów określi, w drodze rozporządzenia, organizację i sposób przeprowadzenia konkursu, mając na względzie w szczególności zapewnienie powszechności dostępu do konkursu i ocenę kwalifikacji kandydatów.

5. Prezes Rady Ministrów powołuje i odwołuje, na wniosek Prezesa, dwóch zastępców Prezesa.

6. Prezes Rady Ministrów odwołuje Prezesa przed upływem kadencji, w przypadku:
...
7. Prezes Rady Ministrów może odwołać Prezesa przed upływem kadencji w razie nieprzyjęcia przez Radę rocznego sprawozdania złożonego przez Prezesa PKN lub na wniosek 2/3 składu Rady Normalizacyjnej.
...
1) składanie wniosku o powołanie i odwołanie Prezesa;

2) organizowanie konkursu, o którym mowa w art. 16 ust. 1.
