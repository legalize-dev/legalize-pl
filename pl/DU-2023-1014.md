---
title: "Obwieszczenie Ministra Infrastruktury z dnia 6 kwietnia 2023 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Ministra Infrastruktury i Rozwoju w sprawie warunków eksploatacji lotnisk"
identifier: "DU-2023-1014"
country: "pl"
rank: "obwieszczenie"
publication_date: "2023-04-06"
last_updated: "2023-04-06"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2023/1014"
department: "MIN. INFRASTRUKTURY"
eli: "DU/2023/1014"
display_address: "Dz.U. 2023 poz. 1014"
internal_address: "WDU20230001014"
publisher: "DU"
volume: "0"
position: "1014"
...
has_pdf: "true"
keywords: "porty lotnicze, lotnictwo cywilne"
---
...
1. Na podstawie art. 16 ust. 3 ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst rozporządzenia Ministra Infrastruktury i Rozwoju z dnia 11 września 2014 r. w sprawie warunków eksploatacji lotnisk , z uwzględnieniem zmian wprowadzonych rozporządzeniem Ministra Infrastruktury z dnia 23 grudnia 2022 r. zmieniającym rozporządzenie w sprawie warunków eksploatacji lotnisk .

2. Podany w załączniku do niniejszego obwieszczenia tekst jednolity rozporządzenia nie obejmuje § 2-4 rozporządzenia Ministra Infrastruktury z dnia 23 grudnia 2022 r. zmieniającego rozporządzenie w sprawie warunków eksploatacji lotnisk , które stanowią:

> § 2. Zarządzający lotniskami dostosują lotniska do wymagań określonych w § 3, § 4 pkt 4, § 6 ust. 2, § 9 ust. 1, § 17, § 20 pkt 2, § 22, § 23 pkt 3, 13 i 14, § 25 ust. 2, § 25a, § 26 ust. 6, § 30, § 31b, § 32a oraz § 33 ust. 1 pkt 3-5 i 13 rozporządzenia zmienianego w § 1 w brzmieniu nadanym niniejszym rozporządzeniem w terminie 12 miesięcy od dnia ogłoszenia niniejszego rozporządzenia. § 3. 1. Do dnia dostosowania przez zarządzającego lotniskiem lotniska do wymagań określonych w § 3, § 4 pkt 4, § 6 ust. 2, § 9 ust. 1, § 17, § 20 pkt 2, § 22, § 23 pkt 3, 13 i 14, § 25 ust. 2, § 25a, § 26 ust. 6, § 30, § 31b, § 32a oraz § 33 ust. 1 pkt 3-5 i 13 rozporządzenia zmienianego w § 1 w brzmieniu nadanym niniejszym rozporządzeniem system zarządzania bezpieczeństwem na lotnisku funkcjonuje zgodnie z przepisami dotychczasowymi. 2. Do dnia dostosowania przez zarządzającego lotniskiem lotniska do wymagań, o których mowa w § 17 rozporządzenia zmienianego w § 1 w brzmieniu nadanym niniejszym rozporządzeniem, prace na lotnisku są wykonywane zgodnie z przepisami dotychczasowymi. 3. Zarządzający lotniskiem dokonuje pierwszego przeglądu i w razie potrzeby uaktualnienia procedur, o których mowa w § 20 pkt 2 rozporządzenia zmienianego w § 1 w brzmieniu nadanym niniejszym rozporządzeniem, w terminie 12 miesięcy od dnia ogłoszenia niniejszego rozporządzenia. § 4. Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia.

## Załącznik - Rozporządzenie Ministra Infrastruktury i Rozwoju z dnia 11 września 2014 r. w sprawie warunków eksploatacji lotnisk
...
### Rozdział 2. Warunki eksploatacji lotnisk, o których mowa w art. 59a ust. 1 pkt 2 ustawy
...
f) sposób weryfikacji zgodności wprowadzanej do stosowania zmiany z zakresem, który był przedmiotem oceny bezpieczeństwa, oraz spełniania kryteriów bezpieczeństwa obwiązujących na lotnisku, przed wprowadzeniem zmiany do stosowania,
...
1. Dostęp do PRN powinny mieć wyłącznie osoby i pojazdy, których obecność jest niezbędna do wykonywania zadań związanych z funkcjonowaniem lotniska.

2. Osoby poruszające się w PRN używają kamizelek ostrzegawczych lub ubioru z elementami odblaskowymi.

##### § 7.

1. Kierowca pojazdu poruszającego się po lotnisku powinien posiadać prawo jazdy kategorii odpowiedniej dla danego pojazdu.
...
1. Procedury bezpieczeństwa na płycie postojowej zapewniające bezpieczeństwo dla znajdujących się na niej osób, statków powietrznych, pojazdów oraz urządzeń dotyczą:
...
1. Procedury zarządzania płytą postojową mają zapewnić:
...
1. LVP opracowane dla danego lotniska kontrolowanego stosuje się w przypadku:
...
1. Lotnisko użytkowane w zimie powinno być wyposażone w sprzęt i środki techniczne niezbędne do usuwania śniegu, lodu i błota pośniegowego z powierzchni PRN.
...
1. Prace na lotnisku powinny być prowadzone w sposób:
...
1. Procedury usuwania statków powietrznych unieruchomionych w PRN powinny określać:
...
1. Zarządzający lotniskiem monitoruje, kontroluje oraz rejestruje obecność zwierząt występujących na lotnisku, które mogą stanowić zagrożenie dla operacji lotniskowych.
...
1. Zarządzający lotniskiem zapewnia w terminach i godzinach otwarcia lotniska, którego średnioroczna krocząca liczba obsłużonych pasażerów obejmująca każde kolejne 365 dni wynosi:

1) do 1 mln pasażerów - pierwszą pomoc na miejscu zdarzenia oraz możliwość wezwania zespołu ratownictwa medycznego, o którym mowa w art. 36 ust. 1 ustawy z dnia 8 września 2006 r. o Państwowym Ratownictwie Medycznym , zwanej dalej „ustawą o PRM”;
...
3. Wymagania, jakim powinny odpowiadać pomieszczenia i urządzenia ambulatorium, o którym mowa w ust. 1 pkt 3 lit. b, pkt 4 lit. b i pkt 5 lit. b, określają przepisy wydane na podstawie art. 22 ust. 3 ustawy z dnia 15 kwietnia 2011 r. o działalności leczniczej .
...
5. Minimalne wyposażenie medyczne na lotnisku do zabezpieczenia zdarzenia masowego, w rozumieniu przepisów wydanych na podstawie art. 14 ust. 2 ustawy z dnia 24 sierpnia 1991 r. o ochronie przeciwpożarowej , określa załącznik nr 2 do rozporządzenia.

### Rozdział 2a. Warunki eksploatacji lotnisk, o których mowa w art. 59a ust. 1 pkt 1 ustawy, w zakresie udzielania niezbędnej pomocy medycznej na lotnisku
...
### Rozdział 3. Warunki eksploatacji lotnisk, dla których została wydana decyzja o ograniczonej certyfikacji, o której mowa w art. 59a ust. 2 ustawy
...
1. W celu zapewnienia bezpiecznej eksploatacji lotniska zarządzający lotniskiem opracowuje i wdraża procedury operacyjne, które określają metody postępowania w zakresie:
...
1. Zarządzający lotniskiem monitoruje i kontroluje obecność zwierząt występujących na lotnisku, które mogą stanowić zagrożenie dla bezpieczeństwa operacji lotniskowych.
...
^1)^ Wyposażenie wymienione w lp. 2-4może zapewniać jedno urządzenie.
...
|  | 2 | Urządzenie monitorujące parametry (funkcje) życiowe zawierające m.in.: monitor EKG, pomiar ciśnienia tętniczego krwi oraz pomiar wysycenia tlenem krwi^1)^ | 1 |
|  | 3 | Elektrokardiograf 12-odprowadzeniowy^1)^ | 1 |
|  | 4 | Defibrylator manualny z możliwością wykonania kardiowersji, elektrostymulacji, posiadający możliwość pomiaru stężenia karboksyhemoglobiny i methemoglobiny oraz wspomagający resuscytację krążeniowo-oddechową^1)^ | 1 |
