...
identifier: "DU-2014-1748"
country: "pl"
rank: "obwieszczenie"
publication_date: "2014-11-21"
last_updated: "2014-11-21"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2014/1748"
department: "PREZ. RADY MINISTRÓW"
eli: "DU/2014/1748"
display_address: "Dz.U. 2014 poz. 1748"
internal_address: "WDU20140001748"
publisher: "DU"
volume: "0"
position: "1748"
...
3. Podczas czynności podejmuje się przedsięwzięcia i stosuje środki konieczne do zapewnienia bezpieczeństwa osobistego funkcjonariuszy Agencji Bezpieczeństwa Wewnętrznego i osób udzielających im pomocy.

##### § 3.

1. Czynności prowadzi się przez czas oznaczony w zarządzeniu Szefa Agencji Bezpieczeństwa Wewnętrznego, zwanego dalej „Szefem ABW”, chyba że wcześniej zostanie osiągnięty cel czynności lub wystąpi trwały brak możliwości ich wykonywania.

2. Czas czynności biegnie od dnia wydania przez Szefa ABW zarządzenia o przeprowadzeniu czynności.

3. Zaprzestanie czynności z powodu trwałego braku możliwości ich wykonywania wymaga akceptacji Szefa ABW.

##### § 4.

1. Dokumentację czynności stanowią:

1) wniosek Szefa ABW do Prokuratora Generalnego o wyrażenie zgody na zarządzenie stosowania czynności;

2) postanowienie Prokuratora Generalnego o wyrażeniu zgody na zarządzenie stosowania czynności przez Szefa ABW;

3) zarządzenie Szefa ABW o stosowaniu czynności;

4) notatka służbowa z przeprowadzonych czynności, sporządzana przez funkcjonariusza Agencji Bezpieczeństwa Wewnętrznego prowadzącego sprawę, w ramach której zarządza się czynności;

5) informacja Szefa ABW o wynikach czynności, kierowana do Prokuratora Generalnego;

6) opis wyników badań, o których mowa w § 5 ust. 2;

6a) zarządzenie Szefa ABW o zniszczeniu materiałów uzyskanych podczas stosowania czynności;

7) protokół zniszczenia materiałów uzyskanych podczas stosowania czynności.
...
3. Notatka służbowa, o której mowa w ust. 1 pkt 4, zawiera w szczególności:
...
3) dane dotyczące podmiotów, wobec których dokonano czynności;

4) informacje o wynikach czynności;

5) dane osób odpowiedzialnych za przeprowadzenie czynności.
...
1. Przedmioty i korzyści majątkowe wręczane podczas czynności opisuje się lub oznacza w sposób umożliwiający ich identyfikację, dokumentując opis oraz oznaczenie w odrębnej notatce służbowej.

2. Przedmioty przejęte podczas czynności, włącznie z korzyściami majątkowymi, można w razie potrzeby poddać badaniom identyfikującym właściwości fizykochemiczne lub inne cechy, istotne z uwagi na cel czynności albo rodzaj przejętych przedmiotów, a także w celu ujawnienia i utrwalenia śladów znajdujących się na tych przedmiotach.

3. Do materiałów uzyskanych podczas stosowania czynności stosuje się przepisy o ochronie informacji niejawnych.

##### § 6.

1. Szef ABW i Prokurator Generalny prowadzą rejestry czynności.
...
1. Dokumentację dotyczącą prowadzonych czynności, w tym materiały zawierające dowody pozwalające na wszczęcie postępowania karnego lub mające znaczenie dla toczącego się postępowania karnego, Szef ABW przekazuje Prokuratorowi Generalnemu za pośrednictwem upoważnionego pisemnie funkcjonariusza Agencji Bezpieczeństwa Wewnętrznego.

2. W odniesieniu do materiałów uzyskanych podczas stosowania czynności, niezawierających dowodów pozwalających na wszczęcie postępowania karnego i niemających znaczenia dla toczącego się postępowania karnego, Szef ABW zarządza ich protokolarne, komisyjne zniszczenie.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2014/1748/text.pdf)
...
## Załącznik nr 4 - Zarządzenie zniszczenia materiałów (wzór)
...
## Załącznik nr 6 - Rejestr (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2014/1748/text.pdf)

## Załącznik nr 7 - Rejestr (wzór)

[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2014/1748/text.pdf)

## Załącznik nr 8 - Rejestr (wzór)
