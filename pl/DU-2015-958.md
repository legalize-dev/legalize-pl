...
identifier: "DU-2015-958"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2015-06-16"
last_updated: "2015-06-16"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2015/958"
department: "MIN. ZDROWIA"
eli: "DU/2015/958"
display_address: "Dz.U. 2015 poz. 958"
internal_address: "WDU20150000958"
publisher: "DU"
volume: "0"
position: "958"
...
has_pdf: "true"
keywords: "farmaceutyczne środki, leki i artykuły sanitarne, opłaty"
---
...
Traci moc rozporządzenie Ministra Zdrowia z dnia 20 listopada 2008 r. w sprawie sposobu ustalania i uiszczania opłat związanych z dopuszczeniem do obrotu produktu leczniczego .
...
|  | A | **Opłata za złożenie wniosku o:** |  |
|  | A | 1) wydanie pozwolenia na dopuszczenie do obrotu referencyjnego produktu leczniczego | 84 000 |
|  | A | 2) wydanie pozwolenia na dopuszczenie do obrotu produktu leczniczego, którego substancja(e) czynna(e) ma(ją) ugruntowane zastosowanie medyczne | 67 200 |
|  | A | 3) wydanie pozwolenia na dopuszczenie do obrotu odpowiednika referencyjnego gotowego produktu leczniczego | 27 300 |
|  | A | 4) wydanie pozwolenia na dopuszczenie do obrotu produktu leczniczego, o którym mowa w art. 15 ust. 7, art. 15 ust. 12 lub art. 16 ust. 5 ustawy | 43 680 |
|  | A | 5) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 2 pkt 1 i ust. 2b ustawy | 10 500 |
|  | A | 6) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 3 a ustawy: |  |
|  | A | a) w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 13 650 |
|  | A | b) w przypadku gdy Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 10 500 |
|  | A | 7) zmiany, o których mowa w art. 31 ustawy, z wyłączeniem wniosku dla produktów, o których mowa w art. 20a i art. 21 ustawy |  |
|  | A | a) zmianę niewielką typu IA - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 3500 |
|  | A | b) zmianę typu IB - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 5040 |
|  | A | c) zmianę typu II - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 20 160 |
|  | A | d) zmianę niewielką typu IA - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 2500 |
|  | A | e) zmianę typu IB - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 4200 |
|  | A | f) zmianę typu II - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 16 800 |
|  | A | g) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy jest organem referencyjnym | 3500 |
|  | A | h) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy jest organem referencyjnym | 5460 |
|  | A | i) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy jest organem referencyjnym | 21 840 |
|  | A | j) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 2500 |
|  | A | k) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 4200 |
|  | A | 1) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 16 800 |
...
|  | B | **Opłata za złożenie wniosku o:** |  |
|  | B | 1) wydanie pozwolenia na dopuszczenie do obrotu produktu leczniczego | 27 300 |
|  | B | 2) przedłużenie terminu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 2 pkt 1 i ust. 2b ustawy | 10 500 |
|  | B | 3) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 3a ustawy: |  |
|  | B | a) w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 13 650 |
|  | B | b) w przypadku gdy Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 10 500 |
|  | B | 4) zmiany, o których mowa w art. 31 ustawy |  |
|  | B | a) zmianę niewielką typu IA - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 3500 |
|  | B | b) zmianę typu IB - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 5040 |
|  | B | c) zmianę typu II - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 20 160 |
|  | B | d) zmianę niewielką typu IA - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 2500 |
|  | B | e) zmianę typu IB - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 4200 |
|  | B | f) zmianę typu II - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 16 800 |
|  | B | g) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy jest organem referencyjnym | 3500 |
|  | B | h) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy jest organem referencyjnym | 5460 |
|  | B | i) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy jest organem referencyjnym | 21 840 |
|  | B | j) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy produkt posiada pozwolenie krajowe lub polski organ właściwy nie jest organem referencyjnym | 2500 |
|  | B | k) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy produkt posiada pozwolenie krajowe lub polski organ właściwy nie jest organem referencyjnym | 4200 |
|  | B | l) w procedurze podziału pracy - zmianę typu II - w przypadku gdy produkt posiada pozwolenie krajowe lub polski organ właściwy nie jest organem referencyjnym | 16 800 |
|  | B | **2. Tradycyjne produkty lecznicze roślinne, o których mowa w art. 20a ustawy; produkty lecznicze roślinne inne niż te, o których mowa w art. 20a ustawy, dla których opracowano monografię wspólnotową** |  |
|  | B | **Opłata za złożenie wniosku o:** |  |
|  | B | 1) wydanie pozwolenia na dopuszczenie do obrotu produktu leczniczego roślinnego | 10 080 |
|  | B | 2) przedłużenie terminu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 2 pkt 1 i ust. 2b ustawy | 4200 |
|  | B | 3) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 3a ustawy: |  |
|  | B | a) w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 5460 |
|  | B | b) w przypadku gdy Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 4200 |
|  | B | 4) zmiany, o których mowa w art. 31 ustawy |  |
|  | B | a) zmianę niewielką typu IA - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 1312 |
|  | B | b) zmianę typu IB - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 1890 |
|  | B | c) zmianę typu II - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 5040 |
|  | B | d) zmianę niewielką typu IA - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 937 |
|  | B | e) zmianę typu IB - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 1575 |
|  | B | f) zmianę typu II - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 4200 |
|  | B | g) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy jest organem referencyjnym | 1312 |
|  | B | h) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy jest organem referencyjnym | 2047 |
|  | B | i) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy jest organem referencyjnym | 5460 |
|  | B | j) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 937 |
|  | B | k) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 1575 |
|  | B | l) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 4200 |
...
|  | **C** | 1) wydanie pozwolenia na dopuszczenie do obrotu produktu leczniczego homeopatycznego, wniosek o dopuszczenie do obrotu może obejmować listę produktów leczniczych homeopatycznych pochodzących z tej samej lub z tych samych substancji pierwotnych homeopatycznych: |  |
|  | **C** | a) mniej niż 50 produktów | 14 280 |
|  | **C** | b) od 50 do 100 produktów | 16 800 |
|  | **C** | c) więcej niż 100 produktów | 25 200 |
|  | **C** | 2) przedłużenie terminu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 2 pkt 1 i ust. 2b ustawy, jeżeli wniosek obejmuje listę zawierającą: |  |
|  | **C** | a) mniej niż 50 produktów | 3108 |
|  | **C** | b) od 50 do 100 produktów | 6132 |
|  | **C** | c) więcej niż 100 produktów | 9492 |
|  | **C** | 3) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 3a ustawy, w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego, jeżeli wniosek obejmuje listę zawierającą: |  |
|  | **C** | a) mniej niż 50 produktów | 4040 |
|  | **C** | b) od 50 do 100 produktów | 7972 |
|  | **C** | c) więcej niż 100 produktów | 12 340 |
|  | **C** | 4) przedłużenie okresu ważności pozwolenia na dopuszczenie do obrotu, o którym mowa w art. 29 ust. 3a ustawy, w przypadku gdy Rzeczpospolita Polska nie pełni roli państwa referencyjnego, jeżeli wniosek obejmuje listę zawierającą: |  |
|  | **C** | a) mniej niż 50 produktów | 3108 |
|  | **C** | b) od 50 do 100 produktów | 6132 |
|  | **C** | c) więcej niż 100 produktów | 9492 |
|  | **C** | 5) zmiany, o których mowa w art. 31 ustawy |  |
|  | **C** | a) zmianę niewielką typu IA - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 1750 |
|  | **C** | b) zmianę typu IB - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 2520 |
|  | **C** | c) zmianę typu II - w przypadku gdy Rzeczpospolita Polska pełni rolę państwa referencyjnego | 10 080 |
|  | **C** | d) zmianę niewielką typu IA - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 1250 |
|  | **C** | e) zmianę typu IB - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 2100 |
|  | **C** | f) zmianę typu II - w przypadku gdy produkt posiada pozwolenie krajowe lub Rzeczpospolita Polska nie pełni roli państwa referencyjnego | 8400 |
|  | **C** | g) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy jest organem referencyjnym | 1750 |
|  | **C** | h) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy jest organem referencyjnym | 2730 |
|  | **C** | i) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy jest organem referencyjnym | 10 920 |
|  | **C** | j) w procedurze podziału pracy - zmianę niewielką typu IA - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 1250 |
|  | **C** | k) w procedurze podziału pracy - zmianę typu IB - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 2100 |
|  | **C** | 1) w procedurze podziału pracy - zmianę typu II - w przypadku gdy polski organ właściwy nie jest organem referencyjnym | 8400 |
...
|  | D | **Opłata za złożenie wniosku o:** |  |
|  | D | 1) wydanie pozwolenia na dopuszczenie do obrotu | 4200 |
|  | D | 2) zmianę danych objętych pozwoleniem oraz zmiany dokumentacji będącej podstawą do wydania pozwolenia | 1050 |
|  | D | 3) przedłużenie terminu ważności pozwolenia na dopuszczenie do obrotu | 2100 |
|  | E | **Surowce farmaceutyczne przeznaczone do sporządzania leków recepturowych i aptecznych** |  |
|  | E | **Opłata za złożenie wniosku o:** |  |
|  | E | 1) wydanie pozwolenia na dopuszczenie do obrotu | 1680 |
|  | E | 2) zmianę danych objętych pozwoleniem oraz zmiany dokumentacji będącej podstawą do wydania pozwolenia | 1050 |
|  | E | 3) przedłużenie terminu ważności pozwolenia na dopuszczenie do obrotu | 1050 |
|  | F | Opłata za złożenie wniosku o wydanie pozwolenia, o którym mowa w art. 21a ustawy |  |
|  | F | Opłata za złożenie wniosku o: |  |
|  | F | 1) wydanie pozwolenia | 6132 |
|  | F | 2) zmianę pozwolenia | 1594 |
|  | F | 3) przedłużenie terminu ważności pozwolenia | 5250 |
