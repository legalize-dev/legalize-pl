---
title: "Rozporządzenie Ministra Zdrowia z dnia 5 stycznia 2012 r. w sprawie sposobu kierowania i kwalifikowania pacjentów do zakładów lecznictwa uzdrowiskowego"
identifier: "DU-2012-14"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2012-01-05"
last_updated: "2012-01-05"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2012/14"
department: "MIN. ZDROWIA"
eli: "DU/2012/14"
display_address: "Dz.U. 2012 poz. 14"
internal_address: "WDU20120000014"
publisher: "DU"
volume: "0"
position: "14"
status_pl: "obowiązujący"
promulgation_date: "2012-01-05"
entry_into_force: "2012-01-08"
valid_from: "2012-01-08"
references_count: "4"
...
Na podstawie art. 19 ust. 3 ustawy z dnia 28 lipca 2005 r. o lecznictwie uzdrowiskowym, uzdrowiskach i obszarach ochrony uzdrowiskowej oraz o gminach uzdrowiskowych zarządza się, co następuje:
...
## Załącznik nr 1 - Szczegółowe wskazania i przeciwwskazania do leczenia uzdrowiskowego w poszczególnych rodzajach zakładów lecznictwa uzdrowiskowego
...
1) I64 - stany po udarach mózgowych z utrwalonymi niedowładami, z afazją sensoryczna lub motoryczną lub zespołem psychoorganicznym oraz z całkowitą niepełnosprawnością;
...
b) I21, I24 - stany po przebytym zawale serca bez powikłań, w okresie do 6 miesięcy od przebycia zawaha serca; w stanach po upływie 40 dni od przebycia zawaha serca i utrzymującym się upośledzeniu frakcji wyrzutowej lewej komory (LVEF) < 35%, z zabezpieczeniem kardiowerterem-defibrylatorem (ICD),
...
1) I11 - nadciśnienie tętnicze III stopnia nieunormowane farmakologicznie z chwiejnym przebiegiem oraz z co najmniej dwoma czynnikami ryzyka powikłań sercowonaczyniowych;
...
b) J44 - przewlekła obturacyjną choroba płuc w II albo III stopniu zaawansowania (FEV1 ≥ 30%),
...
e) J44 - przewlekła obturacyjną choroba płuc w I albo II stopniu zaawansowania (FEV1 ≥ 50%),

f) J45 - dychawica oskrzelowa;

3) przychodnia uzdrowiskowa:

a) J41 - przewlekła obturacyjną choroba płuc w I stopniu zaawansowania,
...
3) I27 - pełnoobjawowa niewydolność oddechowa lub oddechowo-krążeniową;
...
c) E10, El1 - cukrzyca typu 1 albo typu 2 w okresie dekompensacji znacznego stopnia,

d) E10, E11, I25, I68, I73 - cukrzyca typu 1 albo typu 2 z zaawansowaną makroangiopatią,

e) E10, E11, N08, G63, H36 - cukrzyca typu 1 albo typu 2 z zaawansowaną mikroangiopatią (nefropatią lub neuropatia, lub retinopatią),
...
c) El0, El1, I25, I68, I73 - cukrzyca typu 1 albo typu 2 z makroangiopatią (z wyłączeniem przypadków o znacznym zaawansowaniu powikłań),

d) E10, E11, N08, G63, H36 - cukrzyca typu 1 albo typu 2 z mikroangiopatią: nefropatią, neuropatia, retinopatią (z wyłączeniem przypadków o znacznym zaawansowaniu powikłań),
...
b) E10, E11, N08, G63, H36 - wyrównana cukrzyca typu 1 albo typu 2 z mikroangiopatią, nefropatią, neuropatia, retinopatią (z wyłączeniem przypadków o znacznym zaawansowaniu powikłań),
...
7) E10, E, Z74 - pełna niezdolność do samoobsługi z powodu powikłań cukrzycy lub chorób towarzyszących.
...
j) T33 - powierzchowne odmrożenie,
...
h) D29 - gruczolak sterczą, początkowe stadium (bez zalegania moczu w pęcherzu),
...
g) D29 - gruczolak sterczą, początkowe stadium (bez zalegania moczu w pęcherzu),
...
8) D70 - agranulocytoza (neutropenia) poniżej 1,5 G/l (1500/μl);

9) D72.8 - limfopenia poniżej 1,0 G/l (1000/μl);
...
## Załącznik nr 2 - Szczegółowe wskazania i przeciwwskazania do rehabilitacji uzdrowiskowej w poszczególnych rodzajach zakładów lecznictwa uzdrowiskowego
...
1) I64 - stany po udarach mózgowych z utrwalonymi niedowładami, z afazją sensoryczna lub motoryczną, zespołem psychoorganicznym oraz z pełną niepełnosprawnością;
...
5) I64 - stany po udarach mózgowych z utrwalonymi niedowładami, z afazją sensoryczna lub motoryczną, zespołem psychoorganicznym oraz z pełną niepełnosprawnością;
...
14) I50 - niewydolność serca w klasie niewydolności serca III alboIV według NYHA;
