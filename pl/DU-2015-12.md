...
identifier: "DU-2015-12"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2014-12-12"
last_updated: "2014-12-12"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2015/12"
department: "MIN. ADMINISTRACJI I CYFRYZACJI"
eli: "DU/2015/12"
display_address: "Dz.U. 2015 poz. 12"
internal_address: "WDU20150000012"
publisher: "DU"
volume: "0"
position: "12"
...
Na podstawie art. 126 ust. 13 ustawy z dnia 16 lipca 2004 r. - Prawo telekomunikacyjne zarządza się, co następuje:
...
a) numer rutingowy (NR NP) zamieszcza się w parametrze Called Party Number^1)^ wiadomości IAM (Initial Address Message)^2)^ przed numerem abonenta B (tryb połączony „concatenated”),
...
2) następujący format numeru rutingowego (NR NP):
...
ZT^6)^ = numer HOST (HOST - ID)^7)^ w danej SN (dla danego AB),
...
a) połączenia do trzycyfrowych numerów AUS oraz numeru alarmowego 112 mogą być realizowane po odebraniu numeru tylko w formatach:
...
WSNd (Wskaźnik Strefy Numeracyjnej docelowej) - oznacza strefę numeracyjną, w jakiej znajduje się jednostka, do której kierowane jest wywołanie alarmowe,

IDL (Identyfikator Docelowej Lokalizacji) - wskazuje jednostkę, do której kierowane jest wywołanie alarmowe, występującą w danej lokalizacji w danej strefie numeracyjnej,

XYZ - oznacza wybrany trzycyfrowy numer AUS i numer alarmowy 112.
...
^7)^ HOST (HOST - ID) - numer centrali telefonicznej lub innego węzła sieci telekomunikacyjnej, obsługujących nową lokalizację abonenta z przeniesionym numerem.
