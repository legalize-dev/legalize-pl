---
title: "Druga poprawka do Konwencji o ocenach oddziaływania na środowisko w kontekście transgranicznym, sporządzonej w Espoo dnia 25 lutego 1991 r., przyjęta w Cavtat dnia 4 czerwca 2004 r"
identifier: "DU-2018-171"
country: "pl"
rank: "umowa_miedzynarodowa"
publication_date: "2011-12-13"
last_updated: "2011-12-13"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2018/171"
eli: "DU/2018/171"
display_address: "Dz.U. 2018 poz. 171"
internal_address: "WDU20180000171"
publisher: "DU"
volume: "0"
position: "171"
...
3. Przyjmuje następujące poprawki do Konwencji:

a) w artykule 2 po ustępie 10 dodaje się nowy ustęp w brzmieniu:
...
b) w artykule 8 po wyrazie „konwencji” dodaje się wyrazy:

> oraz z wszelkich jej protokołów, których są Stronami,

c) w artykule 11 ustęp 2 nadaje się nowe brzmienie literze (c):
...
d) na końcu artykułu 11 dodaje się dwie nowe litery w brzmieniu:

> (g) będą przygotowywać, w stosownych przypadkach, protokoły do niniejszej konwencji; (h) ustanowią takie organy pomocnicze, jakie uznają za konieczne do wdrożenia niniejszej konwencji.

e) w artykule 14 ustęp 4 drugie zdanie zastępuje się nowym zdaniem w brzmieniu:
...
f) po artykule 14 dodaje się nowy artykuł w brzmieniu:

> Artykuł 14 bis **Przegląd zgodności** 1. Strony dokonują przeglądu zgodności z postanowieniami niniejszej konwencji na podstawie procedury zgodności w ramach przyjętej przez spotkanie Stron procedury niespornej i opartej na pomocy. Przegląd opiera się na regularnym składaniu sprawozdań przez Strony, ale nie jest do niego ograniczony. Decyzje o wymaganej przez Strony częstotliwości regularnego składania sprawozdań oraz o informacjach, jakie należy uwzględnić w tych sprawozdaniach, podejmuje spotkanie Stron. 2. Procedurę zgodności można stosować do każdego protokołu przyjętego w ramach niniejszej konwencji.

g) Załącznik I do Konwencji zastępuje się Załącznikiem do niniejszej Decyzji;

h) w Załączniku VI po ustępie 2 dodaje się nowy ustęp w brzmieniu:
...
20. Instalacje do intensywnej hodowli drobiu lub świń o pojemności większej niż: - 85 000 stanowisk dla brojlerów;
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2018/1710/text.pdf)
