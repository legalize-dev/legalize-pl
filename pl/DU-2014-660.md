---
title: "Rozporządzenie Ministra Sprawiedliwości z dnia 5 maja 2014 r. w sprawie udzielania informacji o osobach oraz o podmiotach zbiorowych na podstawie danych zgromadzonych w Krajowym Rejestrze Karnym"
identifier: "DU-2014-660"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2014-05-05"
last_updated: "2014-05-05"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2014/660"
department: "MIN. SPRAWIEDLIWOŚCI"
eli: "DU/2014/660"
display_address: "Dz.U. 2014 poz. 660"
internal_address: "WDU20140000660"
publisher: "DU"
volume: "0"
position: "660"
...
1. Po wpłynięciu zapytania lub wniosku zawarte w nich dane porównuje się z danymi zgromadzonymi w kartotekach i bazie danych systemu teleinformatycznego Rejestru. Po ustaleniu zgodności tych danych sporządza się informację o osobie lub informację o podmiocie zbiorowym.

2. W przypadku stwierdzenia rozbieżności między danymi osobowymi zgromadzonymi w Rejestrze a danymi osobowymi zawartymi w zapytaniu lub wniosku albo stwierdzenia rozbieżności między danymi o podmiocie zbiorowym zgromadzonymi w Rejestrze a danymi zawartymi w zapytaniu lub wniosku, jeżeli nie budzą one wątpliwości co do tożsamości osoby lub oznaczenia podmiotu, informacja o osobie lub informacja o podmiocie zbiorowym zawiera wykaz tych rozbieżności.

##### § 10.

Informacja z Rejestru przed przekazaniem podmiotowi kierującemu zapytanie lub wniosek podlega kontroli pod względem kompletności. Kontrolę przeprowadza osoba upoważniona przez dyrektora biura informacyjnego.

##### § 11.

Określa się:

1) wzór formularza zapytania o udzielenie informacji o osobie, określony w załączniku nr 1 do rozporządzenia;

2) wzór formularza zapytania o udzielenie informacji o podmiocie zbiorowym, określony w załączniku nr 2 do rozporządzenia;

3) wzór formularza informacji o osobie z Krajowego Rejestru Karnego, określony w załączniku nr 3 do rozporządzenia;

4) wzór formularza informacji o podmiocie zbiorowym z Krajowego Rejestru Karnego, określony w załączniku nr 4 do rozporządzenia.
...
4. Jeżeli dane o podmiocie zbiorowym, którego dotyczy zapytanie lub wniosek, nie są zgromadzone w Rejestrze, informacji o podmiocie zbiorowym udziela się poprzez zwrócenie zapytania lub wniosku opatrzonego adnotacją „NIE FIGURUJE W KARTOTECE PODMIOTÓW ZBIOROWYCH”.
