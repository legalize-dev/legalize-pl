...
identifier: "DU-2014-415"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2014-02-05"
last_updated: "2014-02-05"
status: "expired"
source: "https://api.sejm.gov.pl/eli/acts/DU/2014/415"
department: "PREZ. RADY MINISTRÓW"
eli: "DU/2014/415"
display_address: "Dz.U. 2014 poz. 415"
internal_address: "WDU20140000415"
publisher: "DU"
volume: "0"
position: "415"
...
has_pdf: "true"
keywords: "formularze, sprawozdawczość"
---
...
1. Określa się wzory formularzy sprawozdawczych i ankiet statystycznych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2014 prowadzonych przez Prezesa Głównego Urzędu Statystycznego:
...
16) C-0lb - sprawozdanie o cenach producentów robót budowlano-montażowych;
...
35) DS-01 - sprawozdanie z przyjętych zamówień na towary o znaczeniu strategicznym i zrealizowanych dostaw;

36) DS-01a - załącznik do sprawozdania DS-01;

37) DS-0lb - zestawienie z zawartych umów i zrealizowanych transakcji w handlu zagranicznym towarami o znaczeniu strategicznym;
...
57) H-Ola - sprawozdanie o działalności sklepów, aptek i stacji paliw;

58) H-01g - sprawozdanie o sieci placówek gastronomicznych;

59) H-0l/k - kwartalne badanie przychodów w przedsiębiorstwach handlowych;

60) H-0ls - sprawozdanie o sprzedaży detalicznej i hurtowej;

61) H-0lw- sprawozdanie o sieci handlowej;
...
65) IF- instrumenty finansowe przedsiębiorstw nie finansowych;
...
86) ŁT-lkkp - sprawozdanie o abonentach ruchomej publicznej sieci telekomunikacyjnej i o telefonii stacjonarnej;
...
139) S-l1 - sprawozdanie o pomocy materialnej i socjalnej dla studentów i doktorantów;
...
156) T-ll/k - sprawozdanie o taborze i przewozach w żegludze śródlądowej;
...
180) Z.I.MRiRW - dopłaty dla rolników z tytułu Jednolitej Płatności Obszarowej, Uzupełniającej Płatności Obszarowej, Przejściowej Płatności Uzupełniającej.
...
7) PLC-C - badanie obrotu towarów i usług w ruchu granicznym;

8) PLC-P - badanie obrotu towarów i usług w ruchu granicznym;
...
11) ZD-A - praca nierejestrowana ankieta modułowa BAEL;
...
1. Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2014, prowadzonych przez ministra właściwego do spraw administracji publicznej:
...
15) G-l0.m - miesięczne dane o energii elektrycznej;

16) G-l0.1k - sprawozdanie o działalności elektrowni cieplnej zawodowej;
...
28) G-lle - sprawozdanie o cenach energii elektrycznej według kategorii standardowych odbiorców końcowych;

29) G-l1g - sprawozdanie o cenach gazu ziemnego według kategorii standardowych odbiorców końcowych;
...
28) MS-S 11/12 - sprawozdanie z zakresu prawa pracy i ubezpieczeń społecznych;

29) MS-S 11/12 - sprawozdanie z zakresu prawa pracy i ubezpieczeń społecznych;
...
16. Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2014, prowadzonych przez ministra właściwego do spraw turystyki:
...
1. Określa się wzory zestawień tabelarycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2014, przekazywanych Prezesowi Głównego Urzędu Statystycznego:
...
2. Wzory zestawień tabelarycznych, o których mowa w ust. 1, są określone w załączniku nr 4 do rozporządzenia. § 4. Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia.
