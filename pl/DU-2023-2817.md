---
title: "Rozporządzenie Ministra Finansów z dnia 22 grudnia 2023 r. w sprawie ewidencji, dokumentacji i protokołów dotyczących wyrobów akcyzowych i znaków akcyzy"
identifier: "DU-2023-2817"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2023-12-22"
last_updated: "2023-12-22"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2023/2817"
department: "MIN. FINANSÓW"
eli: "DU/2023/2817"
display_address: "Dz.U. 2023 poz. 2817"
internal_address: "WDU20230002817"
publisher: "DU"
volume: "0"
position: "2817"
...
c) datę wprowadzenia wyrobów akcyzowych do składu podatkowego, a w przypadku importowanych wyrobów akcyzowych wprowadzonych do składu podatkowego w celu dopuszczenia ich do obrotu w rozumieniu przepisów prawa celnego i objęcia procedurą zawieszenia poboru akcyzy w miejscu importu znajdującym się w składzie podatkowym - datę dopuszczenia ich do obrotu,

d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, właściciela wyrobów akcyzowych innego niż podmiot prowadzący skład podatkowy,
...
f) numer zgłoszenia celnego, na podstawie którego importowane wyroby akcyzowe zostały dopuszczone do obrotu w rozumieniu przepisów prawa celnego w miejscu importu znajdującym się w składzie podatkowym,
...
d) kwotę akcyzy, której pobór został zawieszony.

##### § 11.

Ewidencja, o której mowa w art. 138a ust. 1 ustawy, dotycząca wyrobów akcyzowych, od których została zapłacona akcyza, innych niż wyroby energetyczne magazynowane w jednym zbiorniku z wyrobami o innych statusach, zawiera dane dotyczące wyrobów akcyzowych:
...
c) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, od którego wyroby akcyzowe zostały dostarczone,
...
g) kwotę akcyzy zapłaconą od wyrobów akcyzowych,

h) kwotę akcyzy od wyprodukowanych wyrobów akcyzowych, której pobór został zawieszony.
...
c) numer identyfikacyjny dokumentu, na podstawie którego wyroby akcyzowe zostały przemieszczone i wprowadzone do składu podatkowego,

d) datę wprowadzenia wyrobów akcyzowych do składu podatkowego;
...
Ewidencja, o której mowa w art. 138a ust. 1 ustawy, dotycząca wyrobów akcyzowych, w przypadku których wyprowadzenie ze składu podatkowego powoduje zakończenie procedury zawieszenia poboru akcyzy i obowiązek zapłaty akcyzy, zawiera dane dotyczące wyrobów akcyzowych:
...
d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) właściciela wyrobów akcyzowych posiadającego zezwolenie wyprowadzenia;
...
Ewidencja, o której mowa w art. 138a ust. 1 ustawy, dotycząca wyrobów akcyzowych objętych zerową stawką akcyzy ze względu na ich przeznaczenie, o których mowa w art. 89 ust. 2 ustawy, znajdujących się poza procedurą zawieszenia poboru akcyzy, innych niż wyroby energetyczne magazynowane w jednym zbiorniku z wyrobami o innych statusach, zawiera dane dotyczące wyrobów akcyzowych:
...
e) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, do którego wyroby akcyzowe są dostarczane,

f) numer identyfikacyjny dokumentu, na podstawie którego wyroby akcyzowe zostały wyprowadzone ze składu podatkowego i są przemieszczane;
...
c) datę wystawienia i numer faktury lub rachunku,

d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) podmiotu, od którego susz tytoniowy został nabyty na terytorium kraju;
...
d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, od którego susz tytoniowy został nabyty wewnątrzwspólnotowo;
...
c) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, od którego susz tytoniowy został importowany;
...
b) datę sprzedaży suszu tytoniowego,

c) datę wystawienia i numer faktury lub rachunku,

d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, któremu susz tytoniowy został sprzedany;
...
c) numer faktury lub rachunku,

d) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacyjny używany w państwie zamieszkania albo siedziby, podmiotu, do którego susz tytoniowy został dostarczony wewnątrzwspólnotowo,

e) imię i nazwisko albo nazwę oraz adres miejsca zamieszkania albo siedziby przewoźnika lub spedytora,
...
e) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacyjny używany w państwie zamieszkania albo siedziby, podmiotu, do którego susz tytoniowy został wyeksportowany,

f) imię i nazwisko albo nazwę oraz adres miejsca zamieszkania albo siedziby przewoźnika lub spedytora,
...
c) sposób przetworzenia suszu tytoniowego,

d) datę przetworzenia suszu tytoniowego;

8) zużytego, obejmujące:

a) kody Nomenklatury Scalonej (CN) i ilości w kilogramach zużytego suszu tytoniowego,

b) sposób zużycia suszu tytoniowego,

c) datę zużycia suszu tytoniowego,

d) kwotę akcyzy od zużytego suszu tytoniowego;

9) zniszczonego, obejmujące:

a) kody Nomenklatury Scalonej (CN) i ilości w kilogramach zniszczonego suszu tytoniowego,

b) datę zniszczenia suszu tytoniowego.

##### § 18.

Ewidencja, o której mowa w art. 138a ust. 1 ustawy, dotycząca wyrobów akcyzowych wymienionych w art. 103 ust. 5aa ustawy z dnia 11 marca 2004 r. o podatku od towarów i usług , nabywanych wewnątrzwspólnotowo na rzecz innego podmiotu, zawiera:
...
4) określenie rodzaju, kodu Nomenklatury Scalonej (CN) i ilości nabytych wyrobów akcyzowych wymienionych w art. 103 ust. 5aa ustawy z dnia 11 marca 2004 r. o podatku od towarów i usług.

### Rozdział 4. Szczegółowy zakres danych, które powinny znajdować się w ewidencji wyrobów akcyzowych wysyłanych w procedurze zawieszenia poboru akcyzy
...
3) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, importera;
...
7) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, do którego wyroby akcyzowe zostały wysłane w procedurze zawieszenia poboru akcyzy;

8) numer identyfikacyjny dokumentu, na podstawie którego wyroby akcyzowe zostały wysłane i są przemieszczane;

9) kwotę akcyzy, której pobór został zawieszony.
...
4) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, który wysłał wyroby akcyzowe w procedurze zawieszenia poboru akcyzy;
...
### Rozdział 6. Szczegółowy zakres danych, które powinny znajdować się w ewidencji wyrobów akcyzowych dostarczanych na terytorium kraju przez wysyłający podmiot zagraniczny za pośrednictwem przedstawiciela podatkowego
...
3) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny używany w państwie zamieszkania albo siedziby wysyłającego podmiotu zagranicznego;

4) imię i nazwisko oraz adres miejsca zamieszkania osoby fizycznej będącej odbiorcą wyrobów akcyzowych na terytorium kraju;

5) numer identyfikacyjny dokumentu, na podstawie którego wyroby akcyzowe zostały przemieszczone na terytorium kraju;

6) kwotę akcyzy przypadającą do zapłaty;

7) datę odebrania wyrobów akcyzowych przez odbiorcę na terytorium kraju.
...
b) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, który wysłał wyroby akcyzowe z terytorium państwa członkowskiego,

c) ilość w jednostkach miary właściwych dla ustalenia podstawy opodatkowania i nazwę wyrobów akcyzowych wraz z ich kodem Nomenklatury Scalonej (CN),

d) datę odbioru wyrobów akcyzowych w składzie podatkowym;

2) w przypadku dostawy wewnątrzwspólnotowej albo eksportu wyrobów akcyzowych i przemieszczania ich na terytorium kraju w procedurze zawieszenia poboru akcyzy przez podmiot prowadzący skład podatkowy lub zarejestrowanego wysyłającego dane obejmujące:

a) numer dokumentu handlowego lub innego dokumentu potwierdzającego odbiór wyrobów akcyzowych na terytorium państwa członkowskiego albo dokonanie eksportu,

b) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP) albo inny numer identyfikacyjny, używany w państwie zamieszkania albo siedziby, podmiotu, do którego zostały wysłane wyroby akcyzowe,

c) ilość w jednostkach miary właściwych dla ustalenia podstawy opodatkowania i nazwę wyrobów akcyzowych wraz z ich kodem Nomenklatury Scalonej (CN),

d) datę zakończenia procedury zawieszenia poboru akcyzy zgodnie z art. 42 ust. 1 pkt 7 lub 8 ustawy.

### Rozdział 8. Szczegółowy zakres danych, które powinny znajdować się w ewidencji wyrobów akcyzowych zwolnionych od akcyzy ze względu na ich przeznaczenie
...
3. Ewidencja, o której mowa w art. 138f ustawy, dotycząca wyrobów akcyzowych zwolnionych od akcyzy ze względu na ich przeznaczenie, zużytych na cele uprawniające do zwolnienia od akcyzy, zawiera dane obejmujące:
...
4. Ewidencja, o której mowa w art. 138f ustawy, dotycząca magazynowanych wyrobów akcyzowych zwolnionych od akcyzy ze względu na ich przeznaczenie zawiera dane obejmujące:
...
5. Ewidencja, o której mowa w art. 138f ustawy, dotycząca wyrobów akcyzowych zwolnionych od akcyzy ze względu na ich przeznaczenie, magazynowanych w jednym zbiorniku z wyrobami akcyzowymi, które nie są zwolnione od akcyzy, zawiera dane obejmujące:

1) oznaczenie numeru zbiornika;

2) nazwy wyrobów akcyzowych zwolnionych od akcyzy wraz z ich kodami Nomenklatury Scalonej (CN);

3) nazwy wyrobów akcyzowych, które nie są zwolnione od akcyzy, wraz z ich kodami Nomenklatury Scalonej (CN) oraz wskazaniem, jaki posiadają status;
...
6) datę wyprowadzenia wyrobów akcyzowych, o których mowa w pkt 2 i 3, ze zbiornika.

6. W przypadku podmiotu zużywającego, o którym mowa w art. 2 ust. 1 pkt 22 lit. b ustawy, korzystającego ze zwolnień od akcyzy ze względu na przeznaczenie, o których mowa w art. 32 ust. 1 pkt 1 i 2 ustawy, nie stosuje się ust. 1-3. Ewidencję wyrobów akcyzowych objętych zwolnieniem od akcyzy ze względu na ich przeznaczenie prowadzoną przez ten podmiot stanowi zbiór wydruków dokumentów, na podstawie których wyroby akcyzowe zwolnione od akcyzy zostały dostarczone temu podmiotowi.

### Rozdział 9. Szczegółowy zakres danych, które powinny znajdować się w pozostałych ewidencjach

##### § 25.

1. Ewidencja, o której mowa w art. 138g ustawy, zawiera odpowiednio dane określone w § 17.
...
c) liczbę banderol podatkowych wydanych oraz liczbę banderol podatkowych wydanych w ramach dopuszczalnej normy strat;
...
d) liczbę przekazanych banderol podatkowych;
...
a) datę określenia stanu banderol podatkowych,

b) liczbę banderol podatkowych.

##### § 27.

Ewidencja, o której mowa w art. 138l ust. 1 pkt 2 ustawy, zawiera dane obejmujące:

1) nazwę i adres miejsca zamieszkania albo siedziby właściciela wyrobów akcyzowych, o którym mowa w art. 13 ust. 3 ustawy, lub podmiotu, o którym mowa w art. 116 ust. 1 pkt 7 ustawy;
...
### Rozdział 10. Rodzaje dokumentacji, o których mowa w art. 138d ust. 1 ustawy, oraz szczegółowy zakres danych, które powinny znajdować się w tych dokumentacjach
...
Dokumentacja kontroli, o której mowa w § 28 pkt 1, zawiera dane obejmujące:

1) datę wykonania czynności podlegającej wpisaniu;

2) numer identyfikacyjny dokumentu, na podstawie którego alkohol etylowy został przemieszczony;
...
Dokumentacja kontroli, o której mowa w § 28 pkt 2, zawiera dane obejmujące:
...
Dokumentacja kontroli, o której mowa w § 28 pkt 3, zawiera dane obejmujące:
...
Dokumentacja kontroli, o której mowa w § 28 pkt 4, zawiera dane obejmujące:

1) datę wykonania czynności podlegającej wpisaniu;

2) numer i symbol dokumentu, na podstawie którego pobrano alkohol etylowy do produkcji napojów spirytusowych;

3) ilość alkoholu etylowego pobraną do produkcji napojów spirytusowych wyrażoną w dm^3^ 100% vol., w tym:

a) odrębnie dla poszczególnych rodzajów alkoholu etylowego z podaniem ich nazwy,

b) razem alkoholu etylowego pobraną do produkcji napojów spirytusowych;

4) zawartą w półproduktach ilość alkoholu etylowego pobraną do produkcji napojów spirytusowych wyrażoną w dm^3^100% vol., w tym:

a) odrębnie dla poszczególnych rodzajów półproduktów z podaniem ich nazwy,

b) razem alkoholu etylowego zawartą w półproduktach pobraną do produkcji napojów spirytusowych;
...
8) numer i symbol dokumentu, na podstawie którego zużyto alkohol etylowy do produkcji napojów spirytusowych;

9) ilość alkoholu etylowego zużytą do produkcji napojów spirytusowych wyrażoną w dm^3^ 100% vol., w tym:

a) odrębnie dla poszczególnych rodzajów alkoholu etylowego z podaniem ich nazwy,

b) razem alkoholu etylowego zużytą do produkcji napojów spirytusowych;

10) zawartą w półproduktach ilość alkoholu etylowego zużytą do produkcji napojów spirytusowych wyrażoną w dm^3^100% vol., w tym:

a) odrębnie dla poszczególnych rodzajów półproduktów z podaniem ich nazwy,

b) razem alkoholu etylowego zawartą w półproduktach zużytą do produkcji napojów spirytusowych;

11) numer i symbol dokumentu, na podstawie którego sporządzono zestaw, półprodukt oraz rozlano napoje spirytusowe;

12) ilość alkoholu etylowego zawartą w sporządzonych zestawach napojów spirytusowych, półproduktach oraz rozlanych i przekazanych do magazynu napojach spirytusowych wyrażoną w dm^3^ 100% vol., w tym:
...
13) ilość alkoholu etylowego wyrażoną w dm^3^ 100% vol., zawartą w sporządzonych zestawach napojów spirytusowych lub półproduktach, które zostały wyprowadzone luzem z działu produkcji;
...
1. Dokumentacja kontroli, o której mowa w § 28 pkt 5, zawiera dane obejmujące:
...
2. W przypadku gorzelni, o której mowa w art. 93 ust. 5 ustawy, dokumentacja, o której mowa w ust. 1, dodatkowo zawiera dane obejmujące:

1) dane identyfikujące producenta owoców, który dostarcza owoce w celu ich przerobu na alkohol etylowy:

a) imię i nazwisko,

b) miejsce zamieszkania oraz numer PESEL, o ile zostały podane w umowie zawartej zgodnie z art. 93 ust. 7 ustawy;

2) datę zawarcia umowy, o której mowa w art. 93 ust. 7 ustawy;

3) rodzaj owoców dostarczonych do gorzelni przez producenta owoców, o którym mowa w pkt 1, w celu ich przerobu na alkohol etylowy i ich ilość wyrażoną w kilogramach;

4) rodzaj owoców zużytych do produkcji alkoholu etylowego i ich ilość wyrażoną w kilogramach;

5) ilość alkoholu etylowego wyprodukowanego dla producenta owoców, o którym mowa w pkt 1, wyrażoną w dm^3^100% vol. oraz datę jego wydania temu producentowi.

##### § 34.

Dokumentacja kontroli, o której mowa w § 28 pkt 6, zawiera dane obejmujące:
...
Dokumentacjami, o których mowa w art. 138o ustawy, w zakresie produkcji wina, napojów fermentowanych i wyrobów pośrednich, zwanych w niniejszym rozdziale łącznie „wyrobami winiarskimi”, są:
...
Dokumentacja, o której mowa w § 39 pkt 1, zawiera dane obejmujące:
...
Dokumentacja, o której mowa w § 39 pkt 2, zawiera dane obejmujące:
...
5) zawartość alkoholu etylowego i ekstraktu całkowitego;
...
Dokumentacja, o której mowa w § 39 pkt 3, zawiera dane obejmujące:
...
2) imię i nazwisko albo nazwę, adres miejsca zamieszkania albo siedziby oraz numer identyfikacji podatkowej (NIP), podatnika lub podmiotu, w którego posiadaniu znajdowały się wyroby akcyzowe przed zniszczeniem;

3) datę i miejsce zniszczenia wyrobów akcyzowych;

4) kody Nomenklatury Scalonej (CN) i ilości zniszczonych wyrobów akcyzowych w jednostkach miary właściwych dla ustalenia podstawy opodatkowania;
...
1. W protokole wydania lub zwrotu banderol, o którym mowa w art. 138m ust. 1 pkt 2 ustawy, przedstawia się dane o wydaniu lub zwrocie banderol pomiędzy:
...
2. Protokół wydania lub zwrotu banderol, o którym mowa w art. 138m ust. 1 pkt 2 ustawy, zawiera dane obejmujące:
...
4) rok wytworzenia i serię wydanych lub zwróconych banderol;
...
3. Wzór protokołu wydania lub zwrotu banderol, o którym mowa w art. 138m ust. 1 pkt 2 ustawy, określa załącznik nr 2 do rozporządzenia.
...
2) nazwę i adres miejsca zamieszkania albo siedziby podmiotu;
...
6) ustalenie różnicy pomiędzy pomiarem ilości alkoholu etylowego w magazynie gorzelni a ilością wydaną w naczyniach transportowych;
...
Ewidencje, o których mowa w art. 138a ust. 1, art. 138b, art. 138c i art. 138e-138l ustawy, i dokumentacje, o których mowa w art. 138d i art. 138o ustawy, prowadzone zgodnie z przepisami dotychczasowymi, w których zakres danych obejmuje dane określone w niniejszym rozporządzeniu, mogą być prowadzone nadal.

##### § 49.

1. Ewidencje, o których mowa w art. 138a ust. 1, art. 138b, art. 138c i art. 138e-138l ustawy, i dokumentacje, o których mowa w art. 138d i art. 138o ustawy, prowadzone zgodnie z przepisami dotychczasowymi, w których zakres danych nie obejmuje danych określonych w niniejszym rozporządzeniu, mogą być prowadzone nadal, jednak nie dłużej niż do dnia 30 czerwca 2024 r.

2. W przypadku zakończenia prowadzenia ewidencji lub dokumentacji, o której mowa w ust. 1, w postaci papierowej, podmiot prowadzący ewidencję lub dokumentację dokonuje jej zamknięcia i podsumowania na dzień zakończenia prowadzenia tej ewidencji lub dokumentacji, nie później jednak niż następnego dnia roboczego.

3. W przypadku, o którym mowa w ust. 2, stan ewidencyjny ustalony w wyniku zamknięcia i podsumowania ewidencji lub dokumentacji, o której mowa w ust. 1, przenosi się jako stan początkowy odpowiednio do ewidencji lub dokumentacji prowadzonych zgodnie z niniejszym rozporządzeniem.

##### § 50.

Do dnia 31 grudnia 2024 r. protokoły, o których mowa w art. 138m ust. 1 pkt 2-4 ustawy, mogą być sporządzane zgodnie z przepisami dotychczasowymi.
...
[patrz oryginał](https://api.sejm.gov.pl/eli/acts/DU/2023/2817/text.pdf)

## Załącznik nr 2 - Protokół wydania/zwrotu banderol (wzór)
