---
title: "Rozporządzenie Ministra Kultury i Dziedzictwa Narodowego z dnia 19 kwietnia 2022 r. zmieniające rozporządzenie w sprawie podstaw programowych kształcenia w zawodach szkolnictwa artystycznego"
identifier: "DU-2022-1329"
country: "pl"
rank: "rozporzadzenie"
publication_date: "2022-04-19"
last_updated: "2022-04-19"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2022/1329"
department: "MIN. KULTURY I DZIEDZICTWA NARODOWEGO"
eli: "DU/2022/1329"
display_address: "Dz.U. 2022 poz. 1329"
internal_address: "WDU20220001329"
publisher: "DU"
volume: "0"
position: "1329"
...
W rozporządzeniu Ministra Kultury i Dziedzictwa Narodowego z dnia 14 sierpnia 2019 r. w sprawie podstaw programowych kształcenia w zawodach szkolnictwa artystycznego załącznik nr 5 otrzymuje brzmienie określone w załączniku do niniejszego rozporządzenia.
...
## Załącznik - Podstawa programowa kształcenia w zawodzie muzyk
...
3) posiada wiedzę niezbędną do rozwijania umiejętności w zakresie przedmiotu głównego i do świadomego uczestnictwa w życiu muzycznym;
...
10) wykorzystuje wiedzę oraz umiejętności niezbędne do zrozumienia i wykonywania utworów;

11) świadomie wykorzystuje słuch muzyczny w działaniach praktycznych;

12) wykorzystuje ekspresję muzyczną i muzyczno-ruchową;

13) realizuje wskazówki wykonawcze ze zrozumieniem;

14) ocenia jakość wykonywanych zadań;

15) pracuje w zespole pod nadzorem osoby odpowiedzialnej za realizację projektu oraz bierze współodpowiedzialność za efekt tej pracy;

16) integruje się i współpracuje z członkami zespołu;

17) buduje relacje oparte na zaufaniu;

18) wykazuje się w działaniu aktywną postawą;

19) organizuje swoją indywidualną pracę;

20) systematycznie rozwija swoje umiejętności;

21) wykorzystuje technologię informacyjną i komunikacyjną;

22) przewiduje skutki podejmowanych działań;

23) jest przygotowany do kontynuowania nauki;

24) potrafi skutecznie radzić sobie ze stresem, w szczególności z tremą.
...
1. Znajomość techniki gry na fortepianie

Uczeń posługuje się różnymi elementami techniki pianistycznej.

2. Kształtowanie wyobraźni muzycznej i wrażliwości słuchowej

Uczeń świadomie przekazuje treść muzyczną, wykorzystując wiedzę i wyobraźnię muzyczną, zwraca uwagę na estetykę brzmienia.

3. Kształcenie umiejętności samodzielnej pracy

Uczeń efektywnie organizuje swoją pracę, rozwija umiejętność gry a vista.
...
c) stosuje różne rodzaje artykulacji (legato, staccato, portato),

d) stosuje technikę palcową, pasażową, podwójnych dźwięków, akordową,

e) prowadzi dwugłos w jednej ręce,

f) prawidłowo używa prawego pedału;

2) poprawnie realizuje zadania wykonawcze:

a) właściwie realizuje zapis muzyczny utworu (wysokość dźwięku, zapis metrorytmiczny, artykulacja, dynamika, frazowanie, agogika, pedalizacja, aplikatura),

b) prawidłowo realizuje fakturę homofoniczną i podstawy polifonii,

c) świadomie pracuje nad interpretacją utworu muzycznego zgodnie z jego stylem i budową formalną,

d) wykonuje utwór z pamięci;

3) posługuje się umiejętnością gry gam i pasaży do czterech znaków przykluczowych:

a) zna zasady prawidłowego palcowania gam i pasaży,

b) wykonuje prawidłowo gamy i pasaże oraz kadencję wielką doskonałą w tonacjach majorowych i minorowych;

4) posiada zasób środków wykonawczych niezbędnych do realizacji przedmiotu improwizacja fortepianowa.

2. Kształtowanie wyobraźni muzycznej i wrażliwości słuchowej

Uczeń:

1) świadomie kształtuje stronę brzmieniową i wyrazową wykonywanych utworów, w tym własnych kompozycji;

2) wykonuje ze zrozumieniem utwory muzyczne: polifoniczne, klasyczne i inne, np.: utwory kameralne, utwory dowolne, własne kompozycje.

3. Kształcenie umiejętności samodzielnej pracy

Uczeń:

1) umiejętnie planuje swoją pracę - dzieli ją na etapy, koncentruje się na wybranym zagadnieniu;

2) doskonali swoje umiejętności przez systematyczną pracę;

3) samodzielnie i dokładnie odczytuje tekst nutowy;

4) świadomie koryguje swoje błędy.
...
Uczeń prawidłowo posługuje się aparatem gry na fortepianie, nabywa podstawowych umiejętności technicznych i interpretacyjnych w grze na instrumencie wraz z elementami analizy utworu.
...
1) gra łatwe utwory na cztery ręce z nauczycielem lub innym uczniem;
...
Uczeń w sposób kreatywny realizuje zadania z zakresu improwizacji fortepianowej i podstaw kompozycji.

2. Wykorzystywanie wiedzy z zakresu teorii muzyki w praktyce

Uczeń poznaje miniatury muzyczne o różnorodnej stylistyce i charakterze, na ich przykładzie potrafi tworzyć improwizacje i kompozycje o określonej budowie formalnej, stosuje w grze kontrasty związane z elementami muzyki.

3. Wykorzystanie improwizacji fortepianowej do zajęć rytmiki prowadzonych metodą E. Jaques-Dalcroze'a

Uczeń improwizuje do ćwiczeń muzyczno-ruchowych wykorzystywanych w ramach zajęć rytmiki prowadzonych metodą E. Jaques-Dalcroze'a.

4. Zdobywanie umiejętności w zakresie szybkości i wielotorowości myślenia przez ćwiczenia transpozycyjne i grę a vista

Uczeń rozwija umiejętność antycypacji przebiegu muzycznego i wyczucia klawiatury.
...
1) improwizuje melodię i jej warianty;

2) kreuje własne improwizacje konstruowane na zasadach podobieństwa, przeciwieństwa i przejścia (tj. sposobu łączenia stanów kontrastujących) na gruncie harmoniki funkcyjnej, w oparciu o wybrane skale lub w oparciu o technikę modelowania interwałowego;

3) tworzy krótkie kompozycje oparte na dowolnym materiale dźwiękowym (np. na gruncie harmoniki funkcyjnej czy na wybranych skalach);

4) dba o jakość dźwięku w improwizacji.

2. Wykorzystywanie wiedzy z zakresu teorii muzyki w praktyce

Uczeń:

1) tworzy wypowiedzi muzyczne (improwizowane lub przygotowane) o określonej budowie formalnej (AB, ABA) na gruncie harmoniki funkcyjnej oraz w oparciu o wybrane skale;

2) kształtuje improwizacje zgodnie z czasem trwania motywu, frazy, zdania, okresu muzycznego (improwizacja następnika do podanego poprzednika);

3) różnicuje grę ze względu na elementy muzyki (dynamika, artykulacja, kolorystyka, faktura, charakter improwizacji);

4) improwizuje w tonacjach majorowych i minorowych do dwóch znaków przykluczowych włącznie na podstawie wybranych kadencji;

5) wykorzystuje w grze różne typy faktury fortepianowej (np. akordową, figuracyjną).
...
2) improwizuje w oparciu o podane wartości, grupy i tematy rytmiczne w różnym metrum oraz w różnych tempach;

3) tworzy proste akompaniamenty do polskich piosenek ludowych, popularnych i dziecięcych, a także kolęd i pastorałek w oparciu o podstawowe akordy w danej tonacji;

4) komponuje proste formy taneczne w stylistyce klasycznej lub neoklasycznej;

5) improwizuje miniatury oparte na technice modelowania interwałowego w przebiegu periodycznym i aperiodycznym o charakterze ilustracyjnym;

6) potrafi współpracować w grupie przy tworzeniu zespołowej improwizacji instrumentalnej lub wokalno-instrumentalnej.
...
2) kształci umiejętność gry na fortepianie bez obserwowania klawiatury;

3) grając a vista, antycypuje dalszy przebieg utworu;

4) poznaje wybrane przykłady literatury pianistycznej, zdobywa doświadczenie w zakresie szybkiej orientacji w tekście muzycznym.
...
2) uczestniczy w życiu muzycznym szkoły i środowiska oraz nabywa umiejętności stosownego zachowania w czasie rozmaitych wydarzeń kulturalnych;
...
1) nabywa umiejętności przyjmowania odpowiedniej postawy podczas gry na instrumencie oraz posługiwania się prawidłowym aparatem gry;
...
2) przez udział w koncertach doskonali umiejętność swobodnej prezentacji przed publicznością przy równoczesnym kreatywnym wyrażaniu swojej wrażliwości artystycznej;
...
2. Opanowanie podstaw gry na instrumencie Uczeń:
...
8) opanowuje technikę prawidłowego oddechu i zadęcia;
...
3) nabywa umiejętności rozpoznawania cech charakterystycznych budowy formalnej utworów.

3. Kształcenie umiejętności gry na fortepianie

Uczeń:

1) nabywa umiejętności właściwego posługiwania się aparatem gry;
...
5) nabywa umiejętności prawidłowej gry a vista i gry zespołowej.
...
c) interwały, rodzaje trój dźwięków (dur, moll, zwiększony, zmniejszony) wraz z przewrotami oraz D i czterodźwięk zmniejszony z przewrotami;
...
13) nabywa podstawowych umiejętności w zakresie gry zespołowej i je rozwija:
...
1) rozwija wrażliwość artystyczną oraz zainteresowania muzyczne przez uczęszczanie na koncerty i słuchanie muzyki z nagrań;
...
2) przez słuchanie nagrań uczy się kształtować własny gust estetyczny.
...
3) uczestniczy w życiu kulturalnym jako odbiorca sztuki, a także przez grę solową i kameralną.
...
3. Zdobycie i rozwój umiejętności gry na organach pozwalających na wykonywanie utworów z różnych epok, zgodnie z zapisem i kanonami stylistycznymi
...
b) struktury harmoniczne: interwały proste i złożone (nona, decyma) gamo właściwe i w oderwaniu od tonacji, trój dźwięki majorowe i minorowe w postaci zasadniczej i w przewrotach, trój dźwięki zmniejszone i zwiększone, triadę harmoniczną i TVI w poznanych odmianach gam, dominantę septymową w postaci zasadniczej i w przewrotach z rozwiązaniem, czterodźwięk zmniejszony, rodzaje kadencji (doskonała, plagalna, zawieszona, zwodnicza); zagadnienia są realizowane w tonacjach do pięciu znaków przykluczowych,
...
a) język dźwiękowy: skale, melodyka, metrorytmika, harmonika, kolorystyka, m artykulacja, agogika, dynamika i ich najczęściej spotykane włoskie określenia,
...
7. Kształcenie aktywnego udziału w życiu muzycznym Uczeń:
...
2. Przygotowanie ucznia do pracy w orkiestrze Uczeń:
...
2. Rozwijanie aktywnej i twórczej postawy

Uczeń działa w ramach projektów artystycznych.

3. Zdobywanie praktycznej wiedzy z zakresu wybranych zagadnień metody E. Jaques-Dalcroze'a
...
4. Rozwijanie sprawności fizycznej i świadomości ruchu
...
5. Przygotowanie do aktywnego uczestnictwa w różnych formach życia artystycznego Uczeń:
...
2. Opanowanie techniczno-wykonawczych podstaw gry na instrumencie Uczeń:
...
8) opanowuje technikę gry w stopniu umożliwiającym dalsze kształcenie, stosuje prawidłowy podział smyczka oraz operuje podstawowymi sposobami artykulacji (detache, portato, legato, martele);
...
2) pokonuje problemy techniczne przez dobór odpowiednich sposobów ćwiczenia;
...
1) nabywa umiejętności właściwego posługiwania się aparatem gry, prezentując prawidłową postawę, ułożenie rąk, odpowiedni sposób wydobycia dźwięku, różną artykulację, użycie pedału;
...
3) nabywa umiejętności prawidłowej gry a vista łatwych utworów;
...
g) aktywność chwytu czubków palców, h) koordynację rąk,
...
3) prawidłowo i ze zrozumieniem prezentuje w grze różne formy muzyczne: etiudy, utwory polifoniczne, klasyczny cykl sonatowy (do wyboru np.: sonatinę, sonatę, koncert), utwory kantyleno we, utwory taneczne, utwory ilustracyjne;
...
3. Zdobycie podstawowej wiedzy teoretycznej Uczeń:
...
5) bierze udział w popisach i audycjach muzycznych. INSTRUMENT GŁÓWNY - KLARNET
...
1. Umuzykalnienie i rozbudzenie wrażliwości muzycznej Uczeń:
...
2. Opanowanie i doskonalenie umiejętności gry na instrumencie Uczeń:
...
Uczeń nabywa umiejętności świadomego ćwiczenia oraz korekty własnych błędów i ją rozwija.
...
8) gra w pozycjach - co najmniej do piątej;

9) zna budowę gam durowych i molowych oraz pasaży; potrafi je rozpoznać i wykonać;

10) operuje wibracją w stopniu pozwalającym na swobodne jej stosowanie;
...
3. Kształcenie podstawowych umiejętności gry na instrumencie Uczeń:
...
1. Zdobywanie wiedzy z zakresu historii muzyki bazującej na niezbywalnych pojęciach i terminach muzycznych, które są niezbędne do opisu, analizy i interpretacji zjawisk muzycznych obejmujących działania twórcze w ciągłości historycznej od starożytnej Grecji po czasy współczesne
...
1. Przygotowanie ucznia do pracy w orkiestrze (symfonicznej) Uczeń:
...
2. Kształtowanie profesjonalnych postaw w pracy zespołowej oraz rozwijanie zamiłowania do muzykowania zespołowego Uczeń:
...
1. Doskonalenie umiejętności gry na instrumencie Uczeń:
...
2. Umiejętność samodzielnej pracy Uczeń:
...
1. Doskonalenie gry na instrumencie Uczeń:
...
3) zna oznaczenia dynamiczne, artykulacyjne, agogiczne i interpretacyjne (w tym oznaczeni włoskie);
...
b) kształtowanie formy w czasie: prawidłowy rytm, pulsację, tempo finalne, różnice agogiczne, tempo rabato i inne,
...
3. Przygotowanie do samodzielnej pracy i aktywnego uczestnictwa w życiu muzycznym Uczeń:
...
c) stosowania techniki rudymentarnej według podstawowej listy Percussive Arts Society,
...
a) wybrane etiudy o zróżnicowanych problemach technicznych, z uwzględnieniem specyfiki poszczególnych instrumentów, np. etiudy klasyczne i rudymentarne na werblu,

b) wybrane utwory solo i z akompaniamentem,

c) wybrane utwory kameralne na instrumenty melodyczne i membranofony, z uwzględnieniem techniki rudymentarnej, oraz na inne zestawy instrumentalne.
...
3. Przygotowanie ucznia do prezentacji estradowej w grze solowej i zespołowej Uczeń:
...
7) samodzielnie wyszukuje i selekcjonuje informacje potrzebne do realizacji przedmiotów artystycznych oraz dokonuje ich oceny, wykorzystując techniki informacyjne i komunikacyjne;
...
2. Zdobywanie umiejętności pracy w dużym zespole jazzowym Uczeń:
...
3. Zdobywanie wiedzy z zakresu polimetrii i polirytmii Uczeń:
...
1. Kształcenie umiejętności gry na instrumencie Uczeń:
...
2. Zdobywanie umiejętności w zakresie interpretacji utworów muzycznych Uczeń:
...
3. Poznanie wiedzy z historii i literatury muzycznej, z uwzględnieniem muzyki jazzowej Uczeń zna historię muzyki i literaturę muzyczną, ze szczególnym uwzględnieniem jazzu, jego głównych nurtów, stylów oraz przedstawicieli.
...
2. Zdobywanie umiejętności interpretacji utworów muzycznych Uczeń:
...
2) posługuje się elementarnymi zasadami komunikacji i współpracy w zespołach o różnych składach wykonawczych, potrafi słuchać i właściwie reagować na działaniawspółwykonawców.
...
8) samodzielnie wyszukuje i selekcjonuje informacje z zakresu literatury specjalistycznej oraz dokonuje ich oceny, m.in. wykorzystując technologię informacyjną i komunikacyjną. OBOWIĄZKOWE ZAJĘCIA EDUKACYJNE
...
3) przygotowuje i przedstawia krótką prezentację multimedialną w zakresie własnej dziedziny;
...
2. Wykorzystanie wiedzy w działaniach warsztatowych Uczeń potrafi przeprowadzić prostą korektę instrumentu.
...
1) wykorzystuje, selekcjonuje i krytycznie ocenia informacje o sztuce pozyskane z różnych źródeł;
...
1) zna i stosuje w praktyce metodę rytmiki E. Jaques-Dalcroze'a;
...
14) samodzielnie wyszukuje i selekcjonuje informacje niezbędne do realizacji przedmiotów artystycznych oraz dokonuje ich oceny, wykorzystując techniki informacyjne i komunikacyjne.
...
4) wykonuje ze zrozumieniem następujące formy muzyczne: polifoniczne, klasyczne (np. sonatina, allegro sonatowe, rondo, wariacje), etiudy, miniatury, formy taneczne;
...
3) świadomie koryguje swoje błędy;
...
1. Poznanie wiedzy z zakresu powstania i rozwoju metody nauczania rytmiki E. Jaąues- Dalcroze'a
...
1. Poznanie wiedzy z zakresu powstania i rozwoju metody nauczania rytmiki E. Jaques- Dalcroze'a
...
3. Przygotowanie ucznia do publicznej prezentacji dzieła Uczeń:
...
5. Kształcenie umiejętności pracy w zespole jazzowym Uczeń:
...
2. Kształcenie umiejętności interpretacji utworów muzycznych Uczeń:
...
5. Zdobywanie umiejętności pracy w zespole jazzowym Uczeń:
...
2. Kształcenie umiejętności improwizacji oraz interpretacji utworów muzycznych Uczeń:
...
4) przestrzega przepisów prawa autorskiego i przepisów dotyczących ochrony zabytków.
...
1. Zdobycie podstawowej wiedzy z zakresu projektowania i modelowania Uczeń:
...
14) samodzielnie wyszukuje i selekcjonuje informacje niezbędne do realizacji przedmiotów artystycznych oraz dokonuje ich oceny, z wykorzystaniem technik informacyjnych i komunikacyjnych.
...
2. Wykorzystywanie wiedzy z zakresu przedmiotów ogólnomuzycznych w praktyce Uczeń poznaje style muzyczne oraz ich cechy charakterystyczne i potrafi je zastosować we własnej improwizacji i kompozycji.
...
2. Zapoznanie z wybranymi zagadnieniami z dydaktyki ogólnej Uczeń zdobywa podstawowe wiadomości z zakresu procesu nauczania.
...
5) rozpoznaje w utworach muzycznych i tworzy formy: AB, AB A, rondo, wariacje - wykorzystując różne typy ćwiczeń rytmicznych;
...
OBOWIĄZKOWE ZAJĘCIA EDUKACYJNE ĆWICZENIA RYTMICZNE
...
1) ogólnokształcącej szkole muzycznej I stopnia w cyklu 8-letnim wynosi:

a) 52^2^/3 godziny - dla ucznia realizującego we wszystkich klasach przedmiot główny - instrument główny,

b) 56 godzin - dla ucznia realizującego w klasach I-VI przedmiot główny - instrument główny, a w klasach VII i VIII przedmiot główny - rytmikę (w ujęciu tygodniowym w cyklu kształcenia);

2) szkole muzycznej I stopnia:

a) w cyklu 6-letnim wynosi: 35^1^/3 godziny,

b) w cyklu 4-letnim wynosi: 26^1^/3 godziny (w ujęciu tygodniowym w cyklu kształcenia);

3) ogólnokształcącej szkole muzycznej II stopnia - w cyklu 4-letnim dla zawodu muzyk dla specjalności:

a) instrumentalistyka wynosi: do 46^2^/3 godziny,

b) instrumentalistyka jazzowa wynosi: 58 godzin,

c) rytmika wynosi: 53^1^/3 godziny,

d) wokalistyka wynosi: do 59 godzin,

e) wokalistyka jazzowa wynosi: do 68^2^/3 godziny,

f) lutnictwo wynosi: 72 godziny

(w ujęciu tygodniowym w cyklu kształcenia);

4) szkole muzycznej II stopnia:

a) w cyklu 6-letnim dla zawodu muzyk dla specjalności:

- instrumentalistyka wynosi: do 63 godzin,

- instrumentalistyka jazzowa wynosi: 69 godzin,

- rytmika wynosi: 72 godziny,

- wokalistyka jazzowa wynosi: do 76^2^/3 godziny,

- lutnictwo wynosi: 88 godzin

(w ujęciu tygodniowym w cyklu kształcenia),

b) w cyklu 4-letnim dla zawodu muzyk dla specjalności:

- instrumentalistyka jazzowa wynosi: 60 godzin,

- wokalistyka wynosi: do 61 godzin,

- wokalistyka jazzowa wynosi: do 70^2^/3*,*godziny (w ujęciu tygodniowym w cyklu kształcenia).
