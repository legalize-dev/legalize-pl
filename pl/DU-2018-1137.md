---
title: "Ustawa z dnia 12 kwietnia 2018 r. o rejestracji jachtów i innych jednostek pływających o długości do 24 m"
identifier: "DU-2018-1137"
country: "pl"
rank: "ustawa"
publication_date: "2018-04-12"
last_updated: "2018-04-12"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2018/1137"
department: "SEJM"
eli: "DU/2018/1137"
display_address: "Dz.U. 2018 poz. 1137"
internal_address: "WDU20180001137"
publisher: "DU"
volume: "0"
position: "1137"
...
effective_date_notes: "art. 26 i art. 30 wchodzą w życie z dniem 28 czerwca 2018 r."
parliamentary_prints_count: "1"
references_count: "5"
text_variants_count: "5"
has_pdf: "true"
keywords: "kodeks morski, żegluga śródlądowa, rybactwo śródlądowe, rejestry, bezpieczeństwo żeglugi i wypadki morskie, jednostki pływające, systemy teleinformatyczne, statki żeglugi śródlądowej"
---
...
5. W przypadku, o którym mowa w ust. 4, właściciel niezwłocznie oznakowuje jednostkę za pomocą oznakowania kontrolnego, umieszczając je na rufie po prawej stronie w sposób umożliwiający identyfikację jednostki.
...
8. W przypadku utraty albo uszkodzenia dokumentu rejestracyjnego lub oznakowania kontrolnego wtórnik tego dokumentu lub oznakowania wydaje, na wniosek właściciela, organ rejestrujący. Do wniosku dołącza się oświadczenie zawierające informacje o fakcie i okolicznościach utraty albo uszkodzenia dokumentu rejestracyjnego lub oznakowania kontrolnego. Przepis ust. 3 stosuje się odpowiednio.
...
Wyboru producenta blankietów dokumentu rejestracyjnego oraz oznakowania kontrolnego dokonuje minister właściwy do spraw gospodarki morskiej na zasadach określonych w przepisach o zamówieniach publicznych.
...
4) dowodu wniesienia opłaty za rozpatrzenie wniosku o rejestrację i wydanie dokumentu rejestracyjnego oraz wniosku o wydanie oznakowania kontrolnego w przypadku, o którym mowa w art. 4 ust. 4.
...
2) tryb wydawania wtórników dokumentu rejestracyjnego i oznakowania kontrolnego,

3) wzory zaświadczenia, o którym mowa w art. 9 ust. 2, dokumentu rejestracyjnego i oznakowania kontrolnego,
...
6) sposób oznakowywania jednostek pływających oznakowaniem kontrolnym
...
4) wydanie oznakowania kontrolnego w przypadku, o którym mowa w art. 4 ust. 4, albo wtórnika oznakowania kontrolnego,
...
1) pkt 1-4, nie może przekroczyć 10%,
...
2) nie dopełnia obowiązku oznakowania jednostki pływającej oznakowaniem kontrolnym z indywidualnym numerem identyfikacyjnym (INI) zgodnie z art. 4 ust. 5,
...
> 1a) statek przeznaczony lub używany wyłącznie do uprawiania sportu lub rekreacji - jacht rekreacyjny lub jacht komercyjny oraz jednostkę pływającą używaną do amatorskiego połowu ryb; 1b) jacht rekreacyjny - statek przeznaczony lub używany wyłącznie do uprawiania sportu lub rekreacji, inny niż jacht komercyjny; 1c) jacht komercyjny - statek przeznaczony lub używany wyłącznie do uprawiania sportu lub rekreacji, w ramach prowadzenia działalności polegającej na: a) odpłatnym przewozie osób, b) odpłatnym wykonywaniu rejsów szkoleniowych, c) odpłatnym udostępnianiu statku w celach amatorskiego połowu ryb w rozumieniu art. 7 ust. 1 ustawy z dnia 18 kwietnia 1985 r. o rybactwie śródlądowym , d) odpłatnym udostępnianiu statku obsadzonego załogą, e) każdym innym odpłatnym wykorzystaniu lub udostępnianiu statku - o ile w ramach tej działalności nie jest używany do przewozu więcej niż 12 pasażerów; 1d) jednostka pływająca używana do amatorskiego połowu ryb - statek używany do amatorskiego połowu ryb w rozumieniu art. 7 ust. 1 ustawy z dnia 18 kwietnia 1985 r. o rybactwie śródlądowym;
...
3. Właściciel jednostki pływającej, która zgodnie z dotychczasowymi przepisami nie podlegała obowiązkowi rejestracji, ma obowiązek ją zarejestrować w terminie 12 miesięcy od dnia wejścia w życie ustawy.

4. Armator jednostki pływającej, która zgodnie z dotychczasowymi przepisami nie podlegała obowiązkowi posiadania dokumentu bezpieczeństwa, a która jest obowiązana do uzyskania tego dokumentu na podstawie ustawy zmienianej w art. 21, w brzmieniu nadanym niniejszą ustawą, ma obowiązek uzyskania tego dokumentu w terminie 12 miesięcy od dnia wejścia w życie niniejszej ustawy.
...
Ustawa wchodzi w życie z dniem 1 stycznia 2020 r., z wyjątkiem art. 26 i art. 30, które wchodzą w życie po upływie 14 dni od dnia ogłoszenia.
