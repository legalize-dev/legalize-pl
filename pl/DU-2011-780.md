---
title: "Ustawa z dnia 9 czerwca 2011 r. o zmianie ustawy o podatku od towarów i usług, ustawy o zasadach ewidencji i identyfikacji podatników i płatników oraz ustawy o transporcie drogowym"
identifier: "DU-2011-780"
country: "pl"
rank: "ustawa"
publication_date: "2011-06-09"
last_updated: "2011-06-09"
status: "in_force"
source: "https://api.sejm.gov.pl/eli/acts/DU/2011/780"
department: "SEJM"
eli: "DU/2011/780"
display_address: "Dz.U. 2011 nr 134 poz. 780"
internal_address: "WDU20111340780"
publisher: "DU"
volume: "134"
position: "780"
...
effective_date_notes: "art. 1 pkt 20, 21 i 28 wchodzi w życie z dniem 1 stycznia 2012 r."
eu_directives_count: "2"
parliamentary_prints_count: "1"
references_count: "4"
text_variants_count: "5"
has_pdf: "true"
keywords: "ewidencja, działalność gospodarcza, usługi, podatek od towarów i usług, transport drogowy"
---
...
3) w art. 10 ust. 6 i 7 otrzymują brzmienie:

> 6. Podatnicy oraz osoby prawne niebędące podatnikami, do których ma zastosowanie ust. 1 pkt 2, mogą wybrać opodatkowanie wewnątrzwspólnotowego nabycia towarów przez złożenie naczelnikowi urzędu skarbowego pisemnego oświadczenia o takim wyborze albo przez podanie dokonującemu dostawy towarów numeru, o którym mowa w art. 97 ust. 10. 7. Wybór opodatkowania, o którym mowa w ust. 6, obowiązuje przez 2 kolejne lata, licząc od dnia dokonania wewnątrzwspólnotowego nabycia towarów, dla którego dokonano takiego wyboru.

4) w art. 12 w ust. 1 pkt 7 otrzymuje brzmienie:
...
b) w ust. 10 zdanie końcowe otrzymuje brzmienie:
...
8) w art. 22 w ust. 1 pkt 5 i 6 otrzymują brzmienie:
...
9) w art. 28a w pkt 1 lit. b otrzymuje brzmienie:

> b) osobę prawną niebędącą podatnikiem na podstawie lit. a, która jest zidentyfikowana lub obowiązana do identyfikacji do celów podatku lub podatku od wartości dodanej;

10) art. 28b i art. 28c otrzymują brzmienie:
...
16) w art. 42 w ust. 4 pkt 1 i 2 otrzymują brzmienie:
...
17) w art. 83 ust. 1f otrzymuje brzmienie:
...
18) w art. 88 w ust. 3a w pkt 1 lit. a otrzymuje brzmienie:
...
23) w art. 113 w ust. 13 pkt 3 otrzymuje brzmienie:

> 3) nieposiadających siedziby działalności gospodarczej na terytorium kraju.

24) w art. 119 w ust. 3 uchyla się pkt 1;

25) w art. 126 ust. 2 otrzymuje brzmienie:
...
26) w art. 131 pkt 2 otrzymuje brzmienie:
...
30) dodaje się załącznik nr 11 do ustawy w brzmieniu określonym w załączniku do niniejszej ustawy.

##### Art. 2.

W ustawie z dnia 13 października 1995 r. o zasadach ewidencji i identyfikacji podatników i płatników w art. 2 dodaje się ust. 4 w brzmieniu:

> 4. Obowiązkowi ewidencyjnemu, o którym mowa w ust. 1, nie podlegają podatnicy, którzy uzyskali numer identyfikacyjny na podstawie art. 132 ust. 5 oraz art. 134a ust. 4 ustawy z dnia 11 marca 2004 r. o podatku od towarów i usług .

##### Art. 3.

W ustawie z dnia 6 września 2001 r. o transporcie drogowym w art. 87 w ust. 1 w pkt 2 lit. e otrzymuje brzmienie:
...
## Załącznik - Załącznik nr 11: Wykaz towarów, o których mowa w art. 17 ust. 1 pkt 7 ustawy
